...
/* Logic Channel 0 */
#define MclConf_FlexioMclLogicChannels_FlexioMclLogicChannels_TxandClk      ((uint32)CHANNEL_0)
/* Logic Channel 1 */
#define MclConf_FlexioMclLogicChannels_FlexioMclLogicChannels_RxandCs      ((uint32)CHANNEL_1)
