...
*/
#define SpiConf_SpiChannel_SpiChannel_Master    ((Spi_ChannelType)0U)
#define SpiConf_SpiChannel_SpiChannel_Slave    ((Spi_ChannelType)1U)
...
*/
#define SPI_MULTIPARTITION_ENABLED          (STD_OFF)
...
*/
#define SPI_USE_LEGACY_EB_LENGTH (STD_OFF)
