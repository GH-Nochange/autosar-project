...
#else
    #error "PIN_3 cannot be used by SPI driver to configure for RX channel. PIN locked by another driver!"
#endif
...
#else
    #error "PIN_1 cannot be used by SPI driver to configure for CS channel. PIN locked by another driver!"
#endif
