...
*
*/
#define PortConf_PortPin_CAN0_RX_PTE4  0
#define PortConf_PortPin_CAN0_TX_PTE5  1
#define PortConf_PortPin_LPSPI0_SCK_PTB2  2
#define PortConf_PortPin_LPSPI0_SIN_PTB3  3
#define PortConf_PortPin_LPSPI0_SOUT_PTB4  4
#define PortConf_PortPin_LPSPI0_PCS0_PTB5  5
#define PortConf_PortPin_LED_BLUE_PTD0  6
#define PortConf_PortPin_LED_RED_PTD15  7
#define PortConf_PortPin_LED_GREEN_PTD16  8
...
*/
#define PORT_MAX_CONFIGURED_PADS_U16                        ((uint16)9)

/**
 * @brief Number of UnUsed pin array
*/
#define PORT_MAX_UNUSED_PADS_U16   (73U)
