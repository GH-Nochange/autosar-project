...
#define LPSPI_IP_SW_MAJOR_VERSION_PBCFG_C                 3
...
#include "Spi_MemMap.h"
/* Lpspi_Ip_DeviceAttributes_SpiExternalDevice_0_Instance_0 Device Attribute Configuration of Spi*/
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_0_Instance_0 =
{
    0U,  /* Instance */
    (uint32)(LPSPI_CFGR0_HREN(0U) |
             LPSPI_CFGR0_HRSEL(0U) |
             LPSPI_CFGR0_HRPOL(1U)
#ifdef LPSPI_CFGR0_HRDIR      
             | LPSPI_CFGR0_HRDIR(1U)
#endif
             ), /* CFGR0 */
...
const Lpspi_Ip_ConfigType Lpspi_Ip_PhyUnitConfig_SpiPhyUnit_0_Instance_0 =
{
    ...
    #if (LPSPI_IP_DMA_USED == STD_ON)
    (boolean)TRUE,
    (uint8)DMA_LOGIC_CH_0, /* txDmaChannel */
    (uint8)DMA_LOGIC_CH_1, /* rxDmaChannel */
    #if (LPSPI_IP_ENABLE_DMAFASTTRANSFER_SUPPORT == STD_ON)
