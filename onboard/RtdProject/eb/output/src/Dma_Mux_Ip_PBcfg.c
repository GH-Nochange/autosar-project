...
{
    {
        DMA_MUX_INSTANCE_0,
        0U,
        (DMA_MUX_0_LPSPI_0_TX_REQUEST | DMAMUX_CHANNEL_CFG_ENBL_MASK | DMAMUX_CHANNEL_CFG_TRIG(0U))
    },
    {
        DMA_MUX_INSTANCE_0,
        1U,
        (DMA_MUX_0_LPSPI_0_RX_REQUEST | DMAMUX_CHANNEL_CFG_ENBL_MASK | DMAMUX_CHANNEL_CFG_TRIG(0U))
    }
};
