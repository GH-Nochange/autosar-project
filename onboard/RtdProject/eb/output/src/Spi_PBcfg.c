...
static Spi_BufferDescriptorType Spi_Buffer_SpiChannel_Master;
/* Allocate Buffers for IB Channels (if any) */
static Spi_DataBufferType Spi_BufferTX_SpiChannel_Slave[262];
static Spi_DataBufferType Spi_BufferRX_SpiChannel_Slave[262];
...
static Spi_BufferDescriptorType Spi_Buffer_SpiChannel_Slave =
{
    (const uint8*)NULL_PTR,
    Spi_BufferTX_SpiChannel_Slave,  /* pBufferTX */
    Spi_BufferRX_SpiChannel_Slave   /* pBufferRX */
};
...
static const Spi_ChannelConfigType Spi_ChannelConfig_SpiChannel_Master =
{
        /* SpiChannel_Master*/
        ...
        &Spi_Buffer_SpiChannel_Master, /* pcBufferDescriptor */
        (uint32)SPI_SPURIOUS_ID_U32,
};
/* Channel Configuration of SpiChannel_Slave*/
static const Spi_ChannelConfigType Spi_ChannelConfig_SpiChannel_Slave =
{
        /* SpiChannel_Slave*/
...
#endif
        (uint32)1U, /* In the case SpiDefaultData is disabled. Set this value is 1U */
        262U, /* Length (configured in SpiIbNBuffers) */
        &Spi_Buffer_SpiChannel_Slave, /* pcBufferDescriptor */
        (uint32)SPI_SPURIOUS_ID_U32,
};
...
static const Spi_ChannelsCfgType Spi_aChannelConfigList[2] =
{
    {
    /* SpiChannel_Master */
    &Spi_ChannelConfig_SpiChannel_Master
    },
    {
    /* SpiChannel_Slave */
    &Spi_ChannelConfig_SpiChannel_Slave
    }
...
{
    SpiConf_SpiChannel_SpiChannel_Master
};

static const Spi_ChannelType Spi_SpiJob_1_ChannelAssignment[1] = 
{
    SpiConf_SpiChannel_SpiChannel_Slave
};
...
static const Spi_JobConfigType Spi_JobConfig_SpiJob_0 =
{
        ...
        SPI_SpiExternalDevice_1, /* External Device */
                &Spi_aExternalDeviceConfigList[SPI_SpiExternalDevice_1] /* pcExternalDeviceConfig - pointer to the external device configuration */
};
...
static const Spi_JobType Spi_SpiSequence_Master_JobAssignment[1] = 
{
...
/* Sequence Configuration of SpiSequence_Master */
static const Spi_SequenceConfigType Spi_SequenceConfig_SpiSequence_Master =
{
        /* SpiSequence_Master */
        (Spi_JobType)1U,
        (uint32)SPI_SPURIOUS_ID_U32,
        Spi_SpiSequence_Master_JobAssignment, /* List of Jobs */
...
static const Spi_ConfigType Spi_Config=
{
    ...
    (uint32)SPI_SPURIOUS_ID_U32, /* u32SpiCorePartitionUse */
