...
[!LOOP "variant:all()"!]
[!CODE!]#include "Adc_Ipw_[!"."!]_PBcfg.h"[!CR!][!ENDCODE!]
[!ENDLOOP!]
[!ELSE!]
[!CODE!]#include "Adc_Ipw_PBcfg.h"[!CR!][!ENDCODE!]
[!ENDIF!]
...
#define ADC_IPW_SW_MAJOR_VERSION_CFG               3
...
[!LOOP "variant:all()"!]
[!CODE!]
/* Check if Adc_Ipw_Cfg.h file and Adc_Ipw_[!"text:toupper(.)"!]_PBcfg.h file are of the same vendor */
#if (ADC_IPW_VENDOR_ID_CFG != ADC_IPW_VENDOR_ID_[!"text:toupper(.)"!]_PBCFG)
    #error "Adc_Ipw_Cfg.h and Adc_Ipw_[!"text:toupper(.)"!]_PBcfg.h have different vendor ids"
#endif

/* Check if Adc_Ipw_Cfg.h file and Adc_Ipw_[!"text:toupper(.)"!]_PBcfg.h file are of the same Autosar version */
#if ((ADC_IPW_AR_RELEASE_MAJOR_VERSION_CFG != ADC_IPW_AR_RELEASE_MAJOR_VERSION_[!"text:toupper(.)"!]_PBCFG) || \
     (ADC_IPW_AR_RELEASE_MINOR_VERSION_CFG != ADC_IPW_AR_RELEASE_MINOR_VERSION_[!"text:toupper(.)"!]_PBCFG) || \
     (ADC_IPW_AR_RELEASE_REVISION_VERSION_CFG != ADC_IPW_AR_RELEASE_REVISION_VERSION_[!"text:toupper(.)"!]_PBCFG) \
    )
    #error "AutoSar Version Numbers of Adc_Ipw_Cfg.h and Adc_Ipw_[!"text:toupper(.)"!]_PBcfg.h are different"
#endif

/* Check if Adc_Ipw_Cfg.h file and Adc_Ipw_[!"text:toupper(.)"!]_PBcfg.h file are of the same Software version */
#if ((ADC_IPW_SW_MAJOR_VERSION_CFG != ADC_IPW_SW_MAJOR_VERSION_[!"text:toupper(.)"!]_PBCFG) || \
     (ADC_IPW_SW_MINOR_VERSION_CFG != ADC_IPW_SW_MINOR_VERSION_[!"text:toupper(.)"!]_PBCFG) || \
     (ADC_IPW_SW_PATCH_VERSION_CFG != ADC_IPW_SW_PATCH_VERSION_[!"text:toupper(.)"!]_PBCFG) \
    )
  #error "Software Version Numbers of Adc_Ipw_Cfg.h and Adc_Ipw_[!"text:toupper(.)"!]_PBcfg.h are different"
#endif
[!ENDCODE!]
[!ENDLOOP!]
[!ELSE!]
