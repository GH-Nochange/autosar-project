...
[!LOOP "variant:all()"!]
[!CODE!]#include "Adc_Ip_[!"."!]_PBcfg.h"[!CR!][!ENDCODE!]
[!ENDLOOP!]
[!ELSE!]
[!CODE!]#include "Adc_Ip_PBcfg.h"[!CR!][!ENDCODE!]
[!ENDIF!]
...
#define ADC_IP_SW_MAJOR_VERSION_CFG               3
...
[!LOOP "variant:all()"!]
[!CODE!]
/* Check if Adc_Ip_Cfg.h file and Adc_Ip_[!"text:toupper(.)"!]_PBcfg.h file are of the same vendor */
#if (ADC_IP_VENDOR_ID_CFG != ADC_IP_VENDOR_ID_[!"text:toupper(.)"!]_PBCFG)
    #error "Adc_Ip_Cfg.h and Adc_Ip_[!"text:toupper(.)"!]_PBcfg.h have different vendor ids"
#endif

/* Check if Adc_Ip_Cfg.h file and Adc_Ip_[!"text:toupper(.)"!]_PBcfg.h file are of the same Autosar version */
#if ((ADC_IP_AR_RELEASE_MAJOR_VERSION_CFG != ADC_IP_AR_RELEASE_MAJOR_VERSION_[!"text:toupper(.)"!]_PBCFG) || \
     (ADC_IP_AR_RELEASE_MINOR_VERSION_CFG != ADC_IP_AR_RELEASE_MINOR_VERSION_[!"text:toupper(.)"!]_PBCFG) || \
     (ADC_IP_AR_RELEASE_REVISION_VERSION_CFG != ADC_IP_AR_RELEASE_REVISION_VERSION_[!"text:toupper(.)"!]_PBCFG) \
    )
    #error "AutoSar Version Numbers of Adc_Ip_Cfg.h and Adc_Ip_[!"text:toupper(.)"!]_PBcfg.h are different"
#endif

/* Check if Adc_Ip_Cfg.h file and Adc_Ip_[!"text:toupper(.)"!]_PBcfg.h file are of the same Software version */
#if ((ADC_IP_SW_MAJOR_VERSION_CFG != ADC_IP_SW_MAJOR_VERSION_[!"text:toupper(.)"!]_PBCFG) || \
     (ADC_IP_SW_MINOR_VERSION_CFG != ADC_IP_SW_MINOR_VERSION_[!"text:toupper(.)"!]_PBCFG) || \
     (ADC_IP_SW_PATCH_VERSION_CFG != ADC_IP_SW_PATCH_VERSION_[!"text:toupper(.)"!]_PBCFG) \
    )
  #error "Software Version Numbers of Adc_Ip_Cfg.h and Adc_Ip_[!"text:toupper(.)"!]_PBcfg.h are different"
#endif
[!ENDCODE!]
[!ENDLOOP!]
[!ELSE!]
