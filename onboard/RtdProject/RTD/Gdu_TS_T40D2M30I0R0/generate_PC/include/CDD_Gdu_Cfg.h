...
#if (GDU_CFG_VENDOR_ID != GDU_[!"text:toupper(.)"!]_PBCFG_VENDOR_ID)
    #error "CDD_Gdu_Cfg.h and CDD_Gdu_[!"."!]_PBcfg.h have different vendor ids"
#endif
#if ((GDU_CFG_AR_RELEASE_MAJOR_VERSION    != GDU_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
    (GDU_CFG_AR_RELEASE_MINOR_VERSION    != GDU_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_MINOR_VERSION) || \
    (GDU_CFG_AR_RELEASE_REVISION_VERSION != GDU_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of CDD_Gdu_Cfg.h and CDD_Gdu_[!"."!]_PBcfg.h are different"
#endif
#if ((GDU_CFG_SW_MAJOR_VERSION != GDU_[!"text:toupper(.)"!]_PBCFG_SW_MAJOR_VERSION) || \
    (GDU_CFG_SW_MINOR_VERSION != GDU_[!"text:toupper(.)"!]_PBCFG_SW_MINOR_VERSION) || \
    (GDU_CFG_SW_PATCH_VERSION != GDU_[!"text:toupper(.)"!]_PBCFG_SW_PATCH_VERSION) \
    )
