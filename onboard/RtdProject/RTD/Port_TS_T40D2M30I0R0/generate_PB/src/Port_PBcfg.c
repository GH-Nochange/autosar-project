...
#define PORT_AR_RELEASE_MINOR_VERSION_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG_C        7
#define PORT_AR_RELEASE_REVISION_VERSION_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG_C     0
#define PORT_SW_MAJOR_VERSION_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG_C                3
...
[!ELSE!][!//
    ...
    [!VAR "OutPinAltConf"="number(substring-before(substring-after($PinMap,$MacPinMode),':'))"!][!//
[!ENDIF!][!//
[!ENDNOCODE!][!//
[!ENDMACRO!][!//
...
[!ENDIF!][!//
    ...
    [!IF "(ecu:get('Port.Family')='m241') or (ecu:get('Port.Family')='m242') or (ecu:get('Port.Family')='m243') or (ecu:get('Port.Family')='m244')"!][!//
        [!/* SRE bit. Check if slew rate control is set */!][!//
        [!IF "text:match(./PortPinSlewRate,'FAST_SLEW_RATE')"!][!//
            [!VAR "MacPinMSCR"="bit:or($MacPinMSCR,bit:shl(0,2))"!][!//
        [!ELSEIF "text:match(./PortPinSlewRate,'SLOW_SLEW_RATE')"!][!//
            [!VAR "MacPinMSCR"="bit:or($MacPinMSCR,bit:shl(1,2))"!][!//
        [!ENDIF!][!//

        [!/* ODE bit. Check if open drain is enabled */!][!//
        [!IF "./PortPinODE"!][!//
            [!VAR "MacPinMSCR"="bit:or($MacPinMSCR,bit:shl(1,5))"!][!//
        [!ENDIF!][!//
    [!ENDIF!][!//
...
[!MACRO "GetSkip"!][!//
[!NOCODE!][!//
[!IF "text:match(./PortPinMode,'SKIP')"!][!//
    [!VAR "MacSkipMode"= "string('(boolean)TRUE')"!][!//
[!ELSE!][!//
    [!VAR "MacSkipMode"= "string('(boolean)FALSE')"!][!//
[!ENDIF!][!//
[!ENDNOCODE!][!//
[!"$MacSkipMode"!][!//
[!ENDMACRO!][!//
...
[!IF "node:value(../PortGeneral/PortMultiPartitionSupport)='true'"!]
        ...
        [!IF "PortPinId = $x"!][!//
            [!LOOP "PortPinEcucPartitionRef/*"!][!//
                ...
                [!LOOP "as:modconf('Os')[1]/OsApplication/*"!][!//
                    [!IF "$PortCrtPart = node:value(./OsAppEcucPartitionRef)"!][!//
                        [!SELECT "node:ref(./OsAppEcucPartitionRef)"!][!//
                            [!VAR "GetThePartitionNumber"="node:pos(.)"!][!//
...
static const Port_UnUsedPinConfigType Port_UnUsedPin[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!] =
{
    ...
    [!LOOP "NotUsedPortPin"!][!/*
        */!](uint32)[!CALL "GetUnusedPCR"!], (Port_PinDirectionType)[!CALL "GetPDDir"!], (uint8)[!CALL "GetPDO"!], [!CALL "GetSkip"!][!/*
    */!][!ENDLOOP!]
};
[!ENDSELECT!][!//
