...
#define CRC_IP_CFG_SW_MAJOR_VERSION               3
...
#define CRC_IP_NUM_LOGIC_CHANNEL_MAX                   ((uint32)[!"$ChannelMax"!]U)
...
extern const uint32 Crc_Ip_axProtocolConfiguredTable[CRC_IP_PROTOCOL_CONFIGURED_TABLE_NO];
extern const uint32 Crc_Ip_axProtocolConfiguredHardware[CRC_IP_PROTOCOL_CONFIGURED_HARDWARE_NO];
