...
#define DISRAMRE (0x00300000)
    ...
    EXTERN .mcal_shared_data$$Base
    EXTERN .mcal_shared_data_init$$Base
    EXTERN .mcal_shared_data_init$$Limit
    EXTERN .intvec$$Base
...
__INIT_TABLE
    ...
    DCD .mcal_shared_data$$Base
    DCD .mcal_shared_data_init$$Base
    DCD .mcal_shared_data_init$$Limit
    DCD .intvec$$Base
