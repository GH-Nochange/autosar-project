...
[!CODE!]#include "S32K148_MPU.h"[!ENDCODE!]
    [!ELSEIF "contains($ResourceSubderivative, 's32m24')"!][!//
[!CODE!]#include "S32M24x_MPU.h"[!ENDCODE!]
    [!ENDIF!][!//
[!ELSE!][!//
...
#define PLATFORM_IP_ENABLE_MPU            ([!IF "(GeneralConfiguration/PlatformMpuConfigurable = 'true')"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])

[!IF "GeneralConfiguration/PlatformMpuConfigurable"!][!//
/** @brief    Development error checking */
#define MPU_IP_DEV_ERROR_DETECT           ([!IF "GeneralConfiguration/PlatformDevErrorDetect"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
