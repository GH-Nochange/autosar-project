...
[!IF "contains($enabledModules,'Sent') and contains($generateModules,'Sent')"!][!//
#include "Flexio_Sent_Ip_CfgDefines.h"
#if defined(SENT_CHANNEL_0_USED) || defined(SENT_CHANNEL_1_USED) || defined(SENT_CHANNEL_2_USED) || defined(SENT_CHANNEL_3_USED)|| defined(SENT_CHANNEL_4_USED) || defined(SENT_CHANNEL_5_USED) || defined(SENT_CHANNEL_6_USED) || defined(SENT_CHANNEL_7_USED)
    #define FLEXIO_MCL_IP_USE_SENT_MODULE
#endif
[!ENDIF!][!//
[!IF "contains($enabledModules,'I2c') and contains($generateModules,'I2c')"!][!//
...
#endif
[!ENDIF!][!//
[!IF "contains($enabledModules,'I2s') and contains($generateModules,'I2s')"!][!//
#include "Flexio_I2s_Ip_CfgDefines.h"
#if defined(I2S_CHANNEL_0_USED) || defined(I2S_CHANNEL_1_USED) || defined(I2S_CHANNEL_2_USED) || defined(I2S_CHANNEL_3_USED)|| defined(I2S_CHANNEL_4_USED) || defined(I2S_CHANNEL_5_USED) || defined(I2S_CHANNEL_6_USED) || defined(I2S_CHANNEL_7_USED)
    #define FLEXIO_MCL_IP_USE_I2S_MODULE
#endif
[!ENDIF!][!//
[!IF "contains($enabledModules,'Spi') and contains($generateModules,'Spi')"!][!//
#include "Flexio_Spi_Ip_CfgDefines.h"
    ...
    #define FLEXIO_MCL_IP_USE_SPI_MODULE
#endif
[!ENDIF!][!//
[!IF "contains($enabledModules,'Uart') and contains($generateModules,'Uart')"!][!//
...
#endif
[!ENDIF!][!//
[!IF "contains($enabledModules,'Pwm') and contains($generateModules,'Pwm')"!][!//
#include "Flexio_Pwm_Ip_CfgDefines.h"
    ...
    #define FLEXIO_MCL_IP_USE_PWM_MODULE
#endif
[!ENDIF!][!//
[!IF "contains($enabledModules,'Lin') and contains($generateModules,'Lin')"!][!//
#include "Flexio_Lin_Ip_CfgDefines.h"
    ...
    #define FLEXIO_MCL_IP_USE_LIN_MODULE
#endif
[!ENDIF!][!//
