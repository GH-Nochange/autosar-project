...
#define LPTMR_ICU_IP_IRQ_SW_MAJOR_VERSION_C            3
...
/* Check if source file and Lptmr_Icu_Ip.h header file are of the same vendor */
#if (LPTMR_ICU_IP_IRQ_VENDOR_ID_C != LPTMR_ICU_IP_VENDOR_ID)
    #error "Lptmr_Icu_Ip_Irq.c and Lptmr_Icu_Ip.h have different vendor IDs"
#endif
/* Check if source file and Lptmr_Icu_Ip.h header file are of the same AutoSar version */
#if ((LPTMR_ICU_IP_IRQ_AR_RELEASE_MAJOR_VERSION_C    != LPTMR_ICU_IP_AR_RELEASE_MAJOR_VERSION) || \
     (LPTMR_ICU_IP_IRQ_AR_RELEASE_MINOR_VERSION_C    != LPTMR_ICU_IP_AR_RELEASE_MINOR_VERSION) || \
     (LPTMR_ICU_IP_IRQ_AR_RELEASE_REVISION_VERSION_C != LPTMR_ICU_IP_AR_RELEASE_REVISION_VERSION))
    #error "AutoSar Version Numbers of Lptmr_Icu_Ip_Irq.c and Lptmr_Icu_Ip.h are different"
#endif
/* Check if source file and Lptmr_Icu_Ip.h header file are of the same Software version */
#if ((LPTMR_ICU_IP_IRQ_SW_MAJOR_VERSION_C != LPTMR_ICU_IP_SW_MAJOR_VERSION) || \
     (LPTMR_ICU_IP_IRQ_SW_MINOR_VERSION_C != LPTMR_ICU_IP_SW_MINOR_VERSION) || \
     (LPTMR_ICU_IP_IRQ_SW_PATCH_VERSION_C != LPTMR_ICU_IP_SW_PATCH_VERSION))
    #error "Software Version Numbers of Lptmr_Icu_Ip_Irq.c and Lptmr_Icu_Ip.h are different"
#endif
