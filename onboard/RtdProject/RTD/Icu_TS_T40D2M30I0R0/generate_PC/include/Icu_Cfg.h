...
#if (ICU_[!"text:toupper(.)"!]_PBCFG_VENDOR_ID != ICU_CFG_VENDOR_ID)
...
#if ((ICU_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_MAJOR_VERSION != ICU_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (ICU_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_MINOR_VERSION != ICU_CFG_AR_RELEASE_MINOR_VERSION) || \
     (ICU_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_REVISION_VERSION != ICU_CFG_AR_RELEASE_REVISION_VERSION))
...
#if ((ICU_[!"text:toupper(.)"!]_PBCFG_SW_MAJOR_VERSION != ICU_CFG_SW_MAJOR_VERSION) || \
     (ICU_[!"text:toupper(.)"!]_PBCFG_SW_MINOR_VERSION != ICU_CFG_SW_MINOR_VERSION) || \
     (ICU_[!"text:toupper(.)"!]_PBCFG_SW_PATCH_VERSION != ICU_CFG_SW_PATCH_VERSION))
 ...
 *         STD_OFF: Disabled.
 */
#define ICU_SET_MAX_COUNTER               ([!IF "node:exists(IcuAutosarExt/IcuSetMaxCounterValue)"!][!IF "IcuAutosarExt/IcuSetMaxCounterValue"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!][!ELSE!]STD_OFF[!ENDIF!])
 ...
 *         STD_OFF: Disabled.
 */
#define ICU_SET_INITIAL_COUNTER           ([!IF "node:exists(IcuAutosarExt/IcuSetInitialCounterValue)"!][!IF "IcuAutosarExt/IcuSetInitialCounterValue"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!][!ELSE!]STD_OFF[!ENDIF!])

[!ENDCODE!][!//
[!ENDIF!][!//
[!ENDNOCODE!][!//
[!NOCODE!][!//
[!IF "(ecu:has('Icu.Num_Emios_Hw_Modules'))"!][!//
[!CODE!]
/**
...
[!ENDNOCODE!][!//
[!NOCODE!][!//
[!IF "node:exists(IcuAutosarExt/IcuWSCSupport)"!][!//
[!CODE!]
/**
*   @brief   Support / Not Support eMios Wheel Speed channel.
*         STD_ON:  Support eMios Wheel Speed channel.
*         STD_OFF: Not Support eMios Wheel Speed channel.
*/
#define ICU_WSC_SUPPORT                   ([!IF "node:exists(IcuAutosarExt/IcuWSCSupport)"!][!IF "IcuAutosarExt/IcuWSCSupport"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!][!ELSE!]STD_OFF[!ENDIF!])
...
/**
 * @brief Implementation specific.
 *        Maximum value of A shadow register in Emios IPL
 */
#define ICU_SHADOW_REGISTER_MAX_MASK      (0xFFFFFFU)
#endif
...
/**
* @brief        Enable/Disable multiPartition feature for ICU driver.
*/
#define ICU_MULTIPARTITION_SUPPORT            ([!IF "node:value(IcuGeneral/IcuMultiPartitionSupport)='true'"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])

/**
* @brief      Define if global variables need to be placed in non-cache area or not
*/
#define ICU_NO_CACHE_USED                     ([!IF "num:i(count(IcuGeneral/IcuEcucPartitionRef/*)) > 1"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
