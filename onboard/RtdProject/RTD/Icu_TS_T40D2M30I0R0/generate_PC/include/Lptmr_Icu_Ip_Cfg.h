...
#define LPTMR_ICU_IP_CFG_SW_MAJOR_VERSION             3
...
#if (LPTMR_ICU_IP_[!"text:toupper(.)"!]_PBCFG_VENDOR_ID != LPTMR_ICU_IP_CFG_VENDOR_ID)
...
#if ((LPTMR_ICU_IP_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_MAJOR_VERSION != LPTMR_ICU_IP_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (LPTMR_ICU_IP_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_MINOR_VERSION != LPTMR_ICU_IP_CFG_AR_RELEASE_MINOR_VERSION) || \
     (LPTMR_ICU_IP_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_REVISION_VERSION != LPTMR_ICU_IP_CFG_AR_RELEASE_REVISION_VERSION) \
    )
...
#if ((LPTMR_ICU_IP_[!"text:toupper(.)"!]_PBCFG_SW_MAJOR_VERSION != LPTMR_ICU_IP_CFG_SW_MAJOR_VERSION) || \
     (LPTMR_ICU_IP_[!"text:toupper(.)"!]_PBCFG_SW_MINOR_VERSION != LPTMR_ICU_IP_CFG_SW_MINOR_VERSION) || \
     (LPTMR_ICU_IP_[!"text:toupper(.)"!]_PBCFG_SW_PATCH_VERSION != LPTMR_ICU_IP_CFG_SW_PATCH_VERSION) \
    )
...
[!IF "var:defined('postBuildVariant')"!][!//
    [!LOOP "variant:all()"!][!//
        [!CODE!][!WS "8"!]LPTMR_ICU_CONFIG_[!"text:toupper(.)"!]_PB \[!CR!][!ENDCODE!]
    [!ENDLOOP!][!//
[!ELSE!][!//
    [!CODE!][!WS "8"!]LPTMR_ICU_CONFIG_PB[!CR!][!ENDCODE!]
[!ENDIF!][!//
[!ENDIF!][!//
