...
[!NOCODE!]
    [!VAR "FeeLoopIt" = "$FeeLoopIt - 1"!]
    [!IF "../../FeeGeneral/FeeSwapForeignBlocksEnabled"!]
        [!VAR "FeeBlockAssignment" = "concat('FEE_PROJECT_', node:value(./FeeBlockAssignment))"!]
    [!ELSE!]
        [!VAR "FeeBlockAssignment" = "'FEE_PROJECT_RESERVED'"!]
    [!ENDIF!]
[!ENDNOCODE!]
    /* [!"node:name(.)"!] */
    {
