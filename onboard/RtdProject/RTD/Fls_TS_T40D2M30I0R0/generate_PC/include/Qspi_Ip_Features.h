...
==================================================================================================*/
[!IF "ecu:has('Fls.External.Qspi.Header')"!][!//
#include "[!"ecu:get('Fls.External.Qspi.Header')"!]"
[!ENDIF!][!//
...
#define FEATURE_QSPI_AHB_BUF_SIZE                     [!"ecu:get('Fls.External.Qspi.Ahb.Buffer.Size')"!]U
/*! @brief Size of Tx FIFO. */
#define FEATURE_QSPI_TX_BUF_SIZE                      [!"ecu:get('Fls.External.Qspi.Tx.Buffer.Size')"!]U
/*! @brief Size of Rx FIFO. */
#define FEATURE_QSPI_RX_BUF_SIZE                      [!"ecu:get('Fls.External.Qspi.Rx.Buffer.Size')"!]U
/*! @brief Number of LUT registers that make up a LUT sequence */
#define FEATURE_QSPI_LUT_SEQUENCE_SIZE                [!"ecu:get('Fls.External.Qspi.LutSequence.Size')"!]U
/* Minimum entries of 4 bytes fill needed to allow Tx operation to start */
#define FEATURE_QSPI_TX_MIN_BUF_FILL                  [!"ecu:get('Fls.External.Qspi.Tx.Buffer.Fill')"!]U
...
#define FEATURE_QSPI_FLASH_MDID_SIZE                  4U
