...
void Sai_0_Ip_DmaTxCompleteCallback(void)
{
    /* Call function to complete the send with DMA*/
...
void Sai_0_Ip_DmaTxErrorCallback(void)
{
    /* Call function to complete the send with DMA, parameter error set to TRUE*/
...
void Sai_0_Ip_DmaRxCompleteCallback(void)
{
    /* Call function to complete the reception with DMA*/
...
void Sai_0_Ip_DmaRxErrorCallback(void)
{
    /* Call function to complete the reception with DMA, parameter error set to TRUE*/
