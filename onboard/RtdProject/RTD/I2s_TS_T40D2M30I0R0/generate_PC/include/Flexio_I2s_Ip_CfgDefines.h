...
[!ENDIF!][!//
[!IF "contains($DerivativeName, 'S32K396') or contains($DerivativeName, 'S32K394') or contains($DerivativeName, 'S32K366') or contains($DerivativeName, 'S32K364')"!][!//
[!VAR "DerivativeName" = "'S32K39'"!][!//
[!ENDIF!][!//
[!IF "contains($DerivativeName, 'S32K376') or contains($DerivativeName, 'S32K374')"!][!//
[!VAR "DerivativeName" = "'S32K37'"!][!//
[!ENDIF!][!//
...
[!ELSE!][!//
[!IF "contains($DerivativeName, 'S32M244') or contains($DerivativeName, 'S32M243') or contains($DerivativeName, 'S32M242') or contains($DerivativeName, 'S32M241')"!][!//
...
#error "AutoSar Version Numbers of Flexio_I2s_Ip_CfgDefines.h and Std_Types.h are different"
#endif
