...
* @details      Maximum number of EcuC partitions available for configuration, depending on the number of partitions available.
*/
#define I2S_MAX_PARTITIONS             ([!"num:i($maxPartition)"!]U)

/**
* @brief        I2S_MULTIPARTITION_ENABLED.
* @details      This define indicate that the I2s Multipartition Support is enabled or disabled.
*/
#define I2S_MULTIPARTITION_ENABLED             (STD_ON)
...
* @details      This define indicate that the I2s Multipartition Support is enabled or disabled.
*/
#define I2S_MULTIPARTITION_ENABLED             (STD_OFF)
[!ENDIF!][!//
[!ENDNOCODE!][!//
