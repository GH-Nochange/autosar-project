...
static inline void Flexio_I2s_Ip_SetShifterControl(FLEXIO_Type *BaseAddr,
                                                   uint8 Shifter,
                                                   const Flexio_I2s_Ip_ShifterControl *ShifterControl)
{
 ...
 */
static inline boolean Flexio_I2s_Ip_GetShifterErrorInterrupt(const FLEXIO_Type *BaseAddr,
                                                             uint8 Shifter)
{
    boolean RetStatus;
 ...
 */
static inline boolean Flexio_I2s_Ip_GetShifterInterrupt(const FLEXIO_Type *BaseAddr,
                                                        uint8 Shifter)
{
    boolean RetStatus;
