...
#error "AutoSar Version Numbers of Sai_Ip_Types.h and Std_Types.h are different"
#endif
...
/*! @cond DRIVER_INTERNAL_USE_ONLY */
    ...
    Sai_Ip_TransferCallbackType pTxCallback;                /* Tx Callback function */
    Sai_Ip_TransferCallbackType pRxCallback;                /* Rx Callback function */
...
typedef struct
{
    ...
    Sai_Ip_TransferCallbackType pTxCallback; /*!< User Tx callback function, called when transfer complete or selected events occurred.*/
    Sai_Ip_TransferCallbackType pRxCallback; /*!< User Rx callback function, called when transfer complete or selected events occurred.*/
