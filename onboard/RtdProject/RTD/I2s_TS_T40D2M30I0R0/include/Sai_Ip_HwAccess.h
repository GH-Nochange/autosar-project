...
#error "AutoSar Version Numbers of Sai_Ip_HwAccess.h and Std_Types.h are different"
#endif
 ...
 * @implements   Sai_Ip_RxEnableFifoReqInt_Activity
 *END**************************************************************************/
 ...
 * @implements   Sai_Ip_RxEnableFifoReqDma_Activity
 *END**************************************************************************/
 ...
 * Description   : Enable fifo request interrupt
 *@implements    Sai_Ip_TxEnableFifoReqInt_Activity
 *END**************************************************************************/
 ...
 * Description   : Enable fifo request dma
 *@implements    Sai_Ip_TxEnableFifoReqDma_Activity
 *END**************************************************************************/
