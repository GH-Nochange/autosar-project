...
/**
*   @file       Ftfc_Eep_Ip[!"$variantName"!]_PBcfg.c
*
...
==================================================================================================*/
#define FTFC_EEP_IP[!"$variantNameUpperCase"!]_PBCFG_VENDOR_ID_C                      43
#define FTFC_EEP_IP[!"$variantNameUpperCase"!]_PBCFG_AR_RELEASE_MAJOR_VERSION_C       4
#define FTFC_EEP_IP[!"$variantNameUpperCase"!]_PBCFG_AR_RELEASE_MINOR_VERSION_C       4
#define FTFC_EEP_IP[!"$variantNameUpperCase"!]_PBCFG_AR_RELEASE_REVISION_VERSION_C    0
#define FTFC_EEP_IP[!"$variantNameUpperCase"!]_PBCFG_SW_MAJOR_VERSION_C               3
#define FTFC_EEP_IP[!"$variantNameUpperCase"!]_PBCFG_SW_MINOR_VERSION_C               0
#define FTFC_EEP_IP[!"$variantNameUpperCase"!]_PBCFG_SW_PATCH_VERSION_C               0
...
#if (FTFC_EEP_IP[!"$variantNameUpperCase"!]_PBCFG_VENDOR_ID_C != FTFC_EEP_IP_CFG_VENDOR_ID_H)
    #error "Ftfc_Eep_Ip[!"$variantName"!]_PBcfg.c and Ftfc_Eep_Ip_Cfg.h have different vendor IDs!"
#endif
#if ((FTFC_EEP_IP[!"$variantNameUpperCase"!]_PBCFG_AR_RELEASE_MAJOR_VERSION_C    != FTFC_EEP_IP_CFG_AR_RELEASE_MAJOR_VERSION_H) || \
     (FTFC_EEP_IP[!"$variantNameUpperCase"!]_PBCFG_AR_RELEASE_MINOR_VERSION_C    != FTFC_EEP_IP_CFG_AR_RELEASE_MINOR_VERSION_H) || \
     (FTFC_EEP_IP[!"$variantNameUpperCase"!]_PBCFG_AR_RELEASE_REVISION_VERSION_C != FTFC_EEP_IP_CFG_AR_RELEASE_REVISION_VERSION_H) \
    )
    #error "Ftfc_Eep_Ip[!"$variantName"!]_PBcfg.c and Ftfc_Eep_Ip_Cfg.h are for different AUTOSAR versions!"
#endif
#if ((FTFC_EEP_IP[!"$variantNameUpperCase"!]_PBCFG_SW_MAJOR_VERSION_C != FTFC_EEP_IP_CFG_SW_MAJOR_VERSION_H) || \
     (FTFC_EEP_IP[!"$variantNameUpperCase"!]_PBCFG_SW_MINOR_VERSION_C != FTFC_EEP_IP_CFG_SW_MINOR_VERSION_H) || \
     (FTFC_EEP_IP[!"$variantNameUpperCase"!]_PBCFG_SW_PATCH_VERSION_C != FTFC_EEP_IP_CFG_SW_PATCH_VERSION_H)    \
    )
    #error "Ftfc_Eep_Ip[!"$variantName"!]_PBcfg.c and Ftfc_Eep_Ip_Cfg.h have different SW versions!"
#endif
...
const Ftfc_Eep_Ip_ConfigType EepFtfcCfg[!"$variantName"!] =
{
