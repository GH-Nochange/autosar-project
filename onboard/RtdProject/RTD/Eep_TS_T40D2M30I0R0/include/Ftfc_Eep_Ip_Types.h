...
#define FTFC_EEP_IP_TYPES_SW_MAJOR_VERSION_H             3
...
==================================================================================================*/
    ...
    /* Version checks for Std_Types.h */
        ...
        #error "Ftfc_Eep_Ip_Types.h and Std_Types.h are for different AUTOSAR versions!"
    #endif
#endif
...
typedef enum
{
    FTFC_EEP_IP_STATUS_OK = 0,                  /**< success */
