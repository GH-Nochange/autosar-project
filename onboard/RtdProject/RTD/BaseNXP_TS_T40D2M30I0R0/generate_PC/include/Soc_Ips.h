...
[!//
[!/* These erratas are only exited on s32k142, s32k144 and s32k148 device. For s32k142w service, there is no information about errata from hardware team, so it is considered to not apply.*/!][!//
[!IF "((contains(node:value(node:fallback(ResourceGeneral/ResourceSubderivative,'')),'s32k142') or contains(node:value(node:fallback(ResourceGeneral/ResourceSubderivative,'')),'s32k144') or contains(node:value(node:fallback(ResourceGeneral/ResourceSubderivative,'')),'s32k148') or contains(node:value(node:fallback(ResourceGeneral/ResourceSubderivative,'')),'s32m242') or contains(node:value(node:fallback(ResourceGeneral/ResourceSubderivative,'')),'s32m241')) and (not(contains(node:value(node:fallback(ResourceGeneral/ResourceSubderivative,'')),'s32k142w'))))"!][!//
/**
...
[!SELECT "as:modconf('Resource')[1]"!][!//
[!//
[!/* This errata is not exited on s32k144w, s32m243 and s32m244 devices. For s32k142w service, there is no information about errata from hardware team, so it is considered to not apply.*/!][!//
[!IF "not(contains(node:value(node:fallback(ResourceGeneral/ResourceSubderivative,'')),'s32k142w') or contains(node:value(node:fallback(ResourceGeneral/ResourceSubderivative,'')),'s32k144w') or contains(node:value(node:fallback(ResourceGeneral/ResourceSubderivative,'')),'s32m243') or contains(node:value(node:fallback(ResourceGeneral/ResourceSubderivative,'')),'s32m244'))"!][!//
/**
...
[!SELECT "as:modconf('Resource')[1]"!][!//
[!//
[!/* For s32k142w service, there is no information about errata from hardware team, so this errata is considered to not apply. */!][!//
[!IF "not(contains(node:value(node:fallback(ResourceGeneral/ResourceSubderivative,'')),'s32k142w'))"!][!//
/**
...
[!SELECT "as:modconf('Resource')[1]"!][!//
[!//
[!/* This errata applies to k148 device only, for the SAI IP.*/!][!//
[!IF "contains(node:value(node:fallback(ResourceGeneral/ResourceSubderivative,'')),'s32k148')"!][!//
/**
* @brief Hardware errata for SAI: (e050476)
* @details e050476 SAI: FCONT must be disabled when TMR is higher than 0.
*/
#define ERR_IPV_SAI_ERR050476         (STD_ON)
[!ENDIF!][!//
[!ENDSELECT!][!//
[!//
[!SELECT "as:modconf('Resource')[1]"!][!//
[!//
[!/* This errata applies to k148 and K144 device, for the LPI2C IP.*/!][!//
[!IF "contains(node:value(node:fallback(ResourceGeneral/ResourceSubderivative,'')),'s32k148') or contains(node:value(node:fallback(ResourceGeneral/ResourceSubderivative,'')),'s32k144')"!][!//
/**
...
[!SELECT "as:modconf('Resource')[1]"!][!//
[!IF "contains(node:value(node:fallback(ResourceGeneral/ResourceSubderivative,'')),'s32k11')"!][!//
/*  ARM sub-architecture cortex M0+ */
#define MCAL_PLATFORM_ARM_M0PLUS
[!ELSE!][!//
