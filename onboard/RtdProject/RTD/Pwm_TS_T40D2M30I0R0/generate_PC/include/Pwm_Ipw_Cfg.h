...
*/
#define PWM_FAULT_SUPPORTED                     ([!IF "PwmGeneral/PwmFaultSupported"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
#define PWM_FAST_UPDATE_API                     ([!IF "(PwmConfigurationOfOptApiServices/PwmFastUpdateApi = 'true') and (PwmGeneral/PwmMultiChannelSync = 'true' )"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
