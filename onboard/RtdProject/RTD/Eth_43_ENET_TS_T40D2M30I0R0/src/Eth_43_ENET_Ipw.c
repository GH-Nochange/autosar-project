...
#include "Enet_Ip.h"
#include "Eth_43_ENET_Ipw_TrustedFunctions.h"

/*==================================================================================================
*                              SOURCE FILE VERSION INFORMATION
==================================================================================================*/
#define ETH_43_ENET_IPW_VENDOR_ID_C                      43
#define ETH_43_ENET_IPW_AR_RELEASE_MAJOR_VERSION_C       4
#define ETH_43_ENET_IPW_AR_RELEASE_MINOR_VERSION_C       7
#define ETH_43_ENET_IPW_AR_RELEASE_REVISION_VERSION_C    0
#define ETH_43_ENET_IPW_SW_MAJOR_VERSION_C               3
#define ETH_43_ENET_IPW_SW_MINOR_VERSION_C               0
#define ETH_43_ENET_IPW_SW_PATCH_VERSION_C               0

/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Checks against Eth_43_ENET_Ipw.h */
#if (ETH_43_ENET_IPW_VENDOR_ID_C != ETH_43_ENET_IPW_VENDOR_ID)
    #error "Eth_43_ENET_Ipw.c and Eth_43_ENET_Ipw.h have different vendor ids"
#endif
#if ((ETH_43_ENET_IPW_AR_RELEASE_MAJOR_VERSION_C    != ETH_43_ENET_IPW_AR_RELEASE_MAJOR_VERSION) || \
     (ETH_43_ENET_IPW_AR_RELEASE_MINOR_VERSION_C    != ETH_43_ENET_IPW_AR_RELEASE_MINOR_VERSION) || \
     (ETH_43_ENET_IPW_AR_RELEASE_REVISION_VERSION_C != ETH_43_ENET_IPW_AR_RELEASE_REVISION_VERSION))
    #error "AUTOSAR Version Numbers of Eth_43_ENET_Ipw.c and Eth_43_ENET_Ipw.h are different"
#endif
#if ((ETH_43_ENET_IPW_SW_MAJOR_VERSION_C != ETH_43_ENET_IPW_SW_MAJOR_VERSION) || \
     (ETH_43_ENET_IPW_SW_MINOR_VERSION_C != ETH_43_ENET_IPW_SW_MINOR_VERSION) || \
     (ETH_43_ENET_IPW_SW_PATCH_VERSION_C != ETH_43_ENET_IPW_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Eth_43_ENET_Ipw.c and Eth_43_ENET_Ipw.h are different"
#endif

/* Checks against Enet_Ip.h */
#if (ETH_43_ENET_IPW_VENDOR_ID_C != ENET_IP_VENDOR_ID)
    #error "Eth_43_ENET_Ipw.c and Enet_Ip.h have different vendor ids"
#endif
#if ((ETH_43_ENET_IPW_AR_RELEASE_MAJOR_VERSION_C    != ENET_IP_AR_RELEASE_MAJOR_VERSION) || \
     (ETH_43_ENET_IPW_AR_RELEASE_MINOR_VERSION_C    != ENET_IP_AR_RELEASE_MINOR_VERSION) || \
     (ETH_43_ENET_IPW_AR_RELEASE_REVISION_VERSION_C != ENET_IP_AR_RELEASE_REVISION_VERSION))
    #error "AUTOSAR Version Numbers of Eth_43_ENET_Ipw.c and Enet_Ip.h are different"
#endif
#if ((ETH_43_ENET_IPW_SW_MAJOR_VERSION_C != ENET_IP_SW_MAJOR_VERSION) || \
     (ETH_43_ENET_IPW_SW_MINOR_VERSION_C != ENET_IP_SW_MINOR_VERSION) || \
     (ETH_43_ENET_IPW_SW_PATCH_VERSION_C != ENET_IP_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Eth_43_ENET_Ipw.c and Enet_Ip.h are different"
#endif

/* Checks against Eth_43_ENET_Ipw_TrustedFunctions.h */
#if (ETH_43_ENET_IPW_VENDOR_ID_C != ETH_43_ENET_IPW_TRUSTEDFUNCTIONS_VENDOR_ID)
    #error "Eth_43_ENET_Ipw.c and Eth_43_ENET_Ipw_TrustedFunctions.h have different vendor ids"
#endif
#if ((ETH_43_ENET_IPW_AR_RELEASE_MAJOR_VERSION_C    != ETH_43_ENET_IPW_TRUSTEDFUNCTIONS_AR_RELEASE_MAJOR_VERSION) || \
     (ETH_43_ENET_IPW_AR_RELEASE_MINOR_VERSION_C    != ETH_43_ENET_IPW_TRUSTEDFUNCTIONS_AR_RELEASE_MINOR_VERSION) || \
     (ETH_43_ENET_IPW_AR_RELEASE_REVISION_VERSION_C != ETH_43_ENET_IPW_TRUSTEDFUNCTIONS_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AUTOSAR Version Numbers of Eth_43_ENET_Ipw.c and Eth_43_ENET_Ipw_TrustedFunctions.h are different"
#endif
#if ((ETH_43_ENET_IPW_SW_MAJOR_VERSION_C != ETH_43_ENET_IPW_TRUSTEDFUNCTIONS_SW_MAJOR_VERSION) || \
     (ETH_43_ENET_IPW_SW_MINOR_VERSION_C != ETH_43_ENET_IPW_TRUSTEDFUNCTIONS_SW_MINOR_VERSION) || \
     (ETH_43_ENET_IPW_SW_PATCH_VERSION_C != ETH_43_ENET_IPW_TRUSTEDFUNCTIONS_SW_PATCH_VERSION)    \
    )
    #error "Software Version Numbers of Eth_43_ENET_Ipw.c and Eth_43_ENET_Ipw_TrustedFunctions.h are different"
#endif
...
*                                       LOCAL MACROS
==================================================================================================*/
#define ETH_43_ENET_IPW_TIMEOUT_1MS_U32                 ((uint32)1U)
#define ETH_43_ENET_IPW_MAX_DEM_ERRORS_U32              ((uint32)ETH_NUMBER_OF_DEM_IDS)
/* Assign ENET_CTR_RMON_T_DROP to ETH_43_ENET_IPW_DEM_ERROR_UNUSED_U32 because DemErrorId = 0U never exist */
#define ETH_43_ENET_IPW_DEM_ERROR_UNUSED_U32            (ENET_CTR_NUMBER_OF_COUNTERS)

#if STD_ON == ETH_43_ENET_GLOBAL_TIME_API
    #define ETH_43_ENET_IPW_STONS_U64(u48Seconds)           ((uint64)((uint64)(u48Seconds) * (uint64)1000000000UL))
#endif

#if (STD_ON == ETH_43_ENET_ENABLE_USER_MODE_SUPPORT)
    #define Eth_43_ENET_Ipw_Local_Macro_RmiiClkOBE()   OsIf_Trusted_Call(Eth_43_ENET_Ipw_RmiiClkOBE)
#else
    #define Eth_43_ENET_Ipw_Local_Macro_RmiiClkOBE()   Eth_43_ENET_Ipw_RmiiClkOBE()
#endif
...
*                                      LOCAL VARIABLES
==================================================================================================*/
#define ETH_43_ENET_START_SEC_VAR_CLEARED_32
#include "Eth_43_ENET_MemMap.h"

#if (STD_ON == ETH_43_ENET_DEM_EVENT_DETECT)
    static uint32 Eth_43_ENET_Ipw_au32DemErrorCounters[ETH_43_ENET_MAX_CTRLIDX_SUPPORTED][ETH_43_ENET_IPW_MAX_DEM_ERRORS_U32];
#endif

static Eth_BufIdxType Eth_43_ENET_Ipw_axFirstTxBufferIdxInFifo[ETH_43_ENET_MAX_CTRLIDX_SUPPORTED][ETH_43_ENET_MAX_TXFIFO_SUPPORTED];

#define ETH_43_ENET_STOP_SEC_VAR_CLEARED_32
#include "Eth_43_ENET_MemMap.h"


#define ETH_43_ENET_START_SEC_CONST_32
#include "Eth_43_ENET_MemMap.h"

#if (STD_ON == ETH_43_ENET_DEM_EVENT_DETECT)
    /* Map between Eth_43_ENET_DemErrorIdType and Enet_Ip_CounterType */
    static const Enet_Ip_CounterType Eth_43_ENET_Ipw_au32DemErrIdToMmcCnt[ETH_43_ENET_IPW_MAX_DEM_ERRORS_U32] =
    {
        ETH_43_ENET_IPW_DEM_ERROR_UNUSED_U32,
...
#define ETH_43_ENET_STOP_SEC_CONST_32
#include "Eth_43_ENET_MemMap.h"
...
/* Eth_43_ENET_Receive is reentrant for different FIFOs so we need a pair of (Enet_Ip_BufferType, Enet_Ip_RxInfoType) for each FIFO */
static Enet_Ip_BufferType Eth_43_ENET_Ipw_RxFrameBuffer[ETH_43_ENET_MAX_CTRLIDX_SUPPORTED][ETH_43_ENET_MAX_RXFIFO_SUPPORTED];
static Enet_Ip_RxInfoType Eth_43_ENET_Ipw_RxFrameInfo[ETH_43_ENET_MAX_CTRLIDX_SUPPORTED][ETH_43_ENET_MAX_RXFIFO_SUPPORTED];

/* We cannot guarantee reentrancy in Eth_43_ENET_Transmit for different buffer indexes */
/* Make Eth_43_ENET_Transmit reentrant for different FIFOs so we need a pair of (Enet_Ip_BufferType, Enet_Ip_TxInfoType) for each FIFO */
static Enet_Ip_TxInfoType Eth_43_ENET_Ipw_axTxFrameInfo[ETH_43_ENET_MAX_CTRLIDX_SUPPORTED][ETH_43_ENET_MAX_TXFIFO_SUPPORTED];
...
static const boolean Eth_43_ENET_Ipw_InstHasExternalBufferManagement[FEATURE_ENET_NUM_INSTANCES] = ENET_IP_INST_HAS_EXTERNAL_BUFFERS;
...
#if ((STD_ON == ETH_43_ENET_DEM_EVENT_DETECT) || (STD_ON == ETH_43_ENET_GLOBAL_TIME_API))
/* Pointers to IPW configuration structures stored for later use */
const Eth_43_ENET_Ipw_CtrlConfigType *Eth_43_ENET_Ipw_apxInternalCfg[ETH_43_ENET_MAX_CTRLIDX_SUPPORTED];
#endif
...
static inline boolean Eth_43_ENET_Ipw_Local_IsOpenFilterPattern(const uint8 *PhyAddr);
static inline boolean Eth_43_ENET_Ipw_Local_IsCloseFilterPattern(const uint8 *PhyAddr);
static inline boolean Eth_43_ENET_Ipw_Local_IsMulticastAddress(const uint8 *PhyAddr);
...
/*================================================================================================*/
/**
* @brief         Output Buffer Enable for ENET RMII clock in internal loopback mode
*
* @return        void
*/
void Eth_43_ENET_Ipw_RmiiClkOBE(void)
{
    IP_SIM->MISCTRL0 |= SIM_MISCTRL0_RMII_CLK_OBE_MASK;
}
...
*
* @return        Eth_43_ENET_RxStatusType
...
*/
Eth_RxStatusType Eth_43_ENET_Ipw_ReceiveFrame ( \
                                           const uint8 CtrlIdx, \
                                           const uint8 FifoIdx, \
                                           uint8 **FrameData, \
                                           uint16 *FrameLength, \
                                      ...
                                      )
{
    ...
    if (ENET_STATUS_RX_QUEUE_EMPTY != Enet_Ip_ReadFrame(CtrlIdx, FifoIdx, &Eth_43_ENET_Ipw_RxFrameBuffer[CtrlIdx][FifoIdx], &Eth_43_ENET_Ipw_RxFrameInfo[CtrlIdx][FifoIdx]))
    {
        *FrameData   = Eth_43_ENET_Ipw_RxFrameBuffer[CtrlIdx][FifoIdx].Data;
        *FrameLength = Eth_43_ENET_Ipw_RxFrameInfo[CtrlIdx][FifoIdx].PktLen;
        *FrameHasError = ((0U != Eth_43_ENET_Ipw_RxFrameInfo[CtrlIdx][FifoIdx].ErrMask)? ((boolean)TRUE) : ((boolean)FALSE));
...
/*================================================================================================*/
/**
* @brief         Releases the resources locked by the previous call to function Eth_43_ENET_Ipw_ReceiveFrame
*
* @param[in]     CtrlIdx      Index of the controller
...
* @return        void
*/
void Eth_43_ENET_Ipw_ReleaseResources ( \
                                const uint8 CtrlIdx, \
                                const uint8 FifoIdx  \
                              )
{
    Enet_Ip_ProvideRxBuff(CtrlIdx, FifoIdx, &Eth_43_ENET_Ipw_RxFrameBuffer[CtrlIdx][FifoIdx]);

    /* Mark the buffer as released */
    Eth_43_ENET_Ipw_RxFrameBuffer[CtrlIdx][FifoIdx].Data = NULL_PTR;
}
...
*/
Std_ReturnType Eth_43_ENET_Ipw_GetRxStats ( \
                       uint8 CtrlIdx, \
...
*/
Std_ReturnType Eth_43_ENET_Ipw_GetTxStats ( \
                       uint8 CtrlIdx, \
...
*                e.g. this counter is not available..
*/
Std_ReturnType Eth_43_ENET_Ipw_GetTxErrorCounterValues ( \
                       uint8 CtrlIdx, \
...
*/
Std_ReturnType Eth_43_ENET_Ipw_SetGlobalTime ( \
                      uint8 CtrlIdx, \
                      const Eth_43_ENET_ClockCfgType *ClkCfg, \
...
*/
Std_ReturnType Eth_43_ENET_Ipw_SetCorrectionTime ( \
                        uint8 CtrlIdx, \
                        const Eth_43_ENET_ClockCfgType *ClkCfg, \
                            ...
                            )
{
    ...
    RemoteTime = ETH_43_ENET_IPW_STONS_U64(
    ...
    LocalTime  = ETH_43_ENET_IPW_STONS_U64(
    ...
    if (RemoteTime != LocalTime)
    {
        ...
        if (Eth_43_ENET_Ipw_apxInternalCfg[CtrlIdx]->CorectionCounter < LocalCycleNums)
        {
            /* The amount of time elapsed with normal increment before trigger correction */
            NormalTimer = Eth_43_ENET_Ipw_apxInternalCfg[CtrlIdx]->CorectionCounter * NormalInc;
            
            /* Calculate correction increment value for each cycle */
            CorrectInc = (uint32)((RemoteTime - NormalTimer) / (LocalCycleNums - Eth_43_ENET_Ipw_apxInternalCfg[CtrlIdx]->CorectionCounter));
            ...
            Enet_Ip_TimerSetCorrection(CtrlIdx, (uint32)CorrectInc, Eth_43_ENET_Ipw_apxInternalCfg[CtrlIdx]->CorectionCounter);
        } 
        else
        {
            ReturnStatus = (Std_ReturnType)E_NOT_OK;
...
*/
Std_ReturnType Eth_43_ENET_Ipw_GetCurrentTime    ( \
                      uint8 CtrlIdx, \
...
*/
void Eth_43_ENET_Ipw_EnableEgressTimeStamp   ( \
                                uint8 CtrlIdx, \
...
*/
void Eth_43_ENET_Ipw_GetEgressTimeStamp  ( \
                                    const uint8 CtrlIdx, \
...
{
    const uint8 FifoIdx = Eth_43_ENET_axTxBufferIdxMap[CtrlIdx][BufIdx].FifoIdx;
    if (0U == Eth_43_ENET_Ipw_axTxFrameInfo[CtrlIdx][FifoIdx].TimeStamp.nanoseconds)
    {
        *TimeQual= ETH_INVALID;
    }
    else
    {
        TimeStamp->nanoseconds = Eth_43_ENET_Ipw_axTxFrameInfo[CtrlIdx][FifoIdx].TimeStamp.nanoseconds;
        TimeStamp->seconds     = Eth_43_ENET_Ipw_axTxFrameInfo[CtrlIdx][FifoIdx].TimeStamp.seconds;
        TimeStamp->secondsHi   = Eth_43_ENET_Ipw_axTxFrameInfo[CtrlIdx][FifoIdx].TimeStamp.secondsHi;
...
* @param[out]   TimeStampPtr current time stamp.
*/
void Eth_43_ENET_Ipw_GetIngressTimeStamp ( \
                                    const uint8 CtrlIdx, \
                                    const uint8 FifoIdx, \
...
{
    if (FrameData == Eth_43_ENET_Ipw_RxFrameBuffer[CtrlIdx][FifoIdx].Data)
    {
        if (0U == Eth_43_ENET_Ipw_RxFrameInfo[CtrlIdx][FifoIdx].TimeStamp.nanoseconds)
        {
            *TimeQual = ETH_INVALID;
        }
        else
        {
            TimeStamp->nanoseconds = Eth_43_ENET_Ipw_RxFrameInfo[CtrlIdx][FifoIdx].TimeStamp.nanoseconds;
            TimeStamp->seconds     = Eth_43_ENET_Ipw_RxFrameInfo[CtrlIdx][FifoIdx].TimeStamp.seconds;
            TimeStamp->secondsHi   = Eth_43_ENET_Ipw_RxFrameInfo[CtrlIdx][FifoIdx].TimeStamp.secondsHi;
...
* @details      This function is only called by "Eth_43_ENET_MainFunction"
*/
boolean Eth_43_ENET_Ipw_ErrorDetected( \
                            const uint8 CtrlIdx, \
                             ...
                             )
{
    ...
    OldValue = Eth_43_ENET_Ipw_au32DemErrorCounters[CtrlIdx][(uint32)DemErrorId];
    MmcCounter  = Eth_43_ENET_Ipw_au32DemErrIdToMmcCnt[(uint32)DemErrorId];
    Eth_43_ENET_Ipw_au32DemErrorCounters[CtrlIdx][(uint32)DemErrorId] = Enet_Ip_GetCounter(CtrlIdx, MmcCounter);

    return ((Eth_43_ENET_Ipw_au32DemErrorCounters[CtrlIdx][(uint32)DemErrorId] > OldValue) ? ((boolean)TRUE) : ((boolean)FALSE));
}
#endif
...
*/
boolean Eth_43_ENET_Ipw_CheckAccessToController(const uint8 CtrlIdx)
{
...
*/
Std_ReturnType Eth_43_ENET_Ipw_TxTimeAwareShaperInit ( \
                                    uint8 CtrlIdx, \
                                    const Eth_43_ENET_Ipw_CtrlConfigType *IpwCtrlCfg \
                                    )
{
    (void)CtrlIdx;
    (void)IpwCtrlCfg;
...
*/
Std_ReturnType Eth_43_ENET_Ipw_ConfigureController  ( \
                                    const uint8 CtrlIdx, \
                                    const Eth_43_ENET_Ipw_CtrlConfigType *IpwCtrlCfg, \
                                    const Eth_43_ENET_ClockCfgType *ClkCfg \
                                         )
...
#if ((STD_ON == ETH_43_ENET_DEM_EVENT_DETECT) || (STD_ON == ETH_43_ENET_GLOBAL_TIME_API))
    Eth_43_ENET_Ipw_apxInternalCfg[CtrlIdx] = IpwCtrlCfg;
#endif

#if (STD_ON == ETH_43_ENET_DEM_EVENT_DETECT)
    for (Counter = 0U; Counter < ETH_43_ENET_IPW_MAX_DEM_ERRORS_U32; ++Counter)
    {
        Eth_43_ENET_Ipw_au32DemErrorCounters[CtrlIdx][Counter] = 0U;
    }
#endif

    for (Counter = 0U; Counter < ETH_43_ENET_MAX_RXFIFO_SUPPORTED; ++Counter)
    {
        Eth_43_ENET_Ipw_RxFrameBuffer[CtrlIdx][Counter].Data = NULL_PTR;
    }

    Eth_43_ENET_Ipw_axFirstTxBufferIdxInFifo[CtrlIdx][0U] = 0U;
#if (ETH_43_ENET_MAX_TXFIFO_SUPPORTED > 1U)
    for (Counter = 1U; Counter < IpwCtrlCfg->Eth_43_ENET_Ipw_pEnetCtrlConfig->Enet_pCtrlConfig->TxRingCount; ++Counter)
    {
        Eth_43_ENET_Ipw_axFirstTxBufferIdxInFifo[CtrlIdx][Counter] = Eth_43_ENET_Ipw_axFirstTxBufferIdxInFifo[CtrlIdx][Counter - 1U] +
                                                                   IpwCtrlCfg->Eth_43_ENET_Ipw_pEnetCtrlConfig->Enet_paCtrlTxRingConfig[Counter - 1U].RingSize;
    }
#endif

    /* Output Buffer Enable for ENET RMII clock in internal loopback mode. */
    if ((IpwCtrlCfg->Eth_43_ENET_Ipw_pEnetCtrlConfig->Enet_pCtrlConfig->RxConfig & ((uint32)ENET_RCR_LOOP_MASK)) != 0U)
    {
        Eth_43_ENET_Ipw_Local_Macro_RmiiClkOBE();
    }

    Enet_Ip_Init(CtrlIdx, IpwCtrlCfg->Eth_43_ENET_Ipw_pEnetCtrlConfig);
...
#if ((STD_ON == ETH_43_ENET_ENABLE_OFFLOAD_CRC_ICMP) || (STD_ON == ETH_43_ENET_ENABLE_OFFLOAD_CRC_TCP) || (STD_ON == ETH_43_ENET_ENABLE_OFFLOAD_CRC_UDP) || (STD_ON == ETH_43_ENET_ENABLE_OFFLOAD_CRC_IPV4))
...
*/
Std_ReturnType Eth_43_ENET_Ipw_EnableController(const uint8 CtrlIdx)
{
...
*                Eth_43_ENET_Ipw_DisableController function is called.
*/
Std_ReturnType Eth_43_ENET_Ipw_DisableController(const uint8 CtrlIdx)
{
...
*/
Eth_ModeType Eth_43_ENET_Ipw_GetControllerMode(const uint8 CtrlIdx)
{
...
*/
void Eth_43_ENET_Ipw_GetPhysicalAddress  ( \
                const uint8 CtrlIdx, \
                uint8 *PhysAddrPtr \
                                 )
{
...
*/
void Eth_43_ENET_Ipw_SetPhysicalAddress ( \
                    const uint8 CtrlIdx, \
...
*/
BufReq_ReturnType Eth_43_ENET_Ipw_ProvideTxBuffer (  \
                                    const uint8 CtrlIdx, \
                                    const uint8 FifoIdx, \
                                          ...
                                          )
{
    ...
    if (ENET_STATUS_SUCCESS == Status)
    {
        ...
        *BufferIdx = Eth_43_ENET_Ipw_axFirstTxBufferIdxInFifo[CtrlIdx][FifoIdx] + u16BufferIdxWithinFifo;
        /* In case internal buffers are enabled on all controllers, assign the data buffer address returned from the driver.*/
#if (STD_OFF == ETH_43_ENET_HAS_EXTERNAL_TX_BUFFERS)
        *FrameBuffer = TxFrameBuffer.Data;
        ...
        if (Eth_43_ENET_Ipw_InstHasExternalBufferManagement[CtrlIdx])
        {
            (void)FrameBuffer;
        }
        else
...
void Eth_43_ENET_Ipw_ProvideRxBuffer(uint8 CtrlIdx, uint8 FifoIdx, uint8 *BufferData)
{
    Enet_Ip_BufferType BuffInfo;

    BuffInfo.Length = ENET_0_MAX_RXBUFFLEN_SUPPORTED;
    BuffInfo.Data = BufferData;

    Enet_Ip_ProvideRxBuff( CtrlIdx, FifoIdx, &BuffInfo);
}
...
*                be confirmed or not
*/
Std_ReturnType Eth_43_ENET_Ipw_Transmit ( \
                                const uint8 CtrlIdx, \
                                const uint8 FifoIdx,  \
                                uint8 *Buffer, \
                                const uint16 Length \
                                )
{
...
#elif ((STD_ON == ETH_43_ENET_ENABLE_OFFLOAD_CRC_ICMP) || (STD_ON == ETH_43_ENET_ENABLE_OFFLOAD_CRC_TCP) || (STD_ON == ETH_43_ENET_ENABLE_OFFLOAD_CRC_UDP))
    TxOptions.ChecksumIns = ENET_CHECKSUM_INSERTION_PROTO;
#elif (STD_ON == ETH_43_ENET_ENABLE_OFFLOAD_CRC_IPV4)
    ...
    (void) Eth_43_ENET_pLastTransmissionRequestQueueTail;
...
*/
Std_ReturnType Eth_43_ENET_Ipw_GetCounterValues  ( \
                               uint8 CtrlIdx, \
...
*/
boolean Eth_43_ENET_Ipw_WriteMii    ( \
                    const uint8 CtrlIdx, \
                    const uint8 Trcv, \
                    const uint8 Reg, \
                    const uint16 Data
                            )
{
    ...
    return ((ENET_STATUS_SUCCESS == Enet_Ip_MDIOWrite(CtrlIdx, Trcv, Reg, Data, ETH_43_ENET_IPW_TIMEOUT_1MS_U32))? (TRUE) : (FALSE));
}
...
* @retval        FALSE Failure, no response from the hardware within a timeout.
*/
boolean Eth_43_ENET_Ipw_ReadMii ( \
                        const uint8 CtrlIdx, \
                        const uint8 Trcv, \
                        const uint8 Reg, \
                        uint16 * const Data
...
{ 
    /* 1 millisecond is enough to transfer about 16 MDIO frames at an MDC frequency of 1MHz. */
    return ((ENET_STATUS_SUCCESS == Enet_Ip_MDIORead(CtrlIdx, Trcv, Reg, Data, ETH_43_ENET_IPW_TIMEOUT_1MS_U32))? (TRUE) : (FALSE));
}
#endif
...
* @retval        FALSE Failure, no response from the hardware within a timeout.
*/
boolean Eth_43_ENET_Ipw_ReadMmd ( \
                             const uint8 CtrlIdx,\
                             const uint8 TrcvIdx, \
                             const uint8 Mmd, \
                        ...
                        )
{
    ...
    return ((ENET_STATUS_SUCCESS == Enet_Ip_MDIOReadMMD(CtrlIdx, TrcvIdx, Mmd, RegAddress, RegValPtr, ETH_43_ENET_IPW_TIMEOUT_1MS_U32))? (TRUE) : (FALSE));
}
...
* @retval        FALSE Failure, no response from the hardware within a timeout.
*/
boolean Eth_43_ENET_Ipw_WriteMmd ( \
                              const uint8 CtrlIdx,\
                              const uint8 TrcvIdx, \
                              const uint8 Mmd, \
                              const uint16 RegAddress,\
...
{
    /* 1 millisecond is enough to transfer about 8 MMD frames at an MDC frequency of 1MHz. */
    return ((ENET_STATUS_SUCCESS == Enet_Ip_MDIOWriteMMD(CtrlIdx, TrcvIdx, Mmd, RegAddress, RegVal, ETH_43_ENET_IPW_TIMEOUT_1MS_U32))? (TRUE) : (FALSE));
}
#endif
...
Std_ReturnType Eth_43_ENET_Ipw_UpdatePhysAddrFilter ( \
                                    uint8 CtrlIdx, \
                                    ...
                                    )
{
    ...
    if (Eth_43_ENET_Ipw_Local_IsOpenFilterPattern(PhysAddr))
    {
    ...
    else if (Eth_43_ENET_Ipw_Local_IsCloseFilterPattern(PhysAddr))
    {
    ...
    {
        if (Eth_43_ENET_Ipw_Local_IsMulticastAddress(PhysAddr))
        {
...
*/
void Eth_43_ENET_Ipw_ReportTransmission(
                                const Eth_43_ENET_CtrlCfgType *EthControllerConfig, \
                                const uint8 FifoIdx \
                           )
{
    ...
    if (FifoIdx < ETH_43_ENET_MAX_TXFIFO_SUPPORTED)
    {
        /*Get the pointer to the first frame*/
        Iter = Eth_43_ENET_axTransmissionRequests[CtrlIdx][FifoIdx].pQueueHead;
        ...
        while ((Iter != NULL_PTR))
        {
            ...
            EnetStatus = Enet_Ip_GetTransmitStatus(CtrlIdx, FifoIdx, &TxFrameBuffer, &Eth_43_ENET_Ipw_axTxFrameInfo[CtrlIdx][FifoIdx]);

            if (ENET_STATUS_SUCCESS == EnetStatus)
            {
                ...
                {
                    BufIdx   = (Eth_BufIdxType)((sint32)(Iter - Eth_43_ENET_axTxBufferIdxMap[CtrlIdx]));
                    FrameHasError = ((0U == Eth_43_ENET_Ipw_axTxFrameInfo[CtrlIdx][FifoIdx].ErrMask)? ((boolean)FALSE) : ((boolean)TRUE));
                ...
                Eth_43_ENET_axTransmissionRequests[CtrlIdx][FifoIdx].pQueueHead = Iter->pNextBuffer;
                Iter = Iter->pNextBuffer;
            }
            /*In case of returning ENET_STATUS_BUSY, the hardware buffer descriptor is still in use, therefore the transmission is not completely done*/
            else
            {
                break;
            }
