...
#define ENET_IP_HW_ACCESS_AR_RELEASE_MINOR_VERSION_C       7
#define ENET_IP_HW_ACCESS_AR_RELEASE_REVISION_VERSION_C    0
#define ENET_IP_HW_ACCESS_SW_MAJOR_VERSION_C               3
#define ENET_IP_HW_ACCESS_SW_MINOR_VERSION_C               0
#define ENET_IP_HW_ACCESS_SW_PATCH_VERSION_C               0
...
#define ETH_43_ENET_START_SEC_VAR_INIT_UNSPECIFIED
#include "Eth_43_ENET_MemMap.h"
/**
...
#define ETH_43_ENET_STOP_SEC_VAR_INIT_UNSPECIFIED
#include "Eth_43_ENET_MemMap.h"
...
{
    ENET_Type *Base = Enet_apxBases[Instance];
    uint32 IrqEnFlags = (uint32)ENET_EIMR_PLR_MASK | (uint32)ENET_EIMR_BABT_MASK | (uint32)ENET_EIMR_BABR_MASK |
...
Enet_Ip_PowerStateType ENET_GetPowerState(const ENET_Type * Base)
{
    ...
    else if (((Base->ECR & ENET_ECR_DBGEN_MASK) == ENET_ECR_DBGEN_MASK) || ((Base->ECR & ENET_ECR_ETHEREN_MASK) == 0U))
    {
                                             ...
                                             uint32 TimeoutUs)
{
    ...
    /* Add fault injection label for testing */
