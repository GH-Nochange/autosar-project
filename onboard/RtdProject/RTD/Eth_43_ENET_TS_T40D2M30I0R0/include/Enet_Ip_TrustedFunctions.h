...
#define ENET_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MINOR_VERSION     7
#define ENET_IP_TRUSTEDFUNCTIONS_AR_RELEASE_REVISION_VERSION  0
#define ENET_IP_TRUSTEDFUNCTIONS_SW_MAJOR_VERSION             3
#define ENET_IP_TRUSTEDFUNCTIONS_SW_MINOR_VERSION             0
#define ENET_IP_TRUSTEDFUNCTIONS_SW_PATCH_VERSION             0
