...
#define ENET_IP_FEATURES_AR_RELEASE_MINOR_VERSION     7
#define ENET_IP_FEATURES_AR_RELEASE_REVISION_VERSION  0
#define ENET_IP_FEATURES_SW_MAJOR_VERSION             3
#define ENET_IP_FEATURES_SW_MINOR_VERSION             0
#define ENET_IP_FEATURES_SW_PATCH_VERSION             0
...
[!IF "node:exists(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative)"!][!// 
    ...
    #define FEATURE_ENET_CACHABLE_BUFFERS_LMEM              (1U)
    #define FEATURE_ENET_CACHABLE_BUFFERS_CORE              (0U)
