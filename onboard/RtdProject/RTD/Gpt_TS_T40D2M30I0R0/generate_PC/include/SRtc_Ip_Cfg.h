...
[!IF "var:defined('postBuildVariant')"!]
    [!LOOP "variant:all()"!]
#if (SRTC_IP_VENDOR_ID_CFG != SRTC_IP_VENDOR_ID_[!"text:toupper(.)"!]_PBCFG_H)
    #error "SRtc_Ip_Cfg.h and SRtc_Ip_[!"."!]_PBcfg.h have different vendor ids"
#endif
/* Check if this header file and header file are of the same Autosar version */
#if ((SRTC_IP_AR_RELEASE_MAJOR_VERSION_CFG != SRTC_IP_AR_RELEASE_MAJOR_VERSION_[!"text:toupper(.)"!]_PBCFG_H) || \
     (SRTC_IP_AR_RELEASE_MINOR_VERSION_CFG != SRTC_IP_AR_RELEASE_MINOR_VERSION_[!"text:toupper(.)"!]_PBCFG_H) || \
     (SRTC_IP_AR_RELEASE_REVISION_VERSION_CFG != SRTC_IP_AR_RELEASE_REVISION_VERSION_[!"text:toupper(.)"!]_PBCFG_H) \
    )
    #error "AutoSar Version Numbers of SRtc_Ip_Cfg.h and SRtc_Ip_[!"."!]_PBcfg.h are different"
#endif
/* Check if this header file and header file are of the same Software version */
#if ((SRTC_IP_SW_MAJOR_VERSION_CFG != SRTC_IP_SW_MAJOR_VERSION_[!"text:toupper(.)"!]_PBCFG_H) || \
     (SRTC_IP_SW_MINOR_VERSION_CFG != SRTC_IP_SW_MINOR_VERSION_[!"text:toupper(.)"!]_PBCFG_H) || \
     (SRTC_IP_SW_PATCH_VERSION_CFG != SRTC_IP_SW_PATCH_VERSION_[!"text:toupper(.)"!]_PBCFG_H) \
    )
    #error "Software Version Numbers of SRtc_Ip_Cfg.h and SRtc_Ip_[!"."!]_PBcfg.h are different"
#endif
    [!ENDLOOP!]
[!ELSE!]
...
*/
#define SRTC_IP_DEV_ERROR_DETECT ([!IF "GptDriverConfiguration/GptDevErrorDetect"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
/*================================================================================================*/
/**
...
*/
#define SRTC_IP_ENABLE_USER_MODE_SUPPORT    ([!IF "GptAutosarExt/GptEnableUserModeSupport"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
*/
#define SRTC_IP_STANDBY_WAKEUP_SUPPORT    ([!IF "GptAutosarExt/GptStandbyWakeupSupport"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
