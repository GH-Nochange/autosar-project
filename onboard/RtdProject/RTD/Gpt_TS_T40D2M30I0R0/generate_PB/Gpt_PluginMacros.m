...
[!SELECT "node:ref($path_predef)"!]
    ...
    [!ENDIF!]
    [!IF "contains(GptHwChannel,'CE') or contains(GptHwChannel,'RTU') or contains(GptHwChannel,'SMU') or 
            contains(GptHwChannel,'FSS') or contains(GptHwChannel,'CRS')"!][!//
        [!VAR "InstanceName" = "substring-before(GptHwChannel,'_PREDEF')"!]
        [!IF "($InstanceName = 'CE_STM_0') or ($InstanceName = 'CRS_STM_0') or ($InstanceName = 'FSS_COSS_FTM_0')"!]
            [!CODE!][!WS "4"!](uint8)0U, /* hw instance no. */[!CR!][!ENDCODE!]
        [!ELSEIF "($InstanceName = 'CE_STM_1') or ($InstanceName = 'FSS_COSS_STM_0') or ($InstanceName = 'FSS_COSS_FTM_1')"!]
            [!CODE!][!WS "4"!](uint8)1U, /* hw instance no. */[!CR!][!ENDCODE!]
        [!ELSEIF "($InstanceName = 'CE_STM_2') or ($InstanceName = 'FSS_COSS_STM_1') or ($InstanceName = 'FSS_COSS_FTM_2')"!]
            [!CODE!][!WS "4"!](uint8)2U, /* hw instance no. */[!CR!][!ENDCODE!]
        [!ELSEIF "($InstanceName = 'FSS_COSS_STM_2') or ($InstanceName = 'FSS_COSS_FTM_3')"!]
            [!CODE!][!WS "4"!](uint8)3U, /* hw instance no. */[!CR!][!ENDCODE!]
        [!ELSEIF "($InstanceName = 'FSS_COSS_STM_3') or ($InstanceName = 'FSS_HKI_FTM_0')"!]
            [!CODE!][!WS "4"!](uint8)4U, /* hw instance no. */[!CR!][!ENDCODE!]
        [!ELSEIF "($InstanceName = 'FSS_STM_0') or ($InstanceName = 'FSS_HKI_FTM_1')"!]
            [!CODE!][!WS "4"!](uint8)5U, /* hw instance no. */[!CR!][!ENDCODE!]
        [!ELSEIF "($InstanceName = 'FSS_STM_1')"!]
            [!CODE!][!WS "4"!](uint8)6U, /* hw instance no. */[!CR!][!ENDCODE!]
        [!ELSEIF "($InstanceName = 'FSS_AUX_STM_0')"!]
            [!CODE!][!WS "4"!](uint8)7U, /* hw instance no. */[!CR!][!ENDCODE!]
        [!ELSEIF "($InstanceName = 'FSS_AUX_STM_1')"!]
            [!CODE!][!WS "4"!](uint8)8U, /* hw instance no. */[!CR!][!ENDCODE!]
        [!ELSEIF "($InstanceName = 'FSS_AUX_STM_2')"!]
        ...
        [!ELSEIF "($InstanceName = 'RTU0_STM_3')"!]
            [!IF "contains($DerivativeName,'S32Z2') or contains($DerivativeName,'S32E2')"!][!//
                [!CODE!][!WS "4"!](uint8)6U, /* hw instance no. */[!CR!][!ENDCODE!]
            [!ELSEIF "contains($DerivativeName,'S32N5')"!][!//
                [!CODE!][!WS "4"!](uint8)13U, /* hw instance no. */[!CR!][!ENDCODE!]
            [!ENDIF!][!//
        [!ELSEIF "($InstanceName = 'RTU1_STM_0')"!]
            [!IF "contains($DerivativeName,'S32Z2') or contains($DerivativeName,'S32E2')"!][!//
                [!CODE!][!WS "4"!](uint8)7U, /* hw instance no. */[!CR!][!ENDCODE!]
            [!ELSEIF "contains($DerivativeName,'S32N5')"!][!//
                [!CODE!][!WS "4"!](uint8)14U, /* hw instance no. */[!CR!][!ENDCODE!]
            [!ENDIF!][!//
        [!ELSEIF "($InstanceName = 'RTU1_STM_1')"!]
            [!IF "contains($DerivativeName,'S32Z2') or contains($DerivativeName,'S32E2')"!][!//
                [!CODE!][!WS "4"!](uint8)8U, /* hw instance no. */[!CR!][!ENDCODE!]
            [!ELSEIF "contains($DerivativeName,'S32N5')"!][!//
                [!CODE!][!WS "4"!](uint8)15U, /* hw instance no. */[!CR!][!ENDCODE!]
            [!ENDIF!][!//
        [!ELSEIF "($InstanceName = 'RTU1_STM_2')"!]
            [!IF "contains($DerivativeName,'S32Z2') or contains($DerivativeName,'S32E2')"!][!//
                [!CODE!][!WS "4"!](uint8)9U, /* hw instance no. */[!CR!][!ENDCODE!]
            [!ELSEIF "contains($DerivativeName,'S32N5')"!][!//
                [!CODE!][!WS "4"!](uint8)16U, /* hw instance no. */[!CR!][!ENDCODE!]
            [!ENDIF!][!//
        [!ELSEIF "($InstanceName = 'RTU1_STM_3')"!]
            [!IF "contains($DerivativeName,'S32Z2') or contains($DerivativeName,'S32E2')"!][!//
                [!CODE!][!WS "4"!](uint8)10U, /* hw instance no. */[!CR!][!ENDCODE!]
            [!ELSEIF "contains($DerivativeName,'S32N5')"!][!//
                [!CODE!][!WS "4"!](uint8)17U, /* hw instance no. */[!CR!][!ENDCODE!]
            [!ENDIF!][!//
        [!ELSEIF "($InstanceName = 'SMU_STM_0')"!]
            [!CODE!][!WS "4"!](uint8)11U, /* hw instance no. */[!CR!][!ENDCODE!]
        [!ELSEIF "($InstanceName = 'SMU_STM_2')"!]
            [!CODE!][!WS "4"!](uint8)12U, /* hw instance no. */[!CR!][!ENDCODE!]
        [!ELSEIF "($InstanceName = 'RTU2_STM_0')"!]
            [!IF "contains($DerivativeName,'S32N5')"!][!//
                [!CODE!][!WS "4"!](uint8)18U, /* hw instance no. */[!CR!][!ENDCODE!]
            [!ENDIF!][!//
        [!ELSEIF "($InstanceName = 'RTU2_STM_1')"!]
            [!IF "contains($DerivativeName,'S32N5')"!][!//
                [!CODE!][!WS "4"!](uint8)19U, /* hw instance no. */[!CR!][!ENDCODE!]
            [!ENDIF!][!//
        [!ELSEIF "($InstanceName = 'RTU2_STM_2')"!]
            [!IF "contains($DerivativeName,'S32N5')"!][!//
                [!CODE!][!WS "4"!](uint8)20U, /* hw instance no. */[!CR!][!ENDCODE!]
            [!ENDIF!][!//
        [!ELSEIF "($InstanceName = 'RTU2_STM_3')"!]
            [!IF "contains($DerivativeName,'S32N5')"!][!//
                [!CODE!][!WS "4"!](uint8)21U, /* hw instance no. */[!CR!][!ENDCODE!]
            [!ENDIF!][!//
        [!ELSEIF "($InstanceName = 'RTU3_STM_0')"!]
            [!IF "contains($DerivativeName,'S32N5')"!][!//
                [!CODE!][!WS "4"!](uint8)22U, /* hw instance no. */[!CR!][!ENDCODE!]
            [!ENDIF!][!//
        [!ELSEIF "($InstanceName = 'RTU3_STM_1')"!]
            [!IF "contains($DerivativeName,'S32N5')"!][!//
                [!CODE!][!WS "4"!](uint8)23U, /* hw instance no. */[!CR!][!ENDCODE!]
            [!ENDIF!][!//
        [!ELSEIF "($InstanceName = 'RTU3_STM_2')"!]
            [!IF "contains($DerivativeName,'S32N5')"!][!//
                [!CODE!][!WS "4"!](uint8)24U, /* hw instance no. */[!CR!][!ENDCODE!]
            [!ENDIF!][!//
        [!ELSEIF "($InstanceName = 'RTU3_STM_3')"!]
            [!IF "contains($DerivativeName,'S32N5')"!][!//
                [!CODE!][!WS "4"!](uint8)25U, /* hw instance no. */[!CR!][!ENDCODE!]
            [!ENDIF!][!//
        [!ELSEIF "($InstanceName = 'CRS_PIT_0')"!]
            [!CODE!][!WS "4"!](uint8)0U, /* hw instance no. */[!CR!][!ENDCODE!]
        [!ELSEIF "($InstanceName = 'CRS_PIT_1')"!]
            [!CODE!][!WS "4"!](uint8)1U, /* hw instance no. */[!CR!][!ENDCODE!]
        [!ELSEIF "($InstanceName = 'FSS_COSS_PIT_0')"!]
            [!CODE!][!WS "4"!](uint8)2U, /* hw instance no. */[!CR!][!ENDCODE!]
        [!ELSEIF "($InstanceName = 'FSS_COSS_PIT_1')"!]
            [!CODE!][!WS "4"!](uint8)3U, /* hw instance no. */[!CR!][!ENDCODE!]
        [!ELSEIF "($InstanceName = 'FSS_COSS_PIT_2')"!]
            [!CODE!][!WS "4"!](uint8)4U, /* hw instance no. */[!CR!][!ENDCODE!]
        [!ELSEIF "($InstanceName = 'FSS_COSS_PIT_3')"!]
            [!CODE!][!WS "4"!](uint8)5U, /* hw instance no. */[!CR!][!ENDCODE!]
        [!ELSEIF "($InstanceName = 'FSS_COSS_PIT_4')"!]
            [!CODE!][!WS "4"!](uint8)6U, /* hw instance no. */[!CR!][!ENDCODE!]
        [!ELSEIF "($InstanceName = 'FSS_COSS_PIT_5')"!]
            [!CODE!][!WS "4"!](uint8)7U, /* hw instance no. */[!CR!][!ENDCODE!]
        [!ELSEIF "($InstanceName = 'FSS_COSS_PIT_6')"!]
            [!CODE!][!WS "4"!](uint8)8U, /* hw instance no. */[!CR!][!ENDCODE!]
        [!ELSEIF "($InstanceName = 'FSS_HKI_PIT_0')"!]
            [!CODE!][!WS "4"!](uint8)9U, /* hw instance no. */[!CR!][!ENDCODE!]
        [!ELSEIF "($InstanceName = 'FSS_PIT_0')"!]
            [!CODE!][!WS "4"!](uint8)10U, /* hw instance no. */[!CR!][!ENDCODE!]
        [!ELSEIF "($InstanceName = 'PIT_AE')"!]
            [!CODE!][!WS "4"!](uint8)10U, /* hw instance no. */[!CR!][!ENDCODE!]
        [!ELSEIF "($InstanceName = 'RTU0_PIT_0')"!]
            [!IF "contains($DerivativeName,'S32N5') or contains($DerivativeName,'S32E2')"!]"!][!//
                [!CODE!][!WS "4"!](uint8)11U, /* hw instance no. */[!CR!][!ENDCODE!]]
            [!ELSE!]
                [!CODE!][!WS "4"!](uint8)10U, /* hw instance no. */[!CR!][!ENDCODE!]
            [!ENDIF!][!//
        [!ELSEIF "($InstanceName = 'RTU0_PIT_1')"!]
            [!CODE!][!WS "4"!](uint8)12U, /* hw instance no. */[!CR!][!ENDCODE!]
        [!ELSEIF "($InstanceName = 'RTU1_PIT_0')"!]
            [!IF "contains($DerivativeName,'S32N5')"!][!//
                [!CODE!][!WS "4"!](uint8)13U, /* hw instance no. */[!CR!][!ENDCODE!]
            ...
            [!ELSE!]
                [!CODE!][!WS "4"!](uint8)11U, /* hw instance no. */[!CR!][!ENDCODE!]
            [!ENDIF!][!//
        [!ELSEIF "($InstanceName = 'RTU1_PIT_1')"!]
            [!CODE!][!WS "4"!](uint8)14U, /* hw instance no. */[!CR!][!ENDCODE!]
        [!ELSEIF "($InstanceName = 'RTU2_PIT_0')"!]
            [!CODE!][!WS "4"!](uint8)15U, /* hw instance no. */[!CR!][!ENDCODE!]
        [!ELSEIF "($InstanceName = 'RTU2_PIT_1')"!]
            [!CODE!][!WS "4"!](uint8)16U, /* hw instance no. */[!CR!][!ENDCODE!]
        [!ELSEIF "($InstanceName = 'RTU3_PIT_0')"!]
            [!CODE!][!WS "4"!](uint8)17U, /* hw instance no. */[!CR!][!ENDCODE!]
        [!ELSEIF "($InstanceName = 'RTU3_PIT_1')"!]
            [!CODE!][!WS "4"!](uint8)18U, /* hw instance no. */[!CR!][!ENDCODE!]
        [!ENDIF!]
    [!ELSEIF "contains(GptHwChannel,'ETIMER')"!][!//
