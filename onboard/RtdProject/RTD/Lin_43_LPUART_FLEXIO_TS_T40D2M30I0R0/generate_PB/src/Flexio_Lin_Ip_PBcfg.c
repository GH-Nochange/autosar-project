...
#define FLEXIO_LIN_IP[!"$PostBuildVariant"!]_PBCFG_VENDOR_ID_C                     43
#define FLEXIO_LIN_IP[!"$PostBuildVariant"!]_PBCFG_AR_RELEASE_MAJOR_VERSION_C      4
#define FLEXIO_LIN_IP[!"$PostBuildVariant"!]_PBCFG_AR_RELEASE_MINOR_VERSION_C      7
#define FLEXIO_LIN_IP[!"$PostBuildVariant"!]_PBCFG_AR_RELEASE_REVISION_VERSION_C   0
#define FLEXIO_LIN_IP[!"$PostBuildVariant"!]_PBCFG_SW_MAJOR_VERSION_C              3
#define FLEXIO_LIN_IP[!"$PostBuildVariant"!]_PBCFG_SW_MINOR_VERSION_C              0
#define FLEXIO_LIN_IP[!"$PostBuildVariant"!]_PBCFG_SW_PATCH_VERSION_C              0
...
#if (FLEXIO_LIN_IP[!"$PostBuildVariant"!]_PBCFG_VENDOR_ID_C != FLEXIO_LIN_IP_CFG_VENDOR_ID)
...
#if ((FLEXIO_LIN_IP[!"$PostBuildVariant"!]_PBCFG_AR_RELEASE_MAJOR_VERSION_C    != FLEXIO_LIN_IP_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (FLEXIO_LIN_IP[!"$PostBuildVariant"!]_PBCFG_AR_RELEASE_MINOR_VERSION_C    != FLEXIO_LIN_IP_CFG_AR_RELEASE_MINOR_VERSION) || \
     (FLEXIO_LIN_IP[!"$PostBuildVariant"!]_PBCFG_AR_RELEASE_REVISION_VERSION_C != FLEXIO_LIN_IP_CFG_AR_RELEASE_REVISION_VERSION) \
    )
...
#if ((FLEXIO_LIN_IP[!"$PostBuildVariant"!]_PBCFG_SW_MAJOR_VERSION_C != FLEXIO_LIN_IP_CFG_SW_MAJOR_VERSION) || \
     (FLEXIO_LIN_IP[!"$PostBuildVariant"!]_PBCFG_SW_MINOR_VERSION_C != FLEXIO_LIN_IP_CFG_SW_MINOR_VERSION) || \
     (FLEXIO_LIN_IP[!"$PostBuildVariant"!]_PBCFG_SW_PATCH_VERSION_C != FLEXIO_LIN_IP_CFG_SW_PATCH_VERSION) \
    )
...
const Flexio_Lin_Ip_UserConfigType Flexio_Lin_Ip_pxHwConfigPB_[!"LinChannelId"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]=
{
[!ENDCODE!]
    [!NOCODE!]
        ...
        [!VAR "ResponseTimeoutValue" = "ceiling((1 div $ActualBaudrate) * (LinResponseTimeout) * 1000000)"!]
    ...
    (uint16)[!"$DivBest"!]U, /*!< Baudratedivider */
    ...
    &Flexio_Lin_Ip_axStateStructure[[!"num:i($CurrentChannel)"!]U], /*!< Runtime state structure refference/ */
