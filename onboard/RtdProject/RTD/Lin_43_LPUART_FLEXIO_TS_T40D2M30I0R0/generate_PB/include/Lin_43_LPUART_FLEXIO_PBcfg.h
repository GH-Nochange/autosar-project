...
[!IF "var:defined('postBuildVariant')"!]
[!CODE!][!//
#ifndef LIN_43_LPUART_FLEXIO[!"$PostBuildVariant"!]_PBCFG_H
#define LIN_43_LPUART_FLEXIO[!"$PostBuildVariant"!]_PBCFG_H
[!ENDCODE!]
[!ELSE!]
[!CODE!][!//
...
[!IF "var:defined('postBuildVariant')"!]
[!CODE!][!//
#define LIN_43_LPUART_FLEXIO[!"$PostBuildVariant"!]_PBCFG_VENDOR_ID                     43
#define LIN_43_LPUART_FLEXIO[!"$PostBuildVariant"!]_PBCFG_AR_RELEASE_MAJOR_VERSION      4
#define LIN_43_LPUART_FLEXIO[!"$PostBuildVariant"!]_PBCFG_AR_RELEASE_MINOR_VERSION      7
#define LIN_43_LPUART_FLEXIO[!"$PostBuildVariant"!]_PBCFG_AR_RELEASE_REVISION_VERSION   0
#define LIN_43_LPUART_FLEXIO[!"$PostBuildVariant"!]_PBCFG_SW_MAJOR_VERSION              3
#define LIN_43_LPUART_FLEXIO[!"$PostBuildVariant"!]_PBCFG_SW_MINOR_VERSION              0
#define LIN_43_LPUART_FLEXIO[!"$PostBuildVariant"!]_PBCFG_SW_PATCH_VERSION              0
[!ENDCODE!]
[!ELSE!]
[!CODE!][!//
...
#if (LIN_43_LPUART_FLEXIO[!"$PostBuildVariant"!]_PBCFG_VENDOR_ID != LIN_43_LPUART_FLEXIO_TYPES_VENDOR_ID)
...
#endif
#if ((LIN_43_LPUART_FLEXIO[!"$PostBuildVariant"!]_PBCFG_AR_RELEASE_MAJOR_VERSION   != LIN_43_LPUART_FLEXIO_TYPES_AR_RELEASE_MAJOR_VERSION) || \
     (LIN_43_LPUART_FLEXIO[!"$PostBuildVariant"!]_PBCFG_AR_RELEASE_MINOR_VERSION   != LIN_43_LPUART_FLEXIO_TYPES_AR_RELEASE_MINOR_VERSION) || \
     (LIN_43_LPUART_FLEXIO[!"$PostBuildVariant"!]_PBCFG_AR_RELEASE_REVISION_VERSION!= LIN_43_LPUART_FLEXIO_TYPES_AR_RELEASE_REVISION_VERSION) \
    )
...
#endif
#if ((LIN_43_LPUART_FLEXIO[!"$PostBuildVariant"!]_PBCFG_SW_MAJOR_VERSION!= LIN_43_LPUART_FLEXIO_TYPES_SW_MAJOR_VERSION) || \
     (LIN_43_LPUART_FLEXIO[!"$PostBuildVariant"!]_PBCFG_SW_MINOR_VERSION!= LIN_43_LPUART_FLEXIO_TYPES_SW_MINOR_VERSION) || \
     (LIN_43_LPUART_FLEXIO[!"$PostBuildVariant"!]_PBCFG_SW_PATCH_VERSION!= LIN_43_LPUART_FLEXIO_TYPES_SW_PATCH_VERSION) \
    )
...
[!CODE!]#define LIN_43_LPUART_FLEXIO_CONFIG[!"$PostBuildVariant"!]_PB \[!CR!][!ENDCODE!]
    [!ELSE!][!//
...
[!CODE!]#define LIN_43_LPUART_FLEXIO_CONFIG_PB \[!CR!][!ENDCODE!]
    ...
    [!IF "$LinConfiguredPartitions > 0"!][!//
        [!LOOP "LinGeneral/LinEcucPartitionRef/*"!][!//
            [!VAR "LinCount" = "num:i($LinCount + 1)"!][!//
            [!VAR "CurrentPartition" = "substring-after(substring-after(substring-after(substring-after(.,'/'),'/'),'/'),'/')"!][!//
    [!CODE!]extern const Lin_43_LPUART_FLEXIO_ConfigType Lin_43_LPUART_FLEXIO_xConfig[!"$PostBuildVariantNameUnderscore"!]_[!"$CurrentPartition"!];[!IF "$LinCount < $LinConfiguredPartitions"!] \[!ENDIF!][!CR!][!ENDCODE!]
        [!ENDLOOP!][!//
    [!ELSE!][!//
    [!CODE!]extern const Lin_43_LPUART_FLEXIO_ConfigType Lin_43_LPUART_FLEXIO_xConfig[!"$PostBuildVariantNameUnderscore"!];[!ENDCODE!][!//
    [!ENDIF!][!//
[!ENDIF!][!//
[!ENDNOCODE!][!//
...
[!IF "var:defined('postBuildVariant')"!]
[!CODE!][!//
#endif /* LIN'_43_LPUART_FLEXIO_[!"$PostBuildVariant"!]_PBCFG_H */
[!ENDCODE!]
[!ELSE!]
[!CODE!][!//
