...
#if (LIN_43_LPUART_FLEXIO_CFG_VENDOR_ID != LIN_43_LPUART_FLEXIO_[!"text:toupper(.)"!]_PBCFG_VENDOR_ID)
    #error "Lin_43_LPUART_FLEXIO_Cfg.h and Lin_43_LPUART_FLEXIO_[!"."!]_PBcfg.h have different vendor ids"
#endif
#if ((LIN_43_LPUART_FLEXIO_CFG_AR_RELEASE_MAJOR_VERSION    != LIN_43_LPUART_FLEXIO_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
     (LIN_43_LPUART_FLEXIO_CFG_AR_RELEASE_MINOR_VERSION    != LIN_43_LPUART_FLEXIO_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_MINOR_VERSION) || \
     (LIN_43_LPUART_FLEXIO_CFG_AR_RELEASE_REVISION_VERSION != LIN_43_LPUART_FLEXIO_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_REVISION_VERSION) \
    )
     #error "AUTOSAR Version Numbers of Lin_43_LPUART_FLEXIO_Cfg.h and Lin_43_LPUART_FLEXIO_[!"."!]_PBcfg.h are different"
#endif
#if ((LIN_43_LPUART_FLEXIO_CFG_SW_MAJOR_VERSION != LIN_43_LPUART_FLEXIO_[!"text:toupper(.)"!]_PBCFG_SW_MAJOR_VERSION) || \
     (LIN_43_LPUART_FLEXIO_CFG_SW_MINOR_VERSION != LIN_43_LPUART_FLEXIO_[!"text:toupper(.)"!]_PBCFG_SW_MINOR_VERSION) || \
     (LIN_43_LPUART_FLEXIO_CFG_SW_PATCH_VERSION != LIN_43_LPUART_FLEXIO_[!"text:toupper(.)"!]_PBCFG_SW_PATCH_VERSION) \
    )
...
[!IF "var:defined('postBuildVariant')"!][!//
    [!LOOP "variant:all()"!][!//
    LIN_43_LPUART_FLEXIO_CONFIG_[!"text:toupper(.)"!]_PB \
    [!ENDLOOP!][!//
[!ELSE!][!//
