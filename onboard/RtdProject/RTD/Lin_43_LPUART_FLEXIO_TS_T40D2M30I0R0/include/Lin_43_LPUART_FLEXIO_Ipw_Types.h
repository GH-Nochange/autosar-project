...
/**
*   @file Lin_43_LPUART_FLEXIO_Ipw_Types.h
*
 ...
 *               Depending on the type of channel available via u8LinIpType parameter in Lin_43_LPUART_FLEXIO_HwConfigType
...
#endif /* LIN_43_LPUART_FLEXIO_IPW_TYPES_H */
