...
[!VAR "LastLine" = "'    0'"!]
[!LOOP "variant:all()"!][!//
    [!CALL "MacroPrint", "TextToPrint" = "concat('    LPI2C_IP_MAX(LPI2C_IP_NUM_', $InstanceType, '_INSTANCES_USED_', text:toupper(.), ', \')"!]
...
#endif
/* Check if current file and Lpi2c_Ip_[!"."!]_PBcfg.h header file are of the same module */
#if (LPI2C_IP_CFG_MODULE_ID != LPI2C_IP_[!"text:toupper(.)"!]_PBCFG_MODULE_ID)
    #error "Lpi2c_Ip_Cfg.h and Lpi2c_Ip_[!"."!]_PBcfg.h have different module IDs"
#endif
