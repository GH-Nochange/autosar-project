...
#define WDG_AR_RELEASE_MINOR_VERSION_LCFG_C     7
#define WDG_AR_RELEASE_REVISION_VERSION_LCFG_C  0
#define WDG_SW_MAJOR_VERSION_LCFG_C             3
#define WDG_SW_MINOR_VERSION_LCFG_C             0
#define WDG_SW_PATCH_VERSION_LCFG_C             0
...
#if (WDG_VENDOR_ID_LCFG_C != WDG_VENDOR_ID_CFG)
...
#if ((WDG_AR_RELEASE_MAJOR_VERSION_LCFG_C     != WDG_AR_RELEASE_MAJOR_VERSION_CFG) || \
     (WDG_AR_RELEASE_MINOR_VERSION_LCFG_C     != WDG_AR_RELEASE_MINOR_VERSION_CFG) || \
     (WDG_AR_RELEASE_REVISION_VERSION_LCFG_C  != WDG_AR_RELEASE_REVISION_VERSION_CFG) \
    )
...
#if ((WDG_SW_MAJOR_VERSION_LCFG_C != WDG_SW_MAJOR_VERSION_CFG) || \
     (WDG_SW_MINOR_VERSION_LCFG_C != WDG_SW_MINOR_VERSION_CFG) || \
     (WDG_SW_PATCH_VERSION_LCFG_C != WDG_SW_PATCH_VERSION_CFG) \
    )
