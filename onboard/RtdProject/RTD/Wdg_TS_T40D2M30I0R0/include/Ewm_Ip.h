...
#define EWM_IP_AR_RELEASE_MINOR_VERSION     7
#define EWM_IP_AR_RELEASE_REVISION_VERSION  0
#define EWM_IP_SW_MAJOR_VERSION             3
...
/* Check if current file and Ewm_Ip_Cfg header file are of the same vendor */
#if (EWM_IP_VENDOR_ID != EWM_IP_VENDOR_ID_CFG_H)
#error "Ewm_Ip.h and Ewm_Ip_Cfg.h have different vendor ids"
#endif

#if ((EWM_IP_AR_RELEASE_MAJOR_VERSION    != EWM_IP_AR_RELEASE_MAJOR_VERSION_CFG_H) || \
     (EWM_IP_AR_RELEASE_MINOR_VERSION    != EWM_IP_AR_RELEASE_MINOR_VERSION_CFG_H) || \
     (EWM_IP_AR_RELEASE_REVISION_VERSION != EWM_IP_AR_RELEASE_REVISION_VERSION_CFG_H) \
    )
#error "AutoSar Version Numbers of Ewm_Ip.h and Ewm_Ip_Cfg.h are different"
#endif

#if ((EWM_IP_SW_MAJOR_VERSION != EWM_IP_SW_MAJOR_VERSION_CFG_H) || \
     (EWM_IP_SW_MINOR_VERSION != EWM_IP_SW_MINOR_VERSION_CFG_H) || \
     (EWM_IP_SW_PATCH_VERSION != EWM_IP_SW_PATCH_VERSION_CFG_H) \
    )
#error "Software Version Numbers of Ewm_Ip.h and Ewm_Ip_Cfg.h are different"
#endif
