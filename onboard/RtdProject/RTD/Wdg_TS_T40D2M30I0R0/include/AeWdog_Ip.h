...
/* Check if current file and AeWdog_Ip_Cfg header file are of the same vendor */
#if (AEWDOG_IP_VENDOR_ID != AEWDOG_IP_VENDOR_ID_CFG_H)
#error "AeWdog_Ip.h and AeWdog_Ip_Cfg.h have different vendor ids"
#endif

#if ((AEWDOG_IP_AR_RELEASE_MAJOR_VERSION    != AEWDOG_IP_AR_RELEASE_MAJOR_VERSION_CFG_H) || \
     (AEWDOG_IP_AR_RELEASE_MINOR_VERSION    != AEWDOG_IP_AR_RELEASE_MINOR_VERSION_CFG_H) || \
     (AEWDOG_IP_AR_RELEASE_REVISION_VERSION != AEWDOG_IP_AR_RELEASE_REVISION_VERSION_CFG_H) \
    )
#error "AutoSar Version Numbers of AeWdog_Ip.h and AeWdog_Ip_Cfg.h are different"
#endif

#if ((AEWDOG_IP_SW_MAJOR_VERSION != AEWDOG_IP_SW_MAJOR_VERSION_CFG_H) || \
     (AEWDOG_IP_SW_MINOR_VERSION != AEWDOG_IP_SW_MINOR_VERSION_CFG_H) || \
     (AEWDOG_IP_SW_PATCH_VERSION != AEWDOG_IP_SW_PATCH_VERSION_CFG_H) \
    )
#error "Software Version Numbers of AeWdog_Ip.h and AeWdog_Ip_Cfg.h are different"
#endif

#ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
#if (AEWDOG_IP_ENABLE == STD_ON)

/* Check if current file and Aec_Ip header file are of the same AutoSAR version */
#if ((AEWDOG_IP_AR_RELEASE_MAJOR_VERSION    != AEC_IP_AR_RELEASE_MAJOR_VERSION) || \
     (AEWDOG_IP_AR_RELEASE_MINOR_VERSION    != AEC_IP_AR_RELEASE_MINOR_VERSION) \
    )
#error "AutoSar Version Numbers of AeWdog_Ip.h and Aec_Ip.h are different"
#endif
