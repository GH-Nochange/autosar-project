...
#define WDG_IPW_IRQ_AR_RELEASE_MINOR_VERSION_C       7
#define WDG_IPW_IRQ_AR_RELEASE_REVISION_VERSION_C    0
#define WDG_IPW_IRQ_SW_MAJOR_VERSION_C               3
...
/* Check if current file and Wdg_Ip_Cfg_Defines configuration header file are of the same vendor */
#if (WDG_IPW_IRQ_VENDOR_ID_C != WDG_IPW_CFG_DEFINES_VENDOR_ID)
    #error "Wdg_Ipw_Irq.c and Wdg_Ip_Cfg_Defines.h have different vendor ids"
#endif
    ...
    #error "AutoSar Version Numbers of Wdg_Ipw_Irq.c and Wdg_Ip_Cfg_Defines.h are different"
#endif
    ...
    #error "Software Version Numbers of Wdg_Ipw_Irq.c and Wdg_Ip_Cfg_Defines.h are different"
#endif

/* Check if current file and Wdog_Ip header file are of the same vendor */
#if (WDG_IPW_ISR0_USED == STD_ON)
    #if (WDG_IPW_IRQ_VENDOR_ID_C != WDOG_IP_VENDOR_ID)
        #error "Wdg_Ipw_Irq.c and Wdog_Ip.h have different vendor ids"
    #endif

    #if ((WDG_IPW_IRQ_AR_RELEASE_MAJOR_VERSION_C    != WDOG_IP_AR_RELEASE_MAJOR_VERSION) || \
         (WDG_IPW_IRQ_AR_RELEASE_MINOR_VERSION_C    != WDOG_IP_AR_RELEASE_MINOR_VERSION) || \
         (WDG_IPW_IRQ_AR_RELEASE_REVISION_VERSION_C != WDOG_IP_AR_RELEASE_REVISION_VERSION) \
        )
        #error "AutoSar Version Numbers of Wdg_Ipw_Irq.c and Wdog_Ip.h are different"
    #endif

    #if ((WDG_IPW_IRQ_SW_MAJOR_VERSION_C != WDOG_IP_SW_MAJOR_VERSION) || \
         (WDG_IPW_IRQ_SW_MINOR_VERSION_C != WDOG_IP_SW_MINOR_VERSION) || \
         (WDG_IPW_IRQ_SW_PATCH_VERSION_C != WDOG_IP_SW_PATCH_VERSION)    \
        )
        #error "Software Version Numbers of Wdg_Ipw_Irq.c and Wdog_Ip.h are different"
    #endif
#endif
    ...
    /* Check if current file and Mcal header file are of the same Autosar version */
        ...
        #error "AutoSar Version Numbers of Wdg_Ipw_Irq.c and Mcal.h are different"
    #endif
    ...
    /* Check if current file and OsIf header file are of the same Autosar version */
        ...
        #error "AutoSar Version Numbers of Wdg_Ipw_Irq.c and OsIf.h are different"
    #endif
