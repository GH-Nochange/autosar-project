...
#define WDG_START_SEC_VAR_INIT_16_NO_CACHEABLE
#include "Wdg_MemMap.h"

static uint16 AeWdog_Ip_u16LFSRValue = AEWDOG_IP_TOKEN_INIT_VALUE_16;

#define WDG_STOP_SEC_VAR_INIT_16_NO_CACHEABLE
#include "Wdg_MemMap.h"
...
AeWdog_Ip_StatusType AeWdog_Ip_Init(const uint8 Instance, const AeWdog_Ip_ConfigType * const ConfigPtr)
{
    ...
    MCAL_FAULT_INJECTION_POINT(AEWDOG_FIP_INIT);
#endif
...
#ifdef MCAL_ENABLE_FAULT_INJECTION
    MCAL_FAULT_INJECTION_POINT(AEWDOG_FIP_CONFIGWINDOW);
#endif
