...
*/
#define WDOG_IP_DEINIT ([!IF "node:value(concat($xPathModule,'/WdgGeneral/WdgDisableAllowed'))"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
*/
#define WDOG_IP_OSIF_TIMEOUT_VAL        ([!"num:i(node:value(concat($xPathModule,'/WdgGeneral/WdgOsifTimeoutVal')))"!])
[!ELSE!]
/**
* @brief  Compile switch to enable development error detection
*/
