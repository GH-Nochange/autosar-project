...
[!IF "((IMPLEMENTATION_CONFIG_VARIANT != 'VariantPostBuild') and (variant:size() <= 1))"!]
    ...
    [!FOR "i" = "0" TO "num:i(ecu:get('Wdg.Num.Of.Instances'))-1"!]
        ...
        [!IF "node:exists($xPathModule)"!]
            ...
            [!ENDIF!]
            [!CODE!][!IF "num:i($i) > 0"!] ,[!ENDIF!]&Wdg_Config_[!"$i"!][!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!][!IF "var:defined('PartitionName')"!]_[!"$PartitionName"!][!ENDIF!][!ENDCODE!][!CR!]
        [!ELSE!]
...
[!FOR "i" = "0" TO "num:i(ecu:get('Wdg.Num.Of.Instances'))-1"!]
    ...
    [!IF "node:exists($xPathModule)"!]
        [!CODE!]   WDG_43_INSTANCE[!"$i"!]_INITIAL_TIMEOUT_U16[!IF "num:i($i) < num:i(ecu:get('Wdg.Num.Of.Instances')) - 1"!],[!ENDIF!][!ENDCODE!][!CR!]
    [!ELSE!]
        [!CODE!]   0[!IF "num:i($i) < num:i(ecu:get('Wdg.Num.Of.Instances')) - 1"!],[!ENDIF!][!ENDCODE!][!CR!]
    [!ENDIF!]
[!ENDFOR!]
[!ENDINDENT!]
[!ENDNOCODE!][!//
...
[!FOR "i" = "0" TO "num:i(ecu:get('Wdg.Num.Of.Instances'))-1"!]
    ...
    [!IF "node:exists($xPathModule)"!]
        [!CODE!]   WDG_43_INSTANCE[!"$i"!]_MAX_TIMEOUT_U16[!IF "num:i($i) < num:i(ecu:get('Wdg.Num.Of.Instances')) - 1"!],[!ENDIF!][!ENDCODE!][!CR!]
    [!ELSE!]
        [!CODE!]   0[!IF "num:i($i) < num:i(ecu:get('Wdg.Num.Of.Instances')) - 1"!],[!ENDIF!][!ENDCODE!][!CR!]
    [!ENDIF!]
[!ENDFOR!]
...
const uint32 Wdg_au32InstancePartitionUsed[WDG_NO_OF_INSTANCES]=
{
[!NOCODE!]
[!INDENT "1"!]
[!FOR "i" = "0" TO "num:i(ecu:get('Wdg.Num.Of.Instances'))-1"!]
    ...
    [!ELSE!]
        [!VAR "xPathModule" = "concat('ASPathDataOfSchema:/','TS_T40D2M30I0R0/Wdg')"!]
    [!ENDIF!]
    [!CODE!][!IF "num:i($i) > 0"!] ,[!ENDIF!][!ENDCODE!][!CALL "WdgPartitionConfig", "WdgNo" = "$xPathModule"!][!CR!]
[!ENDFOR!]
[!ENDINDENT!]
[!ENDNOCODE!][!//
};
