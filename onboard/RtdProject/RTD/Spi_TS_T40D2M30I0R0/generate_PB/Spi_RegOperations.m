...
[!ENDCODE!][!//
[!IF "SpiAutosarExt/SpiJobStartNotificationEnable = 'true'"!]
...
[!IF "node:exists(as:modconf('Spi')[1]/SpiGeneral/SpiMultipartitionSupport)"!]
[!VAR "MultiCorePartitionEnable" = "as:modconf('Spi')[1]/SpiGeneral/SpiMultipartitionSupport"!]
[!ENDIF!]

[!IF "node:exists(as:modconf('Spi')[1]/SpiGeneral/SpiMulticoreSupport)"!]
[!VAR "MultiCorePartitionEnable" = "as:modconf('Spi')[1]/SpiGeneral/SpiMulticoreSupport"!]
[!ENDIF!]
[!//==================================================================================================
...
VAR_ALIGN(static Spi_BufferDescriptorType Spi_Buffer_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!][!"name(.)"!], 8)
#else
/** Compiler_Warning: It is intended for aligning memory. */
VAR_ALIGN(static Spi_BufferDescriptorType Spi_Buffer_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!][!"name(.)"!], 4)
#endif
[!ENDCODE!][!//
            [!ELSE!][!//
[!CODE!][!//
static Spi_BufferDescriptorType Spi_Buffer_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!][!"name(.)"!];
[!ENDCODE!][!//
            [!ENDIF!][!//
[!CODE!][!//
...
[!CODE!][!//
#if (CPU_TYPE == CPU_TYPE_64)
VAR_ALIGN(static Spi_DataBufferType Spi_BufferTX_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!][!"name(.)"!][[!"num:i($GetSpiIbNBuffers)"!]], 8)
VAR_ALIGN(static Spi_DataBufferType Spi_BufferRX_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!][!"name(.)"!][[!"num:i($GetSpiIbNBuffers)"!]], 8)
#else
/** Compiler_Warning: It is intended for aligning memory. */
VAR_ALIGN(static Spi_DataBufferType Spi_BufferTX_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!][!"name(.)"!][[!"num:i($GetSpiIbNBuffers)"!]], 4)
VAR_ALIGN(static Spi_DataBufferType Spi_BufferRX_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!][!"name(.)"!][[!"num:i($GetSpiIbNBuffers)"!]], 4)
#endif
[!ENDCODE!][!//
            [!ELSE!][!//
[!CODE!][!//
static Spi_DataBufferType Spi_BufferTX_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!][!"name(.)"!][[!"num:i($GetSpiIbNBuffers)"!]];
static Spi_DataBufferType Spi_BufferRX_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!][!"name(.)"!][[!"num:i($GetSpiIbNBuffers)"!]];
[!ENDCODE!][!//
            [!ENDIF!][!//
        [!ENDIF!][!//
      [!ENDIF!][!//
...
static Spi_BufferDescriptorType Spi_Buffer_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!][!"name(.)"!] =
{
    ...
    Spi_BufferTX_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!][!"name(.)"!],  /* pBufferTX */
    Spi_BufferRX_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!][!"name(.)"!]   /* pBufferRX */
};
[!ENDCODE!][!//
        [!ENDIF!][!//
        [!ENDIF!][!//
...
static const Spi_ChannelConfigType Spi_ChannelConfig_[!"name(.)"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!] =
{
        ...
        (boolean)TRUE, /* Bit order */
        [!ELSE!]
        (boolean)FALSE, /* Bit order */
        [!ENDIF!]
        [!IF "node:exists(SpiByteSwapTransfer) and node:value(SpiByteSwapTransfer) = 'true'"!]
        (boolean)TRUE, /* Byte Swap */
        [!ELSE!]
...
[!ENDIF!][!//
[!CODE!][!//
        &Spi_Buffer_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!][!"name(.)"!], /* pcBufferDescriptor */
[!ENDCODE!]
        [!IF "$MultiCorePartitionEnable = 'true'"!]
            [!VAR "CurrentPName"="99"!]
                ...
                [!IF "$CurrentPName = node:name(node:ref(./OsAppEcucPartitionRef))"!][!//
                    [!IF "node:exists(as:modconf('Spi')[1]/SpiGeneral/SpiMultipartitionSupport)"!]
                        [!SELECT "node:ref(./OsAppEcucPartitionRef)"!][!//
                            [!VAR "CrtPartition"="num:i(node:pos(.))"!]
            [!CODE!]        (uint32)[!"$CrtPartition"!]U, /* Partition has assigned */[!ENDCODE!]
                        [!ENDSELECT!][!//
                    [!ELSE!]
            ...
            [!ENDLOOP!][!//
        [!ELSE!]
            [!CODE!]        (uint32)SPI_SPURIOUS_ID_U32,[!ENDCODE!]
        [!ENDIF!]
[!CODE!]
};
[!ENDCODE!][!//
...
[!ENDCODE!][!//
        ...
        [!CODE!][!WS "8"!](uint32)99U, /* No Partition has assigned */[!ENDCODE!]
            [!ELSE!]
                [!LOOP "as:modconf('Os')[1]/OsApplication/*"!][!//
                    [!IF "$CurrentPName = node:name(node:ref(./OsAppEcucPartitionRef))"!][!//
                        [!IF "node:exists(as:modconf('Spi')[1]/SpiGeneral/SpiMultipartitionSupport)"!]
        ...
        [!CODE!][!WS "8"!](uint32)[!"$CrtPartition"!]U, /* Partition has assigned */[!ENDCODE!]
                            [!ENDSELECT!][!//
                        [!ELSE!]
                        [!SELECT "node:ref(./OsApplicationCoreRef)"!][!//
                            [!VAR "CrtCore"="num:i(node:value(./EcucCoreId))"!]
        ...
        [!CODE!][!WS "8"!](uint32)[!"num:i(node:value(./EcucCoreId))"!]U, /* Core has assigned */[!ENDCODE!]
            ...
            [!ENDIF!][!//
        [!ELSE!]
        [!CODE!][!WS "8"!](uint32)SPI_SPURIOUS_ID_U32,[!ENDCODE!]
        [!ENDIF!]
[!CODE!]
...
[!CODE!][!//
        ...
        [!IF "($MultiCorePartitionEnable = 'true') and ($CurrentPName = string(null))"!][!//
        NULL_PTR[!//
        [!ELSE!][!//
        &Spi_aExternalDeviceConfigList[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!][!"$CurrentPName"!][SPI_[!"name(.)"!]] /* pcExternalDeviceConfig - pointer to the external device configuration */[!ENDIF!][!//
[!ENDCODE!][!//
            [!ENDSELECT!][!//
[!CODE!]
};
...
[!CODE!]        (uint32)99U, /* No Partition has assigned */[!ENDCODE!]
                [!ELSE!]
                    [!LOOP "as:modconf('Os')[1]/OsApplication/*"!][!//
                        [!IF "$CurrentPName = node:name(node:ref(./OsAppEcucPartitionRef))"!][!//
                            [!IF "node:exists(as:modconf('Spi')[1]/SpiGeneral/SpiMultipartitionSupport)"!]
...
[!NOCODE!]
    ...
    [!LOOP "as:modconf('EcuC')[1]/EcucHardware/*[1]/EcucCoreDefinition/*"!][!//
        [!IF "$MaxCorePartitionId < node:value(./EcucCoreId)"!]
            [!VAR "MaxCorePartitionId"="node:value(./EcucCoreId)"!]
        [!ENDIF!]
    [!ENDLOOP!][!// 
    [!ENDIF!]
...
[!IF "$MultiCorePartitionEnable = 'true'"!]
    ...
    [!LOOP "as:modconf('Os')[1]/OsApplication/*"!][!//
        ...
        [!IF "node:exists(as:modconf('Spi')[1]/SpiGeneral/SpiMultipartitionSupport)"!]
            [!SELECT "node:ref(./OsAppEcucPartitionRef)"!][!//
[!CODE!]    (uint32)[!"num:i(node:pos(.))"!]U, /* u32SpiCorePartitionUse*/[!ENDCODE!]
            [!ENDSELECT!][!//
        [!ELSE!]
            [!SELECT "node:ref(./OsApplicationCoreRef)"!][!//
[!CODE!]    (uint32)[!"num:i(node:value(./EcucCoreId))"!]U, /* u32SpiCorePartitionUse */[!ENDCODE!]
            [!ENDSELECT!][!//
        [!ENDIF!][!//
        [!BREAK!]
        [!ENDIF!][!//
    [!ENDLOOP!][!//
[!ELSE!]
[!CODE!]    (uint32)SPI_SPURIOUS_ID_U32, /* u32SpiCorePartitionUse */[!ENDCODE!]
[!ENDIF!]
[!CODE!]
...
[!IF "$MultiCorePartitionEnable = 'true'"!]
const Spi_ConfigType * const Spi_PBCfgVariantPredefined[[!"num:i($MaxCorePartitionId + 1)"!]]=
{
[!NOCODE!]
    [!VAR "MacNoPartitions" = "0"!][!//
    [!FOR "SpiCorePartitionIdCount"="0" TO "$MaxCorePartitionId"!]
            ...
            [!IF "num:i(count(as:modconf('Spi')[1]/SpiDriver/SpiExternalDevice/*[contains(./SpiDeviceEcucPartitionRef/*,$MacPartNo)])) > 0"!][!//
                [!LOOP "as:modconf('Os')[1]/OsApplication/*"!]
                    [!IF "$MacPartNo = node:name(node:ref(./OsAppEcucPartitionRef))"!]
                        [!IF "node:exists(as:modconf('Spi')[1]/SpiGeneral/SpiMultipartitionSupport)"!]
                        [!SELECT "node:ref(./OsAppEcucPartitionRef)"!][!//
                            [!IF "num:i($SpiCorePartitionIdCount) = num:i(node:pos(.))"!]
                        ...
                        [!ELSE!]
                        [!SELECT "node:ref(./OsApplicationCoreRef)"!][!//
                            [!IF "num:i($SpiCorePartitionIdCount) = num:i(node:value(./EcucCoreId))"!]
                                [!VAR "CorePartitionIsMatch" = "'true'"!]
                                [!VAR "Partitionname" = "$MacPartNo"!]
                            [!ENDIF!]
                        [!ENDSELECT!]
...
[!CODE!]
    &Spi_Config_[!"$Partitionname"!][!IF "$MacNoPartitions < num:i($MaxCorePartitionId)"!],[!VAR "MacNoPartitions" = "$MacNoPartitions + 1"!][!ENDIF!]
[!ENDCODE!]
        [!ELSE!]
[!CODE!]
