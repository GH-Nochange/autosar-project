...
/**
* @brief   Maximum value for number of data elements of the type Spi_DataBufferType.
*/
#define NUMBER_OF_DATA_TYPE_MAX     ((uint16)65535u)
...
#endif /* ((SPI_LEVEL_DELIVERED == SPI_LEVEL1) || (SPI_LEVEL_DELIVERED == SPI_LEVEL2)) */
    Spi_StatusType Status;    /**< @brief Init, idle or busy state. */
    Spi_ChannelType Channel; /**< @brief Current channel index in Job */
    Spi_JobType Job; /**< @brief  Current job index */
} Spi_HWUnitQueue;
...
/**
* @brief   Export Post-Build configurations. Constant
*/
SPI_CONFIG_EXT
#else
...
* @param[in]      Length              Number of data elements in the external buffer
