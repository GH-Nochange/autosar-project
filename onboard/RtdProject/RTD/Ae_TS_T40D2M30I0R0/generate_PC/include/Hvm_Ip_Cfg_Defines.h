...
[!CODE!][!WS "0"!]#include "S32M24x_HVI_AE.h"[!CR!][!ENDCODE!][!//
    [!ELSEIF "contains(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative, 's32m27')"!][!//
[!CODE!][!WS "0"!]#include "S32M27x_HVI_AE.h"[!CR!][!ENDCODE!][!//
    [!ENDIF!][!//
[!ENDIF!][!//
[!ENDNOCODE!][!//
/*==================================================================================================
...
#define HVM_IP_CFG_DEFINES_AR_RELEASE_MINOR_VERSION      7
#define HVM_IP_CFG_DEFINES_AR_RELEASE_REVISION_VERSION   0
#define HVM_IP_CFG_DEFINES_SW_MAJOR_VERSION              3
