...
==================================================================================================*/
#include "CDD_Ae_Cfg.h"           /* Mandatory include - see the SWS */

/*==================================================================================================
*                              SOURCE FILE VERSION INFORMATION
==================================================================================================*/
#define CDD_AE_VENDOR_ID                    43
#define CDD_AE_MODULE_ID                    250
#define CDD_AE_AR_RELEASE_MAJOR_VERSION     4
#define CDD_AE_AR_RELEASE_MINOR_VERSION     7
#define CDD_AE_AR_RELEASE_REVISION_VERSION  0
#define CDD_AE_SW_MAJOR_VERSION             3
#define CDD_AE_SW_MINOR_VERSION             0
#define CDD_AE_SW_PATCH_VERSION             0

/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Checks against CDD_Ae_Cfg.h */
#if (CDD_AE_VENDOR_ID != CDD_AE_CFG_VENDOR_ID)
    #error "CDD_Ae.h and CDD_Ae_Cfg.h have different vendor ids"
#endif
#if ((CDD_AE_AR_RELEASE_MAJOR_VERSION    != CDD_AE_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (CDD_AE_AR_RELEASE_MINOR_VERSION    != CDD_AE_CFG_AR_RELEASE_MINOR_VERSION) || \
     (CDD_AE_AR_RELEASE_REVISION_VERSION != CDD_AE_CFG_AR_RELEASE_REVISION_VERSION))
     #error "AUTOSAR Version Numbers of CDD_Ae.h and CDD_Ae_Cfg.h are different"
#endif
#if ((CDD_AE_SW_MAJOR_VERSION != CDD_AE_CFG_SW_MAJOR_VERSION) || \
     (CDD_AE_SW_MINOR_VERSION != CDD_AE_CFG_SW_MINOR_VERSION) || \
     (CDD_AE_SW_PATCH_VERSION != CDD_AE_CFG_SW_PATCH_VERSION))
    #error "Software Version Numbers of CDD_Ae.h and CDD_Ae_Cfg.h are different"
#endif
/*==================================================================================================
*                                          CONSTANTS
==================================================================================================*/
...
/* DET error codes */
    ...
    #define AE_E_UNINIT            ((uint8)0x01)
    /*! @brief Development Error ID for "Invalid (Null) Pointer Parameter" */
    #define AE_E_PARAM_POINTER     ((uint8)0x02)
    /*! @brief Development Error ID for "Invalid Configuration pointer argument" */
    #define AE_E_INIT_FAILED       ((uint8)0x03)
    /*! @brief Development Error ID for "API Ae_Init service called while the Ae driver has already been initialized." */
    #define AE_E_ALREADY_INITIALIZED ((uint8)0x04)
    /*! @brief Development Error ID for "API service called with wrong resource assigned." */
    #define AE_E_PARAM_CONFIG        ((uint8)0x05)
...
extern const Ae_ConfigType* const Ae_xPredefinedConfig[AE_MAX_PARTITIONS];
