...
==================================================================================================*/
#define CDD_AE_IPW_VENDOR_ID                    43
#define CDD_AE_IPW_AR_RELEASE_MAJOR_VERSION     4
#define CDD_AE_IPW_AR_RELEASE_MINOR_VERSION     7
#define CDD_AE_IPW_AR_RELEASE_REVISION_VERSION  0
#define CDD_AE_IPW_SW_MAJOR_VERSION             3
#define CDD_AE_IPW_SW_MINOR_VERSION             0
#define CDD_AE_IPW_SW_PATCH_VERSION             0

/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Checks against Ae_Ipw_Cfg.h */
#if (CDD_AE_IPW_VENDOR_ID != CDD_AE_IPW_CFG_VENDOR_ID)
    #error "CDD_Ae_Ipw.h and CDD_Ae_Ipw_Cfg.h have different vendor ids"
#endif
#if ((CDD_AE_IPW_AR_RELEASE_MAJOR_VERSION    != CDD_AE_IPW_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (CDD_AE_IPW_AR_RELEASE_MINOR_VERSION    != CDD_AE_IPW_CFG_AR_RELEASE_MINOR_VERSION) || \
     (CDD_AE_IPW_AR_RELEASE_REVISION_VERSION != CDD_AE_IPW_CFG_AR_RELEASE_REVISION_VERSION))
    #error "AUTOSAR Version Numbers of CDD_Ae_Ipw.h and CDD_Ae_Ipw_Cfg.h are different"
#endif
#if ((CDD_AE_IPW_SW_MAJOR_VERSION != CDD_AE_IPW_CFG_SW_MAJOR_VERSION) || \
     (CDD_AE_IPW_SW_MINOR_VERSION != CDD_AE_IPW_CFG_SW_MINOR_VERSION) || \
     (CDD_AE_IPW_SW_PATCH_VERSION != CDD_AE_IPW_CFG_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of CDD_Ae_Ipw.h and CDD_Ae_Ipw_Cfg.h are different"
#endif
/*==================================================================================================
                                           CONSTANTS
==================================================================================================*/
