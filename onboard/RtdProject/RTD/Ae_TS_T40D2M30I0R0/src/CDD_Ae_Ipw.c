...
==================================================================================================*/
#define CDD_AE_IPW_VENDOR_ID_C                      43
#define CDD_AE_IPW_AR_RELEASE_MAJOR_VERSION_C       4
#define CDD_AE_IPW_AR_RELEASE_MINOR_VERSION_C       7
#define CDD_AE_IPW_AR_RELEASE_REVISION_VERSION_C    0
#define CDD_AE_IPW_SW_MAJOR_VERSION_C               3
#define CDD_AE_IPW_SW_MINOR_VERSION_C               0
#define CDD_AE_IPW_SW_PATCH_VERSION_C               0

/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Checks against CDD_Ae_Ipw.h */
#if (CDD_AE_IPW_VENDOR_ID_C != CDD_AE_IPW_VENDOR_ID)
    #error "CDD_Ae_Ipw.c and CDD_Ae_Ipw.h have different vendor ids"
#endif
#if ((CDD_AE_IPW_AR_RELEASE_MAJOR_VERSION_C    != CDD_AE_IPW_AR_RELEASE_MAJOR_VERSION) || \
     (CDD_AE_IPW_AR_RELEASE_MINOR_VERSION_C    != CDD_AE_IPW_AR_RELEASE_MINOR_VERSION) || \
     (CDD_AE_IPW_AR_RELEASE_REVISION_VERSION_C != CDD_AE_IPW_AR_RELEASE_REVISION_VERSION))
    #error "AUTOSAR Version Numbers of CDD_Ae_Ipw.c and CDD_Ae_Ipw.h are different"
#endif
#if ((CDD_AE_IPW_SW_MAJOR_VERSION_C != CDD_AE_IPW_SW_MAJOR_VERSION) || \
     (CDD_AE_IPW_SW_MINOR_VERSION_C != CDD_AE_IPW_SW_MINOR_VERSION) || \
     (CDD_AE_IPW_SW_PATCH_VERSION_C != CDD_AE_IPW_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of CDD_Ae_Ipw.c and CDD_Ae_Ipw.h are different"
#endif

/* Checks against Aec_Ip.h */
#if (CDD_AE_IPW_VENDOR_ID_C != AEC_IP_VENDOR_ID)
    #error "CDD_Ae_Ipw.c and Aec_Ip.h have different vendor ids"
#endif
#if ((CDD_AE_IPW_AR_RELEASE_MAJOR_VERSION_C    != AEC_IP_AR_RELEASE_MAJOR_VERSION) || \
     (CDD_AE_IPW_AR_RELEASE_MINOR_VERSION_C    != AEC_IP_AR_RELEASE_MINOR_VERSION) || \
     (CDD_AE_IPW_AR_RELEASE_REVISION_VERSION_C != AEC_IP_AR_RELEASE_REVISION_VERSION))
    #error "AUTOSAR Version Numbers of CDD_Ae_Ipw.c and Aec_Ip.h are different"
#endif
#if ((CDD_AE_IPW_SW_MAJOR_VERSION_C != AEC_IP_SW_MAJOR_VERSION) || \
     (CDD_AE_IPW_SW_MINOR_VERSION_C != AEC_IP_SW_MINOR_VERSION) || \
     (CDD_AE_IPW_SW_PATCH_VERSION_C != AEC_IP_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of CDD_Ae_Ipw.c and Aec_Ip.h are different"
#endif

/* Checks against Hvm_Ip.h */
#if (CDD_AE_IPW_VENDOR_ID_C != HVM_IP_VENDOR_ID)
    #error "CDD_Ae_Ipw.c and Hvm_Ip.h have different vendor ids"
#endif
#if ((CDD_AE_IPW_AR_RELEASE_MAJOR_VERSION_C    != HVM_IP_AR_RELEASE_MAJOR_VERSION) || \
     (CDD_AE_IPW_AR_RELEASE_MINOR_VERSION_C    != HVM_IP_AR_RELEASE_MINOR_VERSION) || \
     (CDD_AE_IPW_AR_RELEASE_REVISION_VERSION_C != HVM_IP_AR_RELEASE_REVISION_VERSION))
    #error "AUTOSAR Version Numbers of CDD_Ae_Ipw.c and Hvm_Ip.h are different"
#endif
#if ((CDD_AE_IPW_SW_MAJOR_VERSION_C != HVM_IP_SW_MAJOR_VERSION) || \
     (CDD_AE_IPW_SW_MINOR_VERSION_C != HVM_IP_SW_MINOR_VERSION) || \
     (CDD_AE_IPW_SW_PATCH_VERSION_C != HVM_IP_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of CDD_Ae_Ipw.c and Hvm_Ip.h are different"
#endif
