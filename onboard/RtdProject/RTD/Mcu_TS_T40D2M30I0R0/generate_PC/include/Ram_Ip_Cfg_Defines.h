...
*/
#define RAM_IP_MULTIPARTITION_SUPPORT                   ([!IF "McuGeneralConfiguration/McuMultiPartitionSupport"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
#define RAM_IP_PARTITION_[!"num:i($CurrentPartitionId)"!]                 ((uint8)[!"num:i($CurrentPartitionId)"!]UL)
[!ENDIF!][!//
[!ENDLOOP!][!//
[!ENDLOOP!][!//
[!ELSE!][!//
