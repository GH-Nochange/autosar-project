...
#define UART_MULTIPARTITION_SUPPORT          [!IF "GeneralConfiguration/UartMultipartitionSupport"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
...
[!LOOP "UartGlobalConfig/UartChannel/*"!]
    [!IF "(node:exists(DetailModuleConfiguration/UartTimeoutEnable))"!]
...
[!IF "node:value(GeneralConfiguration/UartMultipartitionSupport)='true'"!]
    [!VAR "MaxPartitionId"="count(as:modconf('EcuC')[1]/EcucPartitionCollection/*[1]/EcucPartition/*) - 1"!]
[!ENDIF!]
[!VAR "MaxPartitionId" = "$MaxPartitionId + 1"!][!//
[!ENDNOCODE!]
#define UART_MAX_PARTITIONS             ([!"num:i($MaxPartitionId)"!]U)
