...
#if (FLEXIO_UART_IP_CFG_VENDOR_ID != FLEXIO_UART_IP_[!"text:toupper(.)"!]_PBCFG_VENDOR_ID)
    #error "Flexio_Uart_Ip_Cfg.h and Flexio_Uart_Ip_[!"."!]_PBcfg.h have different vendor ids"
#endif
#if ((FLEXIO_UART_IP_CFG_AR_RELEASE_MAJOR_VERSION    != FLEXIO_UART_IP_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
     (FLEXIO_UART_IP_CFG_AR_RELEASE_MINOR_VERSION    != FLEXIO_UART_IP_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_MINOR_VERSION) || \
     (FLEXIO_UART_IP_CFG_AR_RELEASE_REVISION_VERSION != FLEXIO_UART_IP_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_REVISION_VERSION) \
    )
     #error "AUTOSAR Version Numbers of Flexio_Uart_Ip_Cfg.h and Flexio_Uart_Ip_[!"."!]_PBcfg.h are different"
#endif
#if ((FLEXIO_UART_IP_CFG_SW_MAJOR_VERSION != FLEXIO_UART_IP_[!"text:toupper(.)"!]_PBCFG_SW_MAJOR_VERSION) || \
     (FLEXIO_UART_IP_CFG_SW_MINOR_VERSION != FLEXIO_UART_IP_[!"text:toupper(.)"!]_PBCFG_SW_MINOR_VERSION) || \
     (FLEXIO_UART_IP_CFG_SW_PATCH_VERSION != FLEXIO_UART_IP_[!"text:toupper(.)"!]_PBCFG_SW_PATCH_VERSION) \
    )
...
[!IF "var:defined('postBuildVariant')"!]
[!LOOP "variant:all()"!][!//
     [!CODE!][!WS "4"!]FLEXIO_UART_IP_CONFIG_[!"text:toupper(.)"!]_PB \[!CR!][!ENDCODE!]
[!ENDLOOP!][!//
[!ELSE!][!//
