...
#if (UART_CFG_VENDOR_ID != UART_[!"text:toupper(.)"!]_PBCFG_VENDOR_ID)
    #error "CDD_Uart_Cfg.h and Uart_[!"."!]_PBcfg.h have different vendor ids"
#endif
#if ((UART_CFG_AR_RELEASE_MAJOR_VERSION    != UART_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
     (UART_CFG_AR_RELEASE_MINOR_VERSION    != UART_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_MINOR_VERSION) || \
     (UART_CFG_AR_RELEASE_REVISION_VERSION != UART_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AUTOSAR Version Numbers of CDD_Uart_Cfg.h and Uart_[!"."!]_PBcfg.h are different"
#endif
#if ((UART_CFG_SW_MAJOR_VERSION != UART_[!"text:toupper(.)"!]_PBCFG_SW_MAJOR_VERSION) || \
     (UART_CFG_SW_MINOR_VERSION != UART_[!"text:toupper(.)"!]_PBCFG_SW_MINOR_VERSION) || \
     (UART_CFG_SW_PATCH_VERSION != UART_[!"text:toupper(.)"!]_PBCFG_SW_PATCH_VERSION) \
    )
