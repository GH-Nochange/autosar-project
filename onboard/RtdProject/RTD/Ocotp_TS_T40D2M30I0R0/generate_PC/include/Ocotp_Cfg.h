...
#if (OCOTP_[!"text:toupper(.)"!]_PBCFG_VENDOR_ID != OCOTP_VENDOR_ID_CFG)
...
#if ((OCOTP_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_MAJOR_VERSION    != OCOTP_AR_RELEASE_MAJOR_VERSION_CFG) || \
     (OCOTP_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_MINOR_VERSION    != OCOTP_AR_RELEASE_MINOR_VERSION_CFG) || \
     (OCOTP_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_REVISION_VERSION != OCOTP_AR_RELEASE_REVISION_VERSION_CFG) \
    )
...
#if ((OCOTP_[!"text:toupper(.)"!]_PBCFG_SW_MAJOR_VERSION != OCOTP_SW_MAJOR_VERSION_CFG) || \
     (OCOTP_[!"text:toupper(.)"!]_PBCFG_SW_MINOR_VERSION != OCOTP_SW_MINOR_VERSION_CFG) || \
     (OCOTP_[!"text:toupper(.)"!]_PBCFG_SW_PATCH_VERSION != OCOTP_SW_PATCH_VERSION_CFG) \
    )
...
[!LOOP "variant:all()"!][!//
    ...
    OCOTP_CONFIG_[!"text:toupper(.)"!]_PB[!IF "$variantIndex < $variantNumber"!] \[!CR!][!ENDIF!]
[!ENDLOOP!][!//
[!ELSE!][!//
    OCOTP_CONFIG_PB
[!ENDIF!][!CR!]
...
#define OCOTP_MULTIPARTITION_SUPPORT                ([!IF "OcotpGeneral/OcotpEnableMultiPartition"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
