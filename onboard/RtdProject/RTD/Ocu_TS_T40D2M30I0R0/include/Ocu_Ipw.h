...
#if (OCU_IPW_VENDOR_ID != FTM_OCU_IP_VENDOR_ID)
    #error "Ocu_Ipw.h and Ftm_Ocu_Ip.h have different vendor ids"
#endif

/* Check if  header file and Ftm_Ocu_Ip.h file are of the same Autosar version */
#if ((OCU_IPW_AR_RELEASE_MAJOR_VERSION != FTM_OCU_IP_AR_RELEASE_MAJOR_VERSION) || \
     (OCU_IPW_AR_RELEASE_MINOR_VERSION != FTM_OCU_IP_AR_RELEASE_MINOR_VERSION) || \
     (OCU_IPW_AR_RELEASE_REVISION_VERSION != FTM_OCU_IP_AR_RELEASE_REVISION_VERSION))
    #error "AutoSar Version Numbers of Ocu_Ipw.h and Ftm_Ocu_Ip.h are different"
#endif

/* Check if header file and Ftm_Ocu_Ip.h file are of the same Software version */
#if ((OCU_IPW_SW_MAJOR_VERSION != FTM_OCU_IP_SW_MAJOR_VERSION) || \
     (OCU_IPW_SW_MINOR_VERSION != FTM_OCU_IP_SW_MINOR_VERSION) || \
     (OCU_IPW_SW_PATCH_VERSION != FTM_OCU_IP_SW_PATCH_VERSION))
    #error "Software Version Numbers of Ocu_Ipw.h and Ftm_Ocu_Ip.h are different"
#endif
 ...
 * @details     Call StartChannel() function for the FTM Ocu channel
 *
 ...
 * @details     Call StopChannel() function for the FTM Ocu channel
 *
 * @param[in]   NumChannel - Ocu channel Id in top configuration structure
 *
 * @return      void
 ...
 * @details     Call SetPinState() function for the FTM Ocu channel
 *
 * @param[in]   NumChannel - Ocu channel Id in top configuration structure
...
* @details  Call SetPinAction() function for the FTM Ocu channel
*
* @param[in]    NumChannel - Ocu channel Id in top configuration structure
...
* @details      Call GetCounter() function for the FTM Ocu channel
*
* @param[in]    NumChannel - Ocu channel Id in top configuration structure
*
* @return       uint16
