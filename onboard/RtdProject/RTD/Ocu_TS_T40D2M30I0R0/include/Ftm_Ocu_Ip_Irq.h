...
#define FTM_OCU_IP_IRQ_AR_RELEASE_MINOR_VERSION        7
#define FTM_OCU_IP_IRQ_AR_RELEASE_REVISION_VERSION     0
#define FTM_OCU_IP_IRQ_SW_MAJOR_VERSION                3
