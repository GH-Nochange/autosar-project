...
*/
[!NOCODE!][!//
[!VAR "dmaOpt" = "'(STD_OFF) /* Disable DMA optimize for IP */'"!]
[!IF "node:exists(GeneralConfiguration/I2cDmaOptimize)"!]
[!IF "GeneralConfiguration/I2cDmaOptimize"!]
[!VAR "dmaOpt" = "'(STD_ON) /* Enable DMA optimize for IP */'"!]
[!ENDIF!]
[!ENDIF!]
[!ENDNOCODE!][!//
#define FLEXIO_I2C_IP_DMA_OPTIMIZE_ENABLE [!"$dmaOpt"!]
...
#ifndef FLEXIO_[!"$instanceId"!]_CH_[!"$sclChannel"!]_USED
    #define FLEXIO_[!"$instanceId"!]_CH_[!"$sclChannel"!]_USED
#else
    #error "CHANNEL_[!"$sclChannel"!] cannot be used by I2C driver. Channel locked by another driver"
#endif

#ifdef FLEXIO_[!"$instanceId"!]_CH_[!"$sclChannel"!]_USED
    #define I2C_CHANNEL_[!"$sclChannel"!]_USED
#else
    #error "CHANNEL_[!"$sclChannel"!] cannot be used by I2C driver. Channel locked by another driver"
#endif

#ifndef FLEXIO_[!"$instanceId"!]_CH_[!"$sdaChannel"!]_USED
    #define FLEXIO_[!"$instanceId"!]_CH_[!"$sdaChannel"!]_USED
#else
    #error "CHANNEL_[!"$sdaChannel"!] cannot be used by I2C driver. Channel locked by another driver"
#endif

#ifdef FLEXIO_[!"$instanceId"!]_CH_[!"$sdaChannel"!]_USED
...
#ifndef FLEXIO_[!"$instanceId"!]_PIN_[!"$pinScl"!]_USED
    #define FLEXIO_[!"$instanceId"!]_PIN_[!"$pinScl"!]_USED
#else
    #error "PIN_[!"$pinScl"!] cannot be used by I2C driver. Pin used by another driver!"
#endif

#ifndef FLEXIO_[!"$instanceId"!]_PIN_[!"$pinSda"!]_USED
    #define FLEXIO_[!"$instanceId"!]_PIN_[!"$pinSda"!]_USED
#else
