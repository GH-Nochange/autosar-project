...
*
*   (u8Idx1) Copyright 2020-2025 NXP
*
 ...
 ******************************************************************************/
    ...
    #define I2s_GetUserId()    (uint32)OsIf_GetUserId()
#else
    #define I2s_GetUserId()    ((uint32)0UL)
#endif
 ...
 * @implement      I2s_ValidatePartition_Activity
 *
 * */
static inline Std_ReturnType I2s_ValidatePartition(I2s_LogicalChannel LogicChn,
                                                   ...
                                                   uint8 ServiceId)
{
    ...
    if (u32PartitionId == u8I2sChannelIdToPartitionMap[LogicChn])
    {
...
#endif /* I2S_MULTIPARTITION_ENABLED == STD_ON */
...
{
    uint32 u32PartitionId;
    u32PartitionId = (uint32)I2s_GetUserId();
...
#if (I2S_PRECOMPILE_SUPPORT == STD_ON)
#if (I2S_MULTIPARTITION_ENABLED == STD_ON)
    I2s_pConfig[u32PartitionId] = I2s_apxConfigVariantPredefined[u32PartitionId];
#else
    I2s_pConfig[u32PartitionId] = I2s_pxConfigVariantPredefined;
#endif
    (void)pConfigPtr;
#else
    I2s_pConfig[u32PartitionId] = pConfigPtr;
#endif

    I2s_Ipw_Init(I2s_pConfig[u32PartitionId]);
#if (I2S_DEV_ERROR_DETECT == STD_ON)
}
#endif /* I2S_DEV_ERROR_DETECT == STD_ON */
}
...
void I2s_DeInit(void)
{
    ...
    {
        if (u32PartitionId == u8I2sChannelIdToPartitionMap[u8LogicChnCount])
        {
            I2s_Ipw_DeInitLogicalChannel(u8LogicChnCount);
        }
    }
#else  /* if (I2S_MULTIPARTITION_ENABLED == STD_ON) */
    I2s_Ipw_DeInit();
#endif /* I2S_MULTIPARTITION_ENABLED == STD_ON */
}
...
#if (I2S_MULTIPARTITION_ENABLED == STD_ON)
    if ((Std_ReturnType) E_NOT_OK == I2s_ValidatePartition(LogicChn, u32PartitionId, (uint8)I2S_SYNCTRANSMIT_ID))
    {
        status = (Std_ReturnType)E_NOT_OK;
    }
    else
...
#if (I2S_MULTIPARTITION_ENABLED == STD_ON)
    if ((Std_ReturnType) E_NOT_OK == I2s_ValidatePartition(LogicChn, u32PartitionId, (uint8)I2S_ASYNCTRANSMIT_ID))
    {
        status = (Std_ReturnType)E_NOT_OK;
    }
    else
                             ...
                             I2s_StatusStructType * const pStatus)
{
    ...
    #if (I2S_MULTIPARTITION_ENABLED == STD_ON)
        if ((Std_ReturnType) E_NOT_OK == I2s_ValidatePartition(LogicChn, u32PartitionId, (uint8)I2S_GETSTATUS_ID))
        {
            status = (Std_ReturnType)E_NOT_OK;
        }
        else
...
void I2s_AbortTransmit(I2s_LogicalChannel LogicChn)
{
    ...
    {
        /* If DET is available raise Det error I2S_E_INIT_FAILED. */
#if (I2S_DEV_ERROR_DETECT == STD_ON)
...
#if (I2S_MULTIPARTITION_ENABLED == STD_ON)
        if (I2s_ValidatePartition(LogicChn, u32PartitionId, (uint8)I2S_ABORTTRANSMIT_ID) == (Std_ReturnType) E_NOT_OK)
        {
            /* Do nothing */
        }
        else
 ...
 * Description   : Writes the module version at pointer pVersionInfo.
 *
