...
/*!
 * @brief De-initialize the FLEXIO_I2S driver
 *
 * This function de-initializes the FLEXIO_I2S driver. The driver can't be used
 ...
 * is initialized in interrupt mode) or by the Flexio_I2s_Ip_GetStatus function (if
 * the driver is initialized in polling mode).
 * Use Flexio_I2s_Ip_GetStatus() to check the progress of the transmission.
 *
 * @param[in] Instance FLEXIO peripheral instance number
 * @param[in] Channel FLEXIO_I2S logical channel number
 ...
 * is initialized in interrupt mode) or by the Flexio_I2s_Ip_GetStatus function (if
 * the driver is initialized in polling mode).
 * Use Flexio_I2s_Ip_GetStatus() to check the progress of the reception.
 *
 * @param[in] Instance FLEXIO peripheral instance number
 * @param[in] Channel FLEXIO_I2S logical channel number
...
/*!
 * @brief Aborts a non-blocking I2S transaction
 *
