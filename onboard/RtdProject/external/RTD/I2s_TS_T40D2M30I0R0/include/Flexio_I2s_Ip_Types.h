 ...
 */
typedef void (*Flexio_I2s_CallbackType)(Flexio_I2s_Ip_EventType Event,
                                        void *UserData);
...
typedef struct
{
    ...
    boolean TxEnabled;              /* Tx Enabled/Disabled */
    boolean RxEnabled;              /* Rx Enabled/Disabled */
    uint8 TxShifter;                /* Tx Shifter number */
    uint8 RxShifter;                /* Rx Shifter number */
...
/*! @cond DRIVER_INTERNAL_USE_ONLY */
    ...
    boolean lastFrame;                              /* Specifies that the last frame has been pushed to the shifter
                                                       and the line will be kept enabled until transmission is over.  */
    Flexio_I2s_CallbackType txCallback;             /* User Tx callback function */
    Flexio_I2s_CallbackType rxCallback;             /* User Rx callback function */
    void *txCallbackParam;                          /* Parameter for the Tx callback function */
    void *rxCallbackParam;                          /* Parameter for the Rx callback function */
/*! @endcond */
...
typedef struct
{
	...
	Flexio_Mcl_Ip_PinPolarityType pinPolarity;/*!< Flexio clock polarity used for data sampling */
    Flexio_I2s_CallbackType txCallback;       /*!< User Tx callback function. Note that this function will be
    ...
    Flexio_I2s_CallbackType rxCallback;       /*!< User Rx callback function. Note that this function will be
                                                called from the interrupt service routine, so its
                                                execution time should be as small as possible. It can be
                                                NULL if it is not needed */
    void *txCallbackParam;                    /*!< Parameter for the Tx callback function */
