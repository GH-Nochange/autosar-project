...
[!VAR "CRC_IP_SW_8_MASK_VALUE" ="num:hextoint('0x80')"!][!//
[!VAR "CRC_IP_SW_16_MASK_VALUE"="num:hextoint('0x8000')"!][!//
[!VAR "CRC_IP_SW_32_MASK_VALUE"="num:hextoint('0x80000000')"!][!//
[!VAR "CRC_IP_SW_64_MASK_VALUE"="num:hextoint('0x8000000000000000')"!][!//
[!VAR "CRC_IP_SW_8_WIDTH_VALUE" ="num:i(8) -num:i(1)"!][!//
[!VAR "CRC_IP_SW_16_WIDTH_VALUE"="num:i(16)-num:i(1)"!][!//
[!VAR "CRC_IP_SW_32_WIDTH_VALUE"="num:i(32)-num:i(1)"!][!//
[!VAR "CRC_IP_SW_64_WIDTH_VALUE"="num:i(64)-num:i(1)"!][!//
...
[!VAR "CRC_IP_SW_MASK_VALUE"  = "$CRC_IP_SW_8_MASK_VALUE"!][!//
[!VAR "CRC_IP_SW_WIDTH_VALUE" = "$CRC_IP_SW_8_WIDTH_VALUE"!][!//
...
[!VAR "CRC_IP_SW_MASK_VALUE"  = "$CRC_IP_SW_16_MASK_VALUE"!][!//
[!VAR "CRC_IP_SW_WIDTH_VALUE" = "$CRC_IP_SW_16_WIDTH_VALUE"!][!//
...
[!VAR "CRC_IP_SW_MASK_VALUE"  = "$CRC_IP_SW_32_MASK_VALUE"!][!//
[!VAR "CRC_IP_SW_WIDTH_VALUE" = "$CRC_IP_SW_32_WIDTH_VALUE"!][!//
...
[!VAR "CRC_IP_SW_MASK_VALUE"  = "$CRC_IP_SW_64_MASK_VALUE"!][!//
[!VAR "CRC_IP_SW_WIDTH_VALUE" = "$CRC_IP_SW_64_WIDTH_VALUE"!][!//
...
[!IF "$CrcIndex = 255"!][!//
[!CODE!][!"text:toupper(num:inttohex($CrcData))"!][!ENDCODE!][!//
[!ELSE!][!//
[!CODE!][!"text:toupper(num:inttohex($CrcData))"!], [!ENDCODE!][!//
[!ENDIF!][!//
[!ENDFOR!][!//
...
[!ELSE!]
    [!VAR "MacCrcHarwareInstance"="ecu:list('Crc.Hardware.Instances.List')[position()]"!]
[!ENDIF!]
...
[!//
[!/*****************************************************************************/!][!//
[!/* MACRO DmaLogicChannelTransferSize                                         */!][!//
[!/* This Macro to get the CRC Dma Transfer Size                               */!][!//
[!/*****************************************************************************/!][!//
[!MACRO "DmaLogicChannelTransferSize"!][!//
[!NOCODE!]
[!IF "text:match(./CrcCalculationType,'CRC_IP_HARDWARE_CALCULATION')"!]
    [!VAR "MacCrcDmaTransferSize"="./CrcHardwareConfig/CrcDmaTransferSize"!]
[!ELSE!]
    [!VAR "MacCrcDmaTransferSize"="'CRC_DMA_TRANSFER_SIZE_1_BYTE'"!]
[!ENDIF!]
[!ENDNOCODE!][!//
[!"$MacCrcDmaTransferSize"!][!//
[!ENDMACRO!][!//
[!//
[!/*****************************************************************************/!][!//
...
[!ELSE!]
    ...
    [!ELSEIF "./CrcProtocolInfo/CrcProtocolType = 'CRC_PROTOCOL_32BIT_CASTAGNOLI'"!]
        [!VAR "MacCrcPolynomialValue"="num:i(249327425)"!]
    [!ELSEIF "./CrcProtocolInfo/CrcProtocolType = 'CRC_PROTOCOL_64BIT_ECMA'"!]
        [!VAR "MacCrcPolynomialValue"=" num:i('4823603603198064275')"!]
    [!ENDIF!]
[!ENDIF!]
[!ENDNOCODE!][!//
[!"text:toupper(num:inttohex($MacCrcPolynomialValue))"!][!//
[!ENDMACRO!][!//
[!//
[!/*****************************************************************************/!][!//
...
[!ELSE!][!//
        ...
        [!ENDERROR!]
[!ENDIF!][!//
    /* Crc_Ip_DmaTransferSizeType DmaLogicChannelTransferSize  */ [!CALL "DmaLogicChannelTransferSize"!],
[!IF "./CrcHardwareConfig/CrcDmaTransferSize='CRC_DMA_TRANSFER_SIZE_1_BYTE'"!][!//
    /* uint8 DmaLogicChannelSignedOffset                   */ (1U),
[!ENDIF!][!//
[!IF "./CrcHardwareConfig/CrcDmaTransferSize='CRC_DMA_TRANSFER_SIZE_2_BYTE'"!][!//
    /* uint8 DmaLogicChannelSignedOffset                   */ (2U),
[!ENDIF!][!//
[!IF "./CrcHardwareConfig/CrcDmaTransferSize='CRC_DMA_TRANSFER_SIZE_4_BYTE'"!][!//
    /* uint8 DmaLogicChannelSignedOffset                   */ (4U),
[!ENDIF!][!//
[!ELSE!][!//
    /* boolean DmaLogicChannelEnable                       */ (boolean)[!"'FALSE'"!],
    /* uint32 DmaLogicChannelName                          */ [!"'DMA_LOGIC_CH_0'"!],
    /* Crc_Ip_DmaTransferSizeType DmaLogicChannelTransferSize  */ [!"'CRC_DMA_TRANSFER_SIZE_1_BYTE'"!],
    /* uint8 DmaLogicChannelOffset                         */ (1U),
[!ENDIF!][!//
[!ENDIF!][!//
#if (STD_ON == CRC_IP_HARDWARE_POLYG_EXT_IS_AVAILABLE)
[!IF "./CrcHardwareConfig/CrcPolynomialSelectionExtendEnable='true'"!][!//
    /* boolean PolygExtEnable                              */ (boolean)[!"'TRUE'"!],
[!ELSE!][!//
    /* boolean PolygExtEnable                              */ (boolean)[!"'FALSE'"!],
[!ENDIF!][!//
#endif
[!IF "../../CrcGeneral/CrcSelectAlgorithmSupportEnable"!][!//
    /* Crc_Ip_AlgorithmType Algorithm                      */ [!"./CrcProtocolInfo/CrcAlgorithmType"!],
[!ELSE!][!//
    /* Crc_Ip_AlgorithmType Algorithm                      */ [!"'CRC_ALGORITHM_BIT_WISE'"!],
[!ENDIF!][!//
...
[!VAR "Mac_ProtocolSupportedTable" = "''"!][!//
[!VAR "Mac_ProtocolSupportedTableIndex" = "num:i(0)"!][!//
[!LOOP "CrcChannelConfig/*"!][!//
[!IF "(./CrcProtocolInfo/CrcProtocolType = 'CRC_PROTOCOL_8BIT_SAE_J1850') and (./CrcCalculationType = 'CRC_IP_TABLE_CALCULATION')"!][!//
[!VAR "Mac_ProtocolSupportedTableIndex" = "num:i($Mac_ProtocolSupportedTableIndex + 1)"!][!//
[!IF "$Mac_ProtocolSupportedTableIndex < 2"!][!//
[!VAR "Mac_ProtocolSupportedTable" = "'(uint32)CRC_PROTOCOL_8BIT_SAE_J1850'"!][!//
[!ELSE!][!//
[!VAR "Mac_ProtocolSupportedTable" = "concat($Mac_ProtocolSupportedTable,', (uint32)CRC_PROTOCOL_8BIT_SAE_J1850')"!][!//
[!ENDIF!][!//
[!ENDIF!][!//
[!IF "(./CrcProtocolInfo/CrcProtocolType = 'CRC_PROTOCOL_8BIT_H2F') and (./CrcCalculationType = 'CRC_IP_TABLE_CALCULATION')"!][!//
[!VAR "Mac_ProtocolSupportedTableIndex" = "num:i($Mac_ProtocolSupportedTableIndex + 1)"!][!//
[!IF "$Mac_ProtocolSupportedTableIndex < 2"!][!//
[!VAR "Mac_ProtocolSupportedTable" = "'(uint32)CRC_PROTOCOL_8BIT_H2F'"!][!//
[!ELSE!][!//
[!VAR "Mac_ProtocolSupportedTable" = "concat($Mac_ProtocolSupportedTable,', (uint32)CRC_PROTOCOL_8BIT_H2F')"!][!//
[!ENDIF!][!//
[!ENDIF!][!//
[!IF "(./CrcProtocolInfo/CrcProtocolType = 'CRC_PROTOCOL_16BIT_CCITT_FALSE') and (./CrcCalculationType = 'CRC_IP_TABLE_CALCULATION')"!][!//
[!VAR "Mac_ProtocolSupportedTableIndex" = "num:i($Mac_ProtocolSupportedTableIndex + 1)"!][!//
[!IF "$Mac_ProtocolSupportedTableIndex < 2"!][!//
[!VAR "Mac_ProtocolSupportedTable" = "'(uint32)CRC_PROTOCOL_16BIT_CCITT_FALSE'"!][!//
[!ELSE!][!//
[!VAR "Mac_ProtocolSupportedTable" = "concat($Mac_ProtocolSupportedTable,', (uint32)CRC_PROTOCOL_16BIT_CCITT_FALSE')"!][!//
[!ENDIF!][!//
[!ENDIF!][!//
[!IF "(./CrcProtocolInfo/CrcProtocolType = 'CRC_PROTOCOL_16BIT_ARC') and (./CrcCalculationType = 'CRC_IP_TABLE_CALCULATION')"!][!//
[!VAR "Mac_ProtocolSupportedTableIndex" = "num:i($Mac_ProtocolSupportedTableIndex + 1)"!][!//
[!IF "$Mac_ProtocolSupportedTableIndex < 2"!][!//
[!VAR "Mac_ProtocolSupportedTable" = "'(uint32)CRC_PROTOCOL_16BIT_ARC'"!][!//
[!ELSE!][!//
[!VAR "Mac_ProtocolSupportedTable" = "concat($Mac_ProtocolSupportedTable,', (uint32)CRC_PROTOCOL_16BIT_ARC')"!][!//
[!ENDIF!][!//
[!ENDIF!][!//
[!IF "(./CrcProtocolInfo/CrcProtocolType = 'CRC_PROTOCOL_32BIT_ETHERNET') and (./CrcCalculationType = 'CRC_IP_TABLE_CALCULATION')"!][!//
[!VAR "Mac_ProtocolSupportedTableIndex" = "num:i($Mac_ProtocolSupportedTableIndex + 1)"!][!//
[!IF "$Mac_ProtocolSupportedTableIndex < 2"!][!//
[!VAR "Mac_ProtocolSupportedTable" = "'(uint32)CRC_PROTOCOL_32BIT_ETHERNET'"!][!//
[!ELSE!][!//
[!VAR "Mac_ProtocolSupportedTable" = "concat($Mac_ProtocolSupportedTable,', (uint32)CRC_PROTOCOL_32BIT_ETHERNET')"!][!//
[!ENDIF!][!//
[!ENDIF!][!//
[!IF "(./CrcProtocolInfo/CrcProtocolType = 'CRC_PROTOCOL_32BIT_E2E_P4') and (./CrcCalculationType = 'CRC_IP_TABLE_CALCULATION')"!][!//
[!VAR "Mac_ProtocolSupportedTableIndex" = "num:i($Mac_ProtocolSupportedTableIndex + 1)"!][!//
[!IF "$Mac_ProtocolSupportedTableIndex < 2"!][!//
[!VAR "Mac_ProtocolSupportedTable" = "'(uint32)CRC_PROTOCOL_32BIT_E2E_P4'"!][!//
[!ELSE!][!//
[!VAR "Mac_ProtocolSupportedTable" = "concat($Mac_ProtocolSupportedTable,', (uint32)CRC_PROTOCOL_32BIT_E2E_P4')"!][!//
[!ENDIF!][!//
[!ENDIF!][!//
[!IF "(./CrcProtocolInfo/CrcProtocolType = 'CRC_PROTOCOL_32BIT_CASTAGNOLI') and (./CrcCalculationType = 'CRC_IP_TABLE_CALCULATION')"!][!//
[!VAR "Mac_ProtocolSupportedTableIndex" = "num:i($Mac_ProtocolSupportedTableIndex + 1)"!][!//
[!IF "$Mac_ProtocolSupportedTableIndex < 2"!][!//
[!VAR "Mac_ProtocolSupportedTable" = "'(uint32)CRC_PROTOCOL_32BIT_CASTAGNOLI'"!][!//
[!ELSE!][!//
[!VAR "Mac_ProtocolSupportedTable" = "concat($Mac_ProtocolSupportedTable,', (uint32)CRC_PROTOCOL_32BIT_CASTAGNOLI')"!][!//
[!ENDIF!][!//
[!ENDIF!][!//
[!IF "(./CrcProtocolInfo/CrcProtocolType = 'CRC_PROTOCOL_64BIT_ECMA') and (./CrcCalculationType = 'CRC_IP_TABLE_CALCULATION')"!][!//
[!VAR "Mac_ProtocolSupportedTableIndex" = "num:i($Mac_ProtocolSupportedTableIndex + 1)"!][!//
[!IF "$Mac_ProtocolSupportedTableIndex < 2"!][!//
[!VAR "Mac_ProtocolSupportedTable" = "'(uint32)CRC_PROTOCOL_64BIT_ECMA'"!][!//
[!ELSE!][!//
[!VAR "Mac_ProtocolSupportedTable" = "concat($Mac_ProtocolSupportedTable,', (uint32)CRC_PROTOCOL_64BIT_ECMA')"!][!//
[!ENDIF!][!//
[!ENDIF!][!//
[!IF "(./CrcProtocolInfo/CrcProtocolType = 'CRC_PROTOCOL_8BIT_CUSTOM') and (./CrcCalculationType = 'CRC_IP_TABLE_CALCULATION')"!][!//
[!VAR "Mac_ProtocolSupportedTableIndex" = "num:i($Mac_ProtocolSupportedTableIndex + 1)"!][!//
[!IF "$Mac_ProtocolSupportedTableIndex < 2"!][!//
[!VAR "Mac_ProtocolSupportedTable" = "'(uint32)CRC_PROTOCOL_8BIT_CUSTOM'"!][!//
[!ELSE!][!//
[!VAR "Mac_ProtocolSupportedTable" = "concat($Mac_ProtocolSupportedTable,', (uint32)CRC_PROTOCOL_8BIT_CUSTOM')"!][!//
[!ENDIF!][!//
[!ENDIF!][!//
[!IF "(./CrcProtocolInfo/CrcProtocolType = 'CRC_PROTOCOL_16BIT_CUSTOM') and (./CrcCalculationType = 'CRC_IP_TABLE_CALCULATION')"!][!//
[!VAR "Mac_ProtocolSupportedTableIndex" = "num:i($Mac_ProtocolSupportedTableIndex + 1)"!][!//
[!IF "$Mac_ProtocolSupportedTableIndex < 2"!][!//
[!VAR "Mac_ProtocolSupportedTable" = "'(uint32)CRC_PROTOCOL_16BIT_CUSTOM'"!][!//
[!ELSE!][!//
[!VAR "Mac_ProtocolSupportedTable" = "concat($Mac_ProtocolSupportedTable,', (uint32)CRC_PROTOCOL_16BIT_CUSTOM')"!][!//
[!ENDIF!][!//
[!ENDIF!][!//
[!IF "(./CrcProtocolInfo/CrcProtocolType = 'CRC_PROTOCOL_32BIT_CUSTOM') and (./CrcCalculationType = 'CRC_IP_TABLE_CALCULATION')"!][!//
[!VAR "Mac_ProtocolSupportedTableIndex" = "num:i($Mac_ProtocolSupportedTableIndex + 1)"!][!//
[!IF "$Mac_ProtocolSupportedTableIndex < 2"!][!//
[!VAR "Mac_ProtocolSupportedTable" = "'(uint32)CRC_PROTOCOL_32BIT_CUSTOM'"!][!//
[!ELSE!][!//
[!VAR "Mac_ProtocolSupportedTable" = "concat($Mac_ProtocolSupportedTable,', (uint32)CRC_PROTOCOL_32BIT_CUSTOM')"!][!//
[!ENDIF!][!//
[!ENDIF!][!//
[!IF "(./CrcProtocolInfo/CrcProtocolType = 'CRC_PROTOCOL_64BIT_CUSTOM') and (./CrcCalculationType = 'CRC_IP_TABLE_CALCULATION')"!][!//
[!VAR "Mac_ProtocolSupportedTableIndex" = "num:i($Mac_ProtocolSupportedTableIndex + 1)"!][!//
[!IF "$Mac_ProtocolSupportedTableIndex < 2"!][!//
[!VAR "Mac_ProtocolSupportedTable" = "'(uint32)CRC_PROTOCOL_64BIT_CUSTOM'"!][!//
[!ELSE!][!//
[!VAR "Mac_ProtocolSupportedTable" = "concat($Mac_ProtocolSupportedTable,', (uint32)CRC_PROTOCOL_64BIT_CUSTOM')"!][!//
[!ENDIF!][!//
[!ENDIF!][!//
[!IF "$Mac_ProtocolSupportedTableIndex < 1"!][!//
[!VAR "Mac_ProtocolSupportedTable" = "'(uint32)CRC_PROTOCOL_INVALID'"!][!//
[!ENDIF!][!//
[!ENDLOOP!][!//

const uint32 Crc_Ip_axProtocolConfiguredTable[CRC_IP_PROTOCOL_CONFIGURED_TABLE_NO]  =
{
[!"$Mac_ProtocolSupportedTable"!]
};

/**
 * @brief  Crc Ip List Protocol Configuration
 * */
[!VAR "Mac_ProtocolSupportedHardware" = "''"!][!//
[!VAR "Mac_ProtocolSupportedHardwareIndex" = "num:i(0)"!][!//
[!IF "(contains(ecu:get('Crc.Protocols.HardwareSupport.List'),'CRC_PROTOCOL_8BIT_SAE_J1850'))"!][!//
[!VAR "Mac_ProtocolSupportedHardwareIndex" = "num:i($Mac_ProtocolSupportedHardwareIndex + 1)"!][!//
[!IF "$Mac_ProtocolSupportedHardwareIndex < 2"!][!//
[!VAR "Mac_ProtocolSupportedHardware" = "concat($Mac_ProtocolSupportedHardware,'(uint32)CRC_PROTOCOL_8BIT_SAE_J1850',$Mac_NewLine)"!][!//
[!ELSE!][!//
[!VAR "Mac_ProtocolSupportedHardware" = "concat($Mac_ProtocolSupportedHardware,', (uint32)CRC_PROTOCOL_8BIT_SAE_J1850',$Mac_NewLine)"!][!//
[!ENDIF!][!//
[!ENDIF!][!//
[!IF "(contains(ecu:get('Crc.Protocols.HardwareSupport.List'),'CRC_PROTOCOL_8BIT_H2F'))"!][!//
[!VAR "Mac_ProtocolSupportedHardwareIndex" = "num:i($Mac_ProtocolSupportedHardwareIndex + 1)"!][!//
[!IF "$Mac_ProtocolSupportedHardwareIndex < 2"!][!//
[!VAR "Mac_ProtocolSupportedHardware" = "concat($Mac_ProtocolSupportedHardware,'(uint32)CRC_PROTOCOL_8BIT_H2F',$Mac_NewLine)"!][!//
[!ELSE!][!//
[!VAR "Mac_ProtocolSupportedHardware" = "concat($Mac_ProtocolSupportedHardware,', (uint32)CRC_PROTOCOL_8BIT_H2F',$Mac_NewLine)"!][!//
[!ENDIF!][!//
[!ENDIF!][!//
[!IF "(contains(ecu:get('Crc.Protocols.HardwareSupport.List'),'CRC_PROTOCOL_16BIT_CCITT_FALSE'))"!][!//
[!VAR "Mac_ProtocolSupportedHardwareIndex" = "num:i($Mac_ProtocolSupportedHardwareIndex + 1)"!][!//
[!IF "$Mac_ProtocolSupportedHardwareIndex < 2"!][!//
[!VAR "Mac_ProtocolSupportedHardware" = "concat($Mac_ProtocolSupportedHardware,'(uint32)CRC_PROTOCOL_16BIT_CCITT_FALSE',$Mac_NewLine)"!][!//
[!ELSE!][!//
[!VAR "Mac_ProtocolSupportedHardware" = "concat($Mac_ProtocolSupportedHardware,', (uint32)CRC_PROTOCOL_16BIT_CCITT_FALSE',$Mac_NewLine)"!][!//
[!ENDIF!][!//
[!ENDIF!][!//
[!IF "(contains(ecu:get('Crc.Protocols.HardwareSupport.List'),'CRC_PROTOCOL_16BIT_ARC'))"!][!//
[!VAR "Mac_ProtocolSupportedHardwareIndex" = "num:i($Mac_ProtocolSupportedHardwareIndex + 1)"!][!//
[!IF "$Mac_ProtocolSupportedHardwareIndex < 2"!][!//
[!VAR "Mac_ProtocolSupportedHardware" = "concat($Mac_ProtocolSupportedHardware,'(uint32)CRC_PROTOCOL_16BIT_ARC',$Mac_NewLine)"!][!//
[!ELSE!][!//
[!VAR "Mac_ProtocolSupportedHardware" = "concat($Mac_ProtocolSupportedHardware,', (uint32)CRC_PROTOCOL_16BIT_ARC',$Mac_NewLine)"!][!//
[!ENDIF!][!//
[!ENDIF!][!//
[!IF "(contains(ecu:get('Crc.Protocols.HardwareSupport.List'),'CRC_PROTOCOL_32BIT_ETHERNET'))"!][!//
[!VAR "Mac_ProtocolSupportedHardwareIndex" = "num:i($Mac_ProtocolSupportedHardwareIndex + 1)"!][!//
[!IF "$Mac_ProtocolSupportedHardwareIndex < 2"!][!//
[!VAR "Mac_ProtocolSupportedHardware" = "concat($Mac_ProtocolSupportedHardware,'(uint32)CRC_PROTOCOL_32BIT_ETHERNET',$Mac_NewLine)"!][!//
[!ELSE!][!//
[!VAR "Mac_ProtocolSupportedHardware" = "concat($Mac_ProtocolSupportedHardware,', (uint32)CRC_PROTOCOL_32BIT_ETHERNET',$Mac_NewLine)"!][!//
[!ENDIF!][!//
[!ENDIF!][!//
[!IF "(contains(ecu:get('Crc.Protocols.HardwareSupport.List'),'CRC_PROTOCOL_32BIT_E2E_P4'))"!][!//
[!VAR "Mac_ProtocolSupportedHardwareIndex" = "num:i($Mac_ProtocolSupportedHardwareIndex + 1)"!][!//
[!IF "$Mac_ProtocolSupportedHardwareIndex < 2"!][!//
[!VAR "Mac_ProtocolSupportedHardware" = "concat($Mac_ProtocolSupportedHardware,'(uint32)CRC_PROTOCOL_32BIT_E2E_P4',$Mac_NewLine)"!][!//
[!ELSE!][!//
[!VAR "Mac_ProtocolSupportedHardware" = "concat($Mac_ProtocolSupportedHardware,', (uint32)CRC_PROTOCOL_32BIT_E2E_P4',$Mac_NewLine)"!][!//
[!ENDIF!][!//
[!ENDIF!][!//
[!IF "(contains(ecu:get('Crc.Protocols.HardwareSupport.List'),'CRC_PROTOCOL_32BIT_CASTAGNOLI'))"!][!//
[!VAR "Mac_ProtocolSupportedHardwareIndex" = "num:i($Mac_ProtocolSupportedHardwareIndex + 1)"!][!//
[!IF "$Mac_ProtocolSupportedHardwareIndex < 2"!][!//
[!VAR "Mac_ProtocolSupportedHardware" = "concat($Mac_ProtocolSupportedHardware,'(uint32)CRC_PROTOCOL_32BIT_CASTAGNOLI',$Mac_NewLine)"!][!//
[!ELSE!][!//
[!VAR "Mac_ProtocolSupportedHardware" = "concat($Mac_ProtocolSupportedHardware,', (uint32)CRC_PROTOCOL_32BIT_CASTAGNOLI',$Mac_NewLine)"!][!//
[!ENDIF!][!//
[!ENDIF!][!//
[!IF "(contains(ecu:get('Crc.Protocols.HardwareSupport.List'),'CRC_PROTOCOL_64BIT_ECMA'))"!]
[!VAR "Mac_ProtocolSupportedHardwareIndex" = "num:i($Mac_ProtocolSupportedHardwareIndex + 1)"!][!//
[!IF "$Mac_ProtocolSupportedHardwareIndex < 2"!][!//
[!VAR "Mac_ProtocolSupportedHardware" = "concat($Mac_ProtocolSupportedHardware,'(uint32)CRC_PROTOCOL_64BIT_ECMA',$Mac_NewLine)"!][!//
[!ELSE!][!//
[!VAR "Mac_ProtocolSupportedHardware" = "concat($Mac_ProtocolSupportedHardware,', (uint32)CRC_PROTOCOL_64BIT_ECMA',$Mac_NewLine)"!][!//
[!ENDIF!][!//
[!ENDIF!][!//
[!IF "(contains(ecu:get('Crc.Protocols.HardwareSupport.List'),'CRC_PROTOCOL_8BIT_CUSTOM'))"!][!//
[!VAR "Mac_ProtocolSupportedHardwareIndex" = "num:i($Mac_ProtocolSupportedHardwareIndex + 1)"!][!//
[!IF "$Mac_ProtocolSupportedHardwareIndex < 2"!][!//
[!VAR "Mac_ProtocolSupportedHardware" = "concat($Mac_ProtocolSupportedHardware,'(uint32)CRC_PROTOCOL_8BIT_CUSTOM',$Mac_NewLine)"!][!//
[!ELSE!][!//
[!VAR "Mac_ProtocolSupportedHardware" = "concat($Mac_ProtocolSupportedHardware,', (uint32)CRC_PROTOCOL_8BIT_CUSTOM',$Mac_NewLine)"!][!//
[!ENDIF!][!//
[!ENDIF!][!//
[!IF "(contains(ecu:get('Crc.Protocols.HardwareSupport.List'),'CRC_PROTOCOL_16BIT_CUSTOM'))"!][!//
[!VAR "Mac_ProtocolSupportedHardwareIndex" = "num:i($Mac_ProtocolSupportedHardwareIndex + 1)"!][!//
[!IF "$Mac_ProtocolSupportedHardwareIndex < 2"!][!//
[!VAR "Mac_ProtocolSupportedHardware" = "concat($Mac_ProtocolSupportedHardware,'(uint32)CRC_PROTOCOL_16BIT_CUSTOM',$Mac_NewLine)"!][!//
[!ELSE!][!//
[!VAR "Mac_ProtocolSupportedHardware" = "concat($Mac_ProtocolSupportedHardware,', (uint32)CRC_PROTOCOL_16BIT_CUSTOM',$Mac_NewLine)"!][!//
[!ENDIF!][!//
[!ENDIF!][!//
[!IF "(contains(ecu:get('Crc.Protocols.HardwareSupport.List'),'CRC_PROTOCOL_32BIT_CUSTOM'))"!][!//
[!VAR "Mac_ProtocolSupportedHardwareIndex" = "num:i($Mac_ProtocolSupportedHardwareIndex + 1)"!][!//
[!IF "$Mac_ProtocolSupportedHardwareIndex < 2"!][!//
[!VAR "Mac_ProtocolSupportedHardware" = "concat($Mac_ProtocolSupportedHardware,'(uint32)CRC_PROTOCOL_32BIT_CUSTOM',$Mac_NewLine)"!][!//
[!ELSE!][!//
[!VAR "Mac_ProtocolSupportedHardware" = "concat($Mac_ProtocolSupportedHardware,', (uint32)CRC_PROTOCOL_32BIT_CUSTOM',$Mac_NewLine)"!][!//
[!ENDIF!][!//
[!ENDIF!][!//
[!IF "(contains(ecu:get('Crc.Protocols.HardwareSupport.List'),'CRC_PROTOCOL_64BIT_CUSTOM'))"!][!//
[!VAR "Mac_ProtocolSupportedHardwareIndex" = "num:i($Mac_ProtocolSupportedHardwareIndex + 1)"!][!//
[!IF "$Mac_ProtocolSupportedHardwareIndex < 2"!][!//
[!VAR "Mac_ProtocolSupportedHardware" = "concat($Mac_ProtocolSupportedHardware,'(uint32)CRC_PROTOCOL_64BIT_CUSTOM',$Mac_NewLine)"!][!//
[!ELSE!][!//
[!VAR "Mac_ProtocolSupportedHardware" = "concat($Mac_ProtocolSupportedHardware,', (uint32)CRC_PROTOCOL_64BIT_CUSTOM',$Mac_NewLine)"!][!//
[!ENDIF!][!//
[!ENDIF!][!//

const uint32 Crc_Ip_axProtocolConfiguredHardware[CRC_IP_PROTOCOL_CONFIGURED_HARDWARE_NO] =
{
[!"$Mac_ProtocolSupportedHardware"!]
};
