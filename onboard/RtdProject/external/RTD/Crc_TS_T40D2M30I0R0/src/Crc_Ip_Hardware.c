                       ...
                       )
{
    ...
    hwAccCrc_SetCrcProtocol(pxCrcBase, pxLogicChannelInitCfg, pxLogicChannelState->Protocol);
    ...
    hwAccCrc_SetInitialSeedValue(pxCrcBase, pxLogicChannelInitCfg, ProtocolInfo->InitialSeedValue);
                         ...
                         )
{
    ...
    hwAccCrc_SetInitialSeedValue(pxCrcBase, LogicChannelInitCfg, InitialSeedValue);
#else
...
uint64 Crc_Ip_HwGetLocResult(const Crc_Ip_LogicChannelType * pxLogicChannelInitCfg)
{
    ...
    if (TRUE == pxLogicChannelInitCfg->DmaLogicChannelEnable)
    {
        ...
        {
            CrcResult = hwAccCRC_GetResult(pxCrcBase, pxLogicChannelInitCfg);
        }
        else
        {
            CrcResult = 0U;
