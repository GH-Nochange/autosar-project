...
#ifndef CRC_IP_LOOKUP_TABLES_SLICE_BY_N_H
#define CRC_IP_LOOKUP_TABLES_SLICE_BY_N_H

/**
*   @file    Crc_Ip_Lookup_Tables_Slice_By_N_Slice_By_N.h
*
*   @version 3.0.0
*
...
*/
#define CRC_IP_LOOKUP_TABLES_SLICE_BY_N_VENDOR_ID                      43
#define CRC_IP_LOOKUP_TABLES_SLICE_BY_N_AR_RELEASE_MAJOR_VERSION       4
#define CRC_IP_LOOKUP_TABLES_SLICE_BY_N_AR_RELEASE_MINOR_VERSION       7
#define CRC_IP_LOOKUP_TABLES_SLICE_BY_N_AR_RELEASE_REVISION_VERSION    0
#define CRC_IP_LOOKUP_TABLES_SLICE_BY_N_SW_MAJOR_VERSION               3
#define CRC_IP_LOOKUP_TABLES_SLICE_BY_N_SW_MINOR_VERSION               0
#define CRC_IP_LOOKUP_TABLES_SLICE_BY_N_SW_PATCH_VERSION               0

/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if source file and Crc_Ip_State.h file are of the same vendor */
#if (CRC_IP_LOOKUP_TABLES_SLICE_BY_N_VENDOR_ID != CRC_IP_STATE_VENDOR_ID)
    #error "Crc_Ip_Lookup_Tables_Slice_By_N.h and Crc_Ip_State.h have different vendor ids"
#endif

/* Check if source file and Crc_Ip_State.h file are of the same Autosar version */
#if ((CRC_IP_LOOKUP_TABLES_SLICE_BY_N_AR_RELEASE_MAJOR_VERSION    != CRC_IP_STATE_AR_RELEASE_MAJOR_VERSION) || \
     (CRC_IP_LOOKUP_TABLES_SLICE_BY_N_AR_RELEASE_MINOR_VERSION    != CRC_IP_STATE_AR_RELEASE_MINOR_VERSION) || \
     (CRC_IP_LOOKUP_TABLES_SLICE_BY_N_AR_RELEASE_REVISION_VERSION != CRC_IP_STATE_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Crc_Ip_Lookup_Tables_Slice_By_N.h and Crc_Ip_State.h are different"
#endif

/* Check if source file and Crc_Ip_State.h header file are of the same Software version */
#if ((CRC_IP_LOOKUP_TABLES_SLICE_BY_N_SW_MAJOR_VERSION != CRC_IP_STATE_SW_MAJOR_VERSION) || \
     (CRC_IP_LOOKUP_TABLES_SLICE_BY_N_SW_MINOR_VERSION != CRC_IP_STATE_SW_MINOR_VERSION) || \
     (CRC_IP_LOOKUP_TABLES_SLICE_BY_N_SW_PATCH_VERSION != CRC_IP_STATE_SW_PATCH_VERSION)    \
    )
    #error "Software Version Numbers of Crc_Ip_Lookup_Tables_Slice_By_N.h and Crc_Ip_State.h are different"
#endif

/* Check if source file and Crc_Ip_Types.h file are of the same vendor */
#if (CRC_IP_LOOKUP_TABLES_SLICE_BY_N_VENDOR_ID != CRC_IP_TYPES_VENDOR_ID)
    #error "Crc_Ip_Lookup_Tables_Slice_By_N.h and Crc_Ip_Types.h have different vendor ids"
#endif

/* Check if source file and Crc_Ip_Types.h file are of the same Autosar version */
#if ((CRC_IP_LOOKUP_TABLES_SLICE_BY_N_AR_RELEASE_MAJOR_VERSION    != CRC_IP_TYPES_AR_RELEASE_MAJOR_VERSION) || \
     (CRC_IP_LOOKUP_TABLES_SLICE_BY_N_AR_RELEASE_MINOR_VERSION    != CRC_IP_TYPES_AR_RELEASE_MINOR_VERSION) || \
     (CRC_IP_LOOKUP_TABLES_SLICE_BY_N_AR_RELEASE_REVISION_VERSION != CRC_IP_TYPES_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Crc_Ip_Lookup_Tables_Slice_By_N.h and Crc_Ip_Types.h are different"
#endif

/* Check if source file and Crc_Ip_Types.h header file are of the same Software version */
#if ((CRC_IP_LOOKUP_TABLES_SLICE_BY_N_SW_MAJOR_VERSION != CRC_IP_TYPES_SW_MAJOR_VERSION) || \
     (CRC_IP_LOOKUP_TABLES_SLICE_BY_N_SW_MINOR_VERSION != CRC_IP_TYPES_SW_MINOR_VERSION) || \
     (CRC_IP_LOOKUP_TABLES_SLICE_BY_N_SW_PATCH_VERSION != CRC_IP_TYPES_SW_PATCH_VERSION)    \
    )
    #error "Software Version Numbers of Crc_Ip_Lookup_Tables_Slice_By_N.h and Crc_Ip_Types.h are different"
#endif
/*==================================================================================================
...
*                                      DEFINES AND MACROS
==================================================================================================*/
/** Array initializer of Look up table for Slice-by-N algorithms */

/** Slice-by-4 Table */
#define CRC_IP_TABLE_SLICE_BY_4                                                                                 \
{                                                                                                               \
    {                                                                                                           \
...
/** Slice-by-8 Table */
#define CRC_IP_TABLE_SLICE_BY_8                                                                                 \
{                                                                                                               \
    {                                                                                                           \
        0x00000000U, 0xF26B8303U, 0xE13B70F7U, 0x1350F3F4U, 0xC79A971FU, 0x35F1141CU, 0x26A1E7E8U, 0xD4CA64EBU, \
        0x8AD958CFU, 0x78B2DBCCU, 0x6BE22838U, 0x9989AB3BU, 0x4D43CFD0U, 0xBF284CD3U, 0xAC78BF27U, 0x5E133C24U, \
...
#endif /* CRC_IP_LOOKUP_TABLES_SLICE_BY_N_H */
