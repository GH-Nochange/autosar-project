...
/* Check if source file and Crc header file are of the same vendor */
    ...
    #error "Crc_Ip_DevAssert.h and Crc_Ip_Types.h have different vendor ids"
#endif
...
/* Check if source file and Crc header file are of the same Autosar version */
    ...
    #error "AutoSar Version Numbers of Crc_Ip_DevAssert.h and Crc_Ip_Types.h are different"
#endif
...
/* Check if source file and Crc header file are of the same Software version */
    ...
    #error "Software Version Numbers of Crc_Ip_DevAssert.h and Crc_Ip_Types.h are different"
#endif
