...
==================================================================================================*/
#define SCHM_CRYPTO_43_CSEC_AR_RELEASE_MAJOR_VERSION_C     4
#define SCHM_CRYPTO_43_CSEC_AR_RELEASE_MINOR_VERSION_C     7
#define SCHM_CRYPTO_43_CSEC_AR_RELEASE_REVISION_VERSION_C  0
#define SCHM_CRYPTO_43_CSEC_SW_MAJOR_VERSION_C             3
#define SCHM_CRYPTO_43_CSEC_SW_MINOR_VERSION_C             0
#define SCHM_CRYPTO_43_CSEC_SW_PATCH_VERSION_C             0
...
* 
*/
uint32 Crypto_43_CSEC_schm_read_msr(void); 
...
#ifdef MCAL_PLATFORM_ARM
#if (MCAL_PLATFORM_ARM == MCAL_ARM_AARCH64)
ASM_KEYWORD uint32 Crypto_43_CSEC_schm_read_msr(void)
{
    mrs x0, S3_3_c4_c2_1
}
#elif  (MCAL_PLATFORM_ARM == MCAL_ARM_RARCH)
...
#ifdef MCAL_PLATFORM_S12
    #define Crypto_43_CSEC_schm_read_msr()  ASM_KEYWORD("tfr ccr, d6")
#else
    #define Crypto_43_CSEC_schm_read_msr() ASM_KEYWORD("mfmsr r3")
#endif
...
void SchM_Enter_Crypto_43_CSEC_CRYPTO_EXCLUSIVE_AREA_00(void)
{
    uint32 msr;
    ...
    if(0UL == reentry_guard_CRYPTO_EXCLUSIVE_AREA_00[u32CoreId])
    {
        ...
        msr = OsIf_Trusted_Call_Return(Crypto_43_CSEC_schm_read_msr);
#else
        msr = Crypto_43_CSEC_schm_read_msr();  /*read MSR (to store interrupts state)*/
...
void SchM_Exit_Crypto_43_CSEC_CRYPTO_EXCLUSIVE_AREA_00(void)
{
    uint32 u32CoreId = (uint32)OsIf_GetCoreID();
...
void SchM_Enter_Crypto_43_CSEC_CRYPTO_EXCLUSIVE_AREA_01(void)
{
    uint32 msr;
    uint32 u32CoreId = (uint32)OsIf_GetCoreID();
...
void SchM_Exit_Crypto_43_CSEC_CRYPTO_EXCLUSIVE_AREA_01(void)
{
    uint32 u32CoreId = (uint32)OsIf_GetCoreID();
...
void SchM_Enter_Crypto_43_CSEC_CRYPTO_EXCLUSIVE_AREA_02(void)
{
    uint32 msr;
    uint32 u32CoreId = (uint32)OsIf_GetCoreID();
...
void SchM_Exit_Crypto_43_CSEC_CRYPTO_EXCLUSIVE_AREA_02(void)
{
    uint32 u32CoreId = (uint32)OsIf_GetCoreID();
...
void SchM_Enter_Crypto_43_CSEC_CRYPTO_EXCLUSIVE_AREA_12(void)
{
    uint32 msr;
    uint32 u32CoreId = (uint32)OsIf_GetCoreID();
...
void SchM_Exit_Crypto_43_CSEC_CRYPTO_EXCLUSIVE_AREA_12(void)
{
    uint32 u32CoreId = (uint32)OsIf_GetCoreID();
...
@remarks Implements 
*/
void SchM_Check_crypto_43_csec(void)
{
    uint32 u32CoreId = (uint32)OsIf_GetCoreID();
