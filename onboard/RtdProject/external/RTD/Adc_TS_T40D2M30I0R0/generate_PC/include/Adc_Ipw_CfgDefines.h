...
#define ADC_IPW_TIMEOUT_TYPE                ([!"AutosarExt/AdcTimeoutMethod"!])

#define ADC_IPW_TIMEOUT_VAL                 ([!"AutosarExt/AdcTimeoutVal"!]UL)
...
*/
#define ADC_IPW_CTU_TRIGGER_MODE_SUPPORTED      (STD_OFF)
