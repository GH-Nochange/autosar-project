...
*/
#define ADC_MULTIPARTITION_SUPPORT               [!IF "node:value(AutosarExt/AdcMultiPartitionSupport)='true'"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
...
*/
#define ADC_MAX_PARTITIONS_CFG              ([!"node:value(AutosarExt/AdcMaxPartitions)"!]U)
[!ELSE!][!//
/**
* @brief          Maximum number of configured partitions.
*/
...
/**
* @brief           Active DMA Error.
*/
[!IF "AutosarExt/AdcEnableDmaErrorNotification"!][!//
#define ADC_DMA_ERROR_SUPPORTED
[!ENDIF!][!//

/**
* @brief           Active DMA transfer notification.
*/
[!LOOP "AdcHwConfiguration/*"!][!//
[!IF "DmaTransferEnable = 'true'"!][!//
[!VAR "AdcPhysicalId" = "substring-after(AdcHwConfiguredId,'ADC')"!][!//
#define ADC_UNIT_[!"$AdcPhysicalId"!]_DMA_TRANSFER_USED
[!ENDIF!][!//
[!ENDLOOP!][!//
...
/**
* @brief IRQ definition and End Of Chain Notification
*/
[!LOOP "AdcHwConfiguration/*"!][!//
  [!VAR "AdcPhysicalId" = "substring-after(AdcHwConfiguredId,'ADC')"!][!//
  [!IF "AdcNormalInterruptEnable = 'true'"!][!//
[!CODE!]
#define ADC_UNIT_[!"$AdcPhysicalId"!]_ISR_USED
