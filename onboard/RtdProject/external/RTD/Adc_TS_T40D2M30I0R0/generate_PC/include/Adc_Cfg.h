...
[!LOOP "variant:all()"!]
[!CODE!]#include "Adc_[!"."!]_PBcfg.h"[!CR!][!ENDCODE!]
[!ENDLOOP!]
[!ELSE!]
[!CODE!]#include "Adc_PBcfg.h"[!CR!][!ENDCODE!]
[!ENDIF!]
...
#define ADC_SW_MAJOR_VERSION_CFG                3
...
#if (ADC_VENDOR_ID_[!"text:toupper(.)"!]_PBCFG != ADC_VENDOR_ID_CFG)
    #error "Adc_[!"."!]_PBcfg.h and Adc_Cfg.h have different vendor IDs"
#endif
/* Check if header file and Adc configuration header file are of the same Autosar version */
#if ((ADC_AR_RELEASE_MAJOR_VERSION_[!"text:toupper(.)"!]_PBCFG != ADC_AR_RELEASE_MAJOR_VERSION_CFG) || \
     (ADC_AR_RELEASE_MINOR_VERSION_[!"text:toupper(.)"!]_PBCFG != ADC_AR_RELEASE_MINOR_VERSION_CFG) || \
     (ADC_AR_RELEASE_REVISION_VERSION_[!"text:toupper(.)"!]_PBCFG != ADC_AR_RELEASE_REVISION_VERSION_CFG) \
    )
    #error "AutoSar Version Numbers of Adc_[!"."!]_PBcfg.h and Adc_Cfg.h are different"
#endif
/* Check if header file and Adc configuration header file are of the same software version */
#if ((ADC_SW_MAJOR_VERSION_[!"text:toupper(.)"!]_PBCFG != ADC_SW_MAJOR_VERSION_CFG) || \
     (ADC_SW_MINOR_VERSION_[!"text:toupper(.)"!]_PBCFG != ADC_SW_MINOR_VERSION_CFG) || \
     (ADC_SW_PATCH_VERSION_[!"text:toupper(.)"!]_PBCFG != ADC_SW_PATCH_VERSION_CFG) \
    )
    #error "Software Version Numbers of Adc_[!"."!]_PBcfg.h and Adc_Cfg.h are different"
#endif[!//
[!ENDLOOP!][!//
[!ELSE!][!//
/* Check if source file and Adc configuration header file are of the same vendor */
