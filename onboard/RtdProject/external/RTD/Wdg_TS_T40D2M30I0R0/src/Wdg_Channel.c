...
*/
static const Wdg_ConfigType* Wdg_apxConfigPtr[WDG_NO_OF_INSTANCES];
...
==================================================================================================*/
...
#if (WDG_VALIDATE_GLOBAL_CALL == STD_ON)
    #define WDG_START_SEC_VAR_INIT_UNSPECIFIED_NO_CACHEABLE
    ...
    */
    ...
    #define WDG_STOP_SEC_VAR_INIT_UNSPECIFIED_NO_CACHEABLE
    ...
    */
    static uint64 Wdg_au64Timeout[WDG_NO_OF_INSTANCES]; /* implicit zero initialization*/

    #define WDG_STOP_SEC_VAR_CLEARED_UNSPECIFIED_NO_CACHEABLE

    #include "Wdg_MemMap.h"

    #define WDG_START_SEC_VAR_CLEARED_32_NO_CACHEABLE
    ...
    */
    ...
    #define WDG_STOP_SEC_VAR_CLEARED_32_NO_CACHEABLE
...
*/
static WdgIf_ModeType Wdg_aePreviousMode[WDG_NO_OF_INSTANCES]; /* implicit zero initialization*/

#if (WDG_DIRECT_SERVICE == STD_OFF)
#if (WDG_VALIDATE_PARAMS == STD_ON)
    static WdgIf_ModeType Wdg_aeCurrentMode[WDG_NO_OF_INSTANCES]; /* implicit zero initialization*/
...
#if (WDG_VALIDATE_PARAMS == STD_ON)
static inline Std_ReturnType Wdg_ValidatePtrInit(const Wdg_ConfigType* const ConfigPtr,
                                                 const Wdg_Ipw_InstanceType Instance);
#endif /* (WDG_VALIDATE_PARAMS == STD_ON) */
...
#if (WDG_MULTIPARTITION_ENABLED == STD_ON)
static inline Std_ReturnType Wdg_ChannelValidatePartitionUsed(uint32 UserID,
                                                              const Wdg_Ipw_InstanceType Instance,
                                                              Wdg_ServiceIdType ServiceId,
                                                              Wdg_ErrorIdType ErrorId);
#endif /* (WDG_MULTIPARTITION_ENABLED == STD_ON) */
                                                    ...
                                                    const Wdg_Ipw_InstanceType Instance)
{
    ...
    else
    {
        ...
        {
            if (NULL_PTR == Wdg_apxConfigPtr[Instance])
            {
 ...
 *
 * @param[in]   The Wdg_ChannelValidatePartitionUsed will check invalidate UserID.
 * @param[in]   ServiceId    The service id of the caller function
                                                              ...
                                                              Wdg_ErrorIdType ErrorId)
{
    ...
    if (UserID == Wdg_au32InstancePartitionUsed[Instance])
    {
    ...
    */
    ...
    {
        uint64 TempTimeout;
    #if ((WDG_MULTIPARTITION_ENABLED == STD_ON) || (WDG_VALIDATE_GLOBAL_CALL == STD_ON))
        Std_ReturnType Valid;
    #endif /* ((WDG_MULTIPARTITION_ENABLED == STD_ON) || (WDG_VALIDATE_GLOBAL_CALL == STD_ON)) */
    #if (WDG_MULTIPARTITION_ENABLED == STD_ON)
        volatile uint32 UserID;

        UserID = (uint32) Wdg_GetUserID();
        Valid = Wdg_ChannelValidatePartitionUsed(UserID, Instance,WDG_TRIGGER_ID,WDG_E_PARAM_CONFIG);
        ...
        if ((Std_ReturnType)E_OK == Valid)
        {
            ...
            if ((Std_ReturnType)E_OK == Valid)
            {
                ...
                if (Wdg_au64Timeout[Instance] < (uint64)Wdg_au32GptPeriod[Instance])
                {
                    SchM_Exit_Wdg_WDG_EXCLUSIVE_AREA_00();

                    Gpt_StopTimer(Wdg_apxConfigPtr[Instance]->Wdg_TimerChannel);
                }
                else
                {
                    TempTimeout = Wdg_au64Timeout[Instance] - Wdg_au32GptPeriod[Instance];
                    Wdg_au64Timeout[Instance] = TempTimeout;
                    SchM_Exit_Wdg_WDG_EXCLUSIVE_AREA_00();
                                                     ...
                                                     const Wdg_Ipw_InstanceType Instance)
{
    ...
    if ((!((WDGIF_OFF_MODE  == Wdg_Mode)||(WDGIF_FAST_MODE == Wdg_Mode)||(WDGIF_SLOW_MODE == Wdg_Mode))) || \
        (NULL_PTR == Wdg_apxConfigPtr[Instance]->Wdg_ModeSettings[Wdg_Mode]) \
       )
    {
#if (WDG_VALIDATE_PARAMS == STD_ON)
...
static inline Std_ReturnType Wdg_InitialHardware(const Wdg_Ipw_InstanceType Instance, const Std_ReturnType Status)
{
    ...
    if ((Std_ReturnType)E_OK == Valid)
    {
        if (WDGIF_OFF_MODE == Wdg_apxConfigPtr[Instance]->Wdg_DefaultMode)
        {
        #if (WDG_DISABLE_ALLOWED == (STD_ON))
            Valid = Wdg_Ipw_SetMode(Instance, Wdg_apxConfigPtr[Instance]->Wdg_ModeSettings[Wdg_apxConfigPtr[Instance]->Wdg_DefaultMode]->Wdg_Ipw_pConfig);
        #else
            Valid = (Std_ReturnType)E_NOT_OK;
        #endif
        }
        ...
        {
            Valid = Wdg_Ipw_Init(Instance, Wdg_apxConfigPtr[Instance]->Wdg_ModeSettings[Wdg_apxConfigPtr[Instance]->Wdg_DefaultMode]->Wdg_Ipw_pConfig);
        }
    }
    return Valid;
}
...
static inline Std_ReturnType Wdg_VadidateHardwareSetting(const Wdg_Ipw_InstanceType Instance, const Std_ReturnType Status)
{
    ...
    #endif
        Wdg_apxConfigPtr[Instance] = NULL_PTR;
    }
    else
    {
...
static inline Std_ReturnType Wdg_DoChannelSetMode(const Wdg_Ipw_InstanceType Instance, const WdgIf_ModeType Mode)
{
    ...
    if (WDGIF_OFF_MODE == Mode)
    {
        ...
        {
            Valid = Wdg_Ipw_SetMode(Instance, Wdg_apxConfigPtr[Instance]->Wdg_ModeSettings[Mode]->Wdg_Ipw_pConfig);
        }
        else
        {
            Valid = (Std_ReturnType)E_NOT_OK;
    ...
    else
    {
        ...
        {
            if ((Std_ReturnType)E_OK == Wdg_Ipw_SetMode(Instance, Wdg_apxConfigPtr[Instance]->Wdg_ModeSettings[Mode]->Wdg_Ipw_pConfig))
            {
...
#if (WDG_DIRECT_SERVICE == STD_OFF)
        Gpt_StopTimer(Wdg_apxConfigPtr[Instance]->Wdg_TimerChannel);
        ElapsedTime =  Gpt_GetTimeElapsed(Wdg_apxConfigPtr[Instance]->Wdg_TimerChannel);

        /* update timeout */
        SchM_Enter_Wdg_WDG_EXCLUSIVE_AREA_03();
        if (Wdg_au64Timeout[Instance] < ElapsedTime)
        {
            ValueTempU64 = 0;
        }
        else
        {
            ValueTempU64 = Wdg_au64Timeout[Instance] - ElapsedTime;
        }
        Wdg_au64Timeout[Instance] =  ValueTempU64;
        SchM_Exit_Wdg_WDG_EXCLUSIVE_AREA_03();
        Wdg_au32GptPeriod[Instance] = Wdg_apxConfigPtr[Instance]->Wdg_ModeSettings[Mode]->Wdg_u32TimerTriggeringPeriod;

        /* Start the timer only if the mode is not off mode*/
        if (WDGIF_OFF_MODE != Mode)
        {
            Gpt_StartTimer(Wdg_apxConfigPtr[Instance]->Wdg_TimerChannel,Wdg_au32GptPeriod[Instance]);
        }
#endif /* (WDG_DIRECT_SERVICE == STD_OFF) */
        Valid = (Std_ReturnType)E_OK;
...
static inline void Wdg_ChannelStartGpt(const Wdg_Ipw_InstanceType Instance)
{
    ...
    Wdg_au32GptPeriod[Instance] = Wdg_apxConfigPtr[Instance]->Wdg_ModeSettings[Wdg_apxConfigPtr[Instance]->Wdg_DefaultMode]->Wdg_u32TimerTriggeringPeriod;

    Gpt_EnableNotification(Wdg_apxConfigPtr[Instance]->Wdg_TimerChannel);
    ...
    Wdg_au64Timeout[Instance] = (uint64)((uint64)Wdg_au16CfgInitialTimeout[Instance]*((uint64)Wdg_apxConfigPtr[Instance]->Wdg_u32TriggerSourceClock));
...
void Wdg_ChannelInit(const Wdg_Ipw_InstanceType Instance, const Wdg_ConfigType *ConfigPtr)
{
    ...
    UserID = (uint32) Wdg_GetUserID();
    Valid = Wdg_ChannelValidatePartitionUsed(UserID, Instance,WDG_INIT_ID,WDG_E_PARAM_CONFIG);
    if ((Std_ReturnType)E_OK == Valid)
    {
#endif /* (WDG_MULTIPARTITION_ENABLED == STD_ON) */
#if (WDG_VALIDATE_GLOBAL_CALL == STD_ON)
        ...
        if ((Std_ReturnType)E_OK == Valid)
        {
            ...
            if ((Std_ReturnType)E_OK == Valid)
            {
...
#if (WDG_PRECOMPILE_SUPPORT == STD_ON)
                Wdg_apxConfigPtr[Instance] = Wdg_Config[Instance];
                (void)ConfigPtr;
#else
                Wdg_apxConfigPtr[Instance] = ConfigPtr;
#endif /*(WDG_PRECOMPILE_SUPPORT == STD_ON)*/

#if (WDG_DIRECT_SERVICE == STD_OFF)
#if (WDG_VALIDATE_PARAMS == STD_ON)
                Wdg_aeCurrentMode[Instance] = Wdg_apxConfigPtr[Instance]->Wdg_DefaultMode;
#endif /*(WDG_VALIDATE_PARAMS == STD_ON)*/
                ...
                {
#endif /* (WDG_DIRECT_SERVICE == STD_OFF) */
                    Valid = Wdg_ChannelValidateMode(Wdg_apxConfigPtr[Instance]->Wdg_DefaultMode, WDG_INIT_ID, WDG_E_PARAM_MODE, Instance);
                }
                else
                {
                    Valid = (Std_ReturnType)E_NOT_OK;
                ...
                if ((Std_ReturnType)E_OK == Valid)
                {
                    ...
                    Wdg_aePreviousMode[Instance] =  Wdg_apxConfigPtr[Instance]->Wdg_DefaultMode;
...
Std_ReturnType Wdg_ChannelSetMode(const Wdg_Ipw_InstanceType Instance, WdgIf_ModeType Mode)
{
    ...
    UserID = (uint32) Wdg_GetUserID();
    Valid = Wdg_ChannelValidatePartitionUsed(UserID, Instance,WDG_SETMODE_ID,WDG_E_PARAM_CONFIG);
    if ((Std_ReturnType)E_OK == Valid)
    {
#endif /* (WDG_MULTIPARTITION_ENABLED == STD_ON) */
#if (WDG_VALIDATE_GLOBAL_CALL == STD_ON)
    ...
    */
    ...
    #if ((WDG_VALIDATE_GLOBAL_CALL == STD_ON) ||  (WDG_MULTIPARTITION_ENABLED == STD_ON))
        Std_ReturnType Valid;
    #endif /* ((WDG_VALIDATE_GLOBAL_CALL == STD_ON) ||  (WDG_MULTIPARTITION_ENABLED == STD_ON)) */

    #if (WDG_MULTIPARTITION_ENABLED == STD_ON)
        volatile uint32 UserID;

        UserID = (uint32) Wdg_GetUserID();
        Valid = Wdg_ChannelValidatePartitionUsed(UserID, Instance,WDG_SETTRIGGERCONDITION_ID,WDG_E_PARAM_CONFIG);
        if ((Std_ReturnType)E_OK == Valid)
        {
    #endif /* (WDG_MULTIPARTITION_ENABLED == STD_ON) */
    #if (WDG_VALIDATE_GLOBAL_CALL == STD_ON)
            ...
            if ((Std_ReturnType)E_OK == Valid)
            {
                ...
                if ((Std_ReturnType)E_OK == Valid)
                {
                    ...
                    if (((Gpt_ValueType)(ElapsedTime) > Wdg_au64Timeout[Instance]) || ((uint16)0 == Timeout))
                    {
                        Wdg_au64Timeout[Instance] = (uint64)0;
                    ...
                    {
                        Wdg_au64Timeout[Instance] = (uint64)((uint64)Timeout * (uint64)Wdg_apxConfigPtr[Instance]->Wdg_u32TriggerSourceClock) + ElapsedTime;
                        SchM_Exit_Wdg_WDG_EXCLUSIVE_AREA_05();
                    }
    #if (WDG_VALIDATE_PARAMS == STD_ON)
                }
...
void Wdg_ChannelService(const Wdg_Ipw_InstanceType Instance)
{
    ...
    UserID = (uint32) Wdg_GetUserID();
    Valid = Wdg_ChannelValidatePartitionUsed(UserID, Instance,WDG_SERVICE_ID,WDG_E_PARAM_CONFIG);
    if ((Std_ReturnType)E_OK == Valid)
#endif /* (WDG_MULTIPARTITION_ENABLED == STD_ON) */
    {
    #if (WDG_VALIDATE_GLOBAL_CALL == STD_ON)
        Valid = Wdg_ChannelValidateGlobalCall(WDG_SERVICE_ID, Instance);
    #endif /* (WDG_VALIDATE_GLOBAL_CALL == STD_ON) */
        if ((Std_ReturnType)E_OK == Valid)
        {
            Wdg_Ipw_Service(Instance);
