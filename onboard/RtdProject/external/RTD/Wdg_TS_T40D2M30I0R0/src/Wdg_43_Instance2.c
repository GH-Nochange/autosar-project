...
#define WDG_43_INSTANCE2_VENDOR_ID_C                    43
#define WDG_43_INSTANCE2_AR_RELEASE_MAJOR_VERSION_C     4
#define WDG_43_INSTANCE2_AR_RELEASE_MINOR_VERSION_C     7
#define WDG_43_INSTANCE2_AR_RELEASE_REVISION_VERSION_C  0
#define WDG_43_INSTANCE2_SW_MAJOR_VERSION_C             3
#define WDG_43_INSTANCE2_SW_MINOR_VERSION_C             0
#define WDG_43_INSTANCE2_SW_PATCH_VERSION_C             0

/*==================================================================================================
                                      FILE VERSION CHECKS
==================================================================================================*/
/* Check if current file and Wdg_Channel.h header file are of the same vendor */
#if (WDG_43_INSTANCE2_VENDOR_ID_C != WDG_CHANNEL_VENDOR_ID)
    #error "Wdg_Channel.c and Wdg_Channel.h have different vendor ids"
#endif

#if ((WDG_43_INSTANCE2_AR_RELEASE_MAJOR_VERSION_C    != WDG_CHANNEL_AR_RELEASE_MAJOR_VERSION) || \
     (WDG_43_INSTANCE2_AR_RELEASE_MINOR_VERSION_C    != WDG_CHANNEL_AR_RELEASE_MINOR_VERSION) || \
     (WDG_43_INSTANCE2_AR_RELEASE_REVISION_VERSION_C != WDG_CHANNEL_AR_RELEASE_REVISION_VERSION))
#error "AutoSar Version Numbers of Wdg.c and Wdg_Channel.h are different"
#endif

#if ((WDG_43_INSTANCE2_SW_MAJOR_VERSION_C != WDG_CHANNEL_SW_MAJOR_VERSION) || \
     (WDG_43_INSTANCE2_SW_MINOR_VERSION_C != WDG_CHANNEL_SW_MINOR_VERSION) || \
     (WDG_43_INSTANCE2_SW_PATCH_VERSION_C != WDG_CHANNEL_SW_PATCH_VERSION))
...
#if (WDG_43_INSTANCE2_VENDOR_ID_C != WDG_43_INSTANCE2_VENDOR_ID)
    #error "Wdg_Channel.c and Wdg.h have different vendor ids"
#endif

#if ((WDG_43_INSTANCE2_AR_RELEASE_MAJOR_VERSION_C    != WDG_43_INSTANCE2_AR_RELEASE_MAJOR_VERSION) || \
     (WDG_43_INSTANCE2_AR_RELEASE_MINOR_VERSION_C    != WDG_43_INSTANCE2_AR_RELEASE_MINOR_VERSION) || \
     (WDG_43_INSTANCE2_AR_RELEASE_REVISION_VERSION_C != WDG_43_INSTANCE2_AR_RELEASE_REVISION_VERSION))
#error "AutoSar Version Numbers of Wdg.c and Wdg.h are different"
#endif

#if ((WDG_43_INSTANCE2_SW_MAJOR_VERSION_C != WDG_43_INSTANCE2_SW_MAJOR_VERSION) || \
     (WDG_43_INSTANCE2_SW_MINOR_VERSION_C != WDG_43_INSTANCE2_SW_MINOR_VERSION) || \
     (WDG_43_INSTANCE2_SW_PATCH_VERSION_C != WDG_43_INSTANCE2_SW_PATCH_VERSION))
...
#if (WDG_43_INSTANCE2_VENDOR_ID_C != WDG_CHANNEL_TYPES_VENDOR_ID)
    #error "Wdg_Channel.c and Wdg_ChannelTypes.h have different vendor ids"
#endif

#if ((WDG_43_INSTANCE2_AR_RELEASE_MAJOR_VERSION_C    != WDG_CHANNEL_TYPES_AR_RELEASE_MAJOR_VERSION) || \
     (WDG_43_INSTANCE2_AR_RELEASE_MINOR_VERSION_C    != WDG_CHANNEL_TYPES_AR_RELEASE_MINOR_VERSION) || \
     (WDG_43_INSTANCE2_AR_RELEASE_REVISION_VERSION_C != WDG_CHANNEL_TYPES_AR_RELEASE_REVISION_VERSION))
#error "AutoSar Version Numbers of Wdg.c and Wdg_ChannelTypes.h are different"
#endif

#if ((WDG_43_INSTANCE2_SW_MAJOR_VERSION_C != WDG_CHANNEL_TYPES_SW_MAJOR_VERSION) || \
     (WDG_43_INSTANCE2_SW_MINOR_VERSION_C != WDG_CHANNEL_TYPES_SW_MINOR_VERSION) || \
     (WDG_43_INSTANCE2_SW_PATCH_VERSION_C != WDG_CHANNEL_TYPES_SW_PATCH_VERSION))
...
{
    Wdg_ChannelInit(WDG_IPW_INSTANCE2, ConfigPtr);
}
...
{
    return Wdg_ChannelSetMode(WDG_IPW_INSTANCE2, Mode);
}

#if (WDG_DIRECT_SERVICE_INSTANCE2 == STD_OFF)
    /**
    ...
    **/
    ...
    {
        Wdg_ChannelSetTriggerCondition(WDG_IPW_INSTANCE2, Timeout);
    }
#endif
    ...
    **/
    ...
    {
        Wdg_ChannelService(WDG_IPW_INSTANCE2);
    }
#endif
...
{
    Wdg_ChannelGetVersionInfo(WDG_IPW_INSTANCE2, Versioninfo);
}
