...
==================================================================================================*/
    ...
    extern const uint32 Wdg_au32InstancePartitionUsed[WDG_NO_OF_INSTANCES];
    ...
    [!FOR "i" = "0" TO "num:i(ecu:get('Wdg.Num.Of.Instances'))-1"!]
        ...
        [!IF "node:exists($xPathModule)"!]
            ...
            [!IF "var:defined('postBuildVariant')"!]
                [!CODE!]extern const Wdg_ConfigType Wdg_Config_[!"$i"!][!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!IF "var:defined('PartitionName')"!]_[!"$PartitionName"!][!ENDIF!][!ENDIF!];[!ENDCODE!][!CR!]
            [!ELSE!]
