        ...
        [!IF "var:defined('postBuildVariant')"!]
            [!LOOP "variant:all()"!][!//
                [!CODE!]
                    ...
                    #if (WDG_VENDOR_ID_CFG != WDG_43_INSTANCE[!"$i"!]_VENDOR_ID_[!"text:toupper(.)"!]_PBCFG)
                    ...
                    #if ((WDG_AR_RELEASE_MAJOR_VERSION_CFG    != WDG_43_INSTANCE[!"$i"!]_AR_RELEASE_MAJOR_VERSION_[!"text:toupper(.)"!]_PBCFG) || \
                         (WDG_AR_RELEASE_MINOR_VERSION_CFG    != WDG_43_INSTANCE[!"$i"!]_AR_RELEASE_MINOR_VERSION_[!"text:toupper(.)"!]_PBCFG) || \
                         (WDG_AR_RELEASE_REVISION_VERSION_CFG != WDG_43_INSTANCE[!"$i"!]_AR_RELEASE_REVISION_VERSION_[!"text:toupper(.)"!]_PBCFG) \
                        )
                    ...
                    #if ((WDG_SW_MAJOR_VERSION_CFG != WDG_43_INSTANCE[!"$i"!]_SW_MAJOR_VERSION_[!"text:toupper(.)"!]_PBCFG) || \
                         (WDG_SW_MINOR_VERSION_CFG != WDG_43_INSTANCE[!"$i"!]_SW_MINOR_VERSION_[!"text:toupper(.)"!]_PBCFG) || \
                         (WDG_SW_PATCH_VERSION_CFG != WDG_43_INSTANCE[!"$i"!]_SW_PATCH_VERSION_[!"text:toupper(.)"!]_PBCFG) \
                        )
...
[!IF "not((IMPLEMENTATION_CONFIG_VARIANT != 'VariantPostBuild') and (variant:size() <= 1))"!]
    [!FOR "i" = "0" TO "num:i(ecu:get('Wdg.Num.Of.Instances'))-1"!][!CR!]
        ...
        [!IF "node:exists($xPathModule)"!]
            ...
            [!IF "var:defined('postBuildVariant')"!]
                [!LOOP "variant:all()"!]
                    [!CODE!]WDG_43_INSTANCE[!"$i"!]_CONFIG_[!"text:toupper(.)"!]_PB[!ENDCODE!][!CR!]
                [!ENDLOOP!]
            [!ELSE!]
