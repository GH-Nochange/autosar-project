...
[!FOR "i" = "0" TO "num:i(ecu:get('Wdg.Num.Of.Instances'))-1"!]
    ...
    [!IF "node:exists($xPathModule) and contains(ecu:list('Wdg.WdgInstance')[$i + 1], 'AEWDOG')"!]
        [!IF "var:defined('postBuildVariant')"!][!//
            [!LOOP "variant:all()"!][!//
                [!CODE!]#include "AeWdog_Ip_[!"."!]_PBcfg.h"
                [!ENDCODE!]
            [!ENDLOOP!]
        [!ELSE!]
...
==================================================================================================*/
    ...
    /* Checks against Std_Types.h */
        ...
        #error "AutoSar Version Numbers of AeWdog_Ip_Cfg.h and Std_Types.h are different"
    #endif
#endif
...
[!IF "var:defined('postBuildVariant')"!][!//
[!LOOP "variant:all()"!][!//
#if (AEWDOG_IP_VENDOR_ID_CFG_H != AEWDOG_IP_VENDOR_ID_[!"text:toupper(.)"!]_PBCFG)
    #error "AeWdog_Ip_Cfg.h and AeWdog_Ip_[!"."!]_PBcfg.h have different vendor IDs"
#endif

#if ((AEWDOG_IP_AR_RELEASE_MAJOR_VERSION_CFG_H != AEWDOG_IP_AR_RELEASE_MAJOR_VERSION_[!"text:toupper(.)"!]_PBCFG) || \
     (AEWDOG_IP_AR_RELEASE_MINOR_VERSION_CFG_H != AEWDOG_IP_AR_RELEASE_MINOR_VERSION_[!"text:toupper(.)"!]_PBCFG) || \
     (AEWDOG_IP_AR_RELEASE_REVISION_VERSION_CFG_H != AEWDOG_IP_AR_RELEASE_REVISION_VERSION_[!"text:toupper(.)"!]_PBCFG) \
    )
    #error "AutoSar Version Numbers of AeWdog_Ip_Cfg.h and AeWdog_Ip_[!"."!]_PBcfg.h are different"
#endif

#if ((AEWDOG_IP_SW_MAJOR_VERSION_CFG_H != AEWDOG_IP_SW_MAJOR_VERSION_[!"text:toupper(.)"!]_PBCFG) || \
     (AEWDOG_IP_SW_MINOR_VERSION_CFG_H != AEWDOG_IP_SW_MINOR_VERSION_[!"text:toupper(.)"!]_PBCFG) || \
     (AEWDOG_IP_SW_PATCH_VERSION_CFG_H != AEWDOG_IP_SW_PATCH_VERSION_[!"text:toupper(.)"!]_PBCFG) \
    )
    #error "Software Version Numbers of AeWdog_Ip_Cfg.h and AeWdog_Ip_[!"."!]_PBcfg.h are different"
#endif
[!ENDLOOP!][!//
[!ELSE!][!//
#if (AEWDOG_IP_VENDOR_ID_CFG_H != AEWDOG_IP_VENDOR_ID_PBCFG)
    #error "AeWdog_Ip_Cfg.h and AeWdog_Ip_PBcfg.h have different vendor IDs"
#endif

#if ((AEWDOG_IP_AR_RELEASE_MAJOR_VERSION_CFG_H != AEWDOG_IP_AR_RELEASE_MAJOR_VERSION_PBCFG) || \
     (AEWDOG_IP_AR_RELEASE_MINOR_VERSION_CFG_H != AEWDOG_IP_AR_RELEASE_MINOR_VERSION_PBCFG) || \
     (AEWDOG_IP_AR_RELEASE_REVISION_VERSION_CFG_H != AEWDOG_IP_AR_RELEASE_REVISION_VERSION_PBCFG) \
    )
    #error "AutoSar Version Numbers of AeWdog_Ip_Cfg.h and AeWdog_Ip_PBcfg.h are different"
#endif

#if ((AEWDOG_IP_SW_MAJOR_VERSION_CFG_H != AEWDOG_IP_SW_MAJOR_VERSION_PBCFG) || \
     (AEWDOG_IP_SW_MINOR_VERSION_CFG_H != AEWDOG_IP_SW_MINOR_VERSION_PBCFG) || \
     (AEWDOG_IP_SW_PATCH_VERSION_CFG_H != AEWDOG_IP_SW_PATCH_VERSION_PBCFG) \
    )
