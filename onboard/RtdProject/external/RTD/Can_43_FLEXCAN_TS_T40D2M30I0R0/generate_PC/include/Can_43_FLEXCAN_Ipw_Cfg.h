...
[!LOOP "variant:all()"!][!//
#include "Can_43_FLEXCAN_Ipw_[!"."!]_PBcfg.h"
[!ENDLOOP!][!//
[!ELSE!][!//
...
[!LOOP "variant:all()"!]
[!CODE!][!//
/* Checks against Can_43_FLEXCAN_Ipw_[!"."!]_PBcfg.h */
#if (CAN_43_FLEXCAN_IPW_CFG_VENDOR_ID != CAN_43_FLEXCAN_VENDOR_ID_[!"text:toupper(.)"!]_IPW_PBCFG_H)
    #error "Can_43_FLEXCAN_Ipw_Cfg.h and Can_43_FLEXCAN_Ipw_[!"."!]_PBcfg.h have different vendor ids"
#endif
#if ((CAN_43_FLEXCAN_IPW_CFG_AR_RELEASE_MAJOR_VERSION    != CAN_43_FLEXCAN_AR_RELEASE_MAJOR_VERSION_[!"text:toupper(.)"!]_IPW_PBCFG_H) || \
     (CAN_43_FLEXCAN_IPW_CFG_AR_RELEASE_MINOR_VERSION    != CAN_43_FLEXCAN_AR_RELEASE_MINOR_VERSION_[!"text:toupper(.)"!]_IPW_PBCFG_H) || \
     (CAN_43_FLEXCAN_IPW_CFG_AR_RELEASE_REVISION_VERSION != CAN_43_FLEXCAN_AR_RELEASE_REVISION_VERSION_[!"text:toupper(.)"!]_IPW_PBCFG_H) \
    )
    #error "AutoSar Version Numbers of Can_43_FLEXCAN_Ipw_Cfg.h and Can_43_FLEXCAN_Ipw_[!"."!]_PBcfg.h are different"
#endif
#if ((CAN_43_FLEXCAN_IPW_CFG_SW_MAJOR_VERSION != CAN_43_FLEXCAN_SW_MAJOR_VERSION_[!"text:toupper(.)"!]_IPW_PBCFG_H) || \
     (CAN_43_FLEXCAN_IPW_CFG_SW_MINOR_VERSION != CAN_43_FLEXCAN_SW_MINOR_VERSION_[!"text:toupper(.)"!]_IPW_PBCFG_H) || \
     (CAN_43_FLEXCAN_IPW_CFG_SW_PATCH_VERSION != CAN_43_FLEXCAN_SW_PATCH_VERSION_[!"text:toupper(.)"!]_IPW_PBCFG_H) \
    )
    #error "Software Version Numbers of Can_43_FLEXCAN_Ipw_Cfg.h and Can_43_FLEXCAN_Ipw_[!"."!]_PBcfg.h are different"
#endif
[!ENDCODE!]
[!ENDLOOP!]
[!ELSE!]
...
#define CAN_43_FLEXCAN_MB_INTERRUPT_SUPPORT               [!IF "num:i($MbIntFlag) = 1"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
...
#define CAN_43_FLEXCAN_FEATURE_HAS_DMA_ENABLE             [!IF "node:exists(CanConfigSet/CanController/*[node:exists(CanRxFiFo) and CanRxFiFo = 'CanEnhanceFiFo' and CanRxFiFo/CanEnhanceFiFoDmaEnable = 'true'])"!](STD_ON)[!ELSEIF "node:exists(CanConfigSet/CanController/*[node:exists(CanRxFiFo) and CanRxFiFo = 'CanLegacyFiFo' and CanRxFiFo/CanLegacyFiFoDmaEnable = 'true'])"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
#define CAN_43_FLEXCAN_FEATURE_HAS_PRETENDED_NETWORKING   [!IF "(ecu:get('Can.CanConfigSet.CanPretendedNetworking') = 'STD_ON') and (CanGeneral/CanPublicIcomSupport = 'true')"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
...
[!IF "var:defined('postBuildVariant')"!]
    ...
    [!LOOP "variant:all()"!]
        ...
        [!CODE!]CAN_43_FLEXCAN_IPW_CONFIG_[!"text:toupper(.)"!]_PB [!IF "$variantIndex < $variantNumber"!]\[!ENDIF!][!CR!][!ENDCODE!]
    [!ENDLOOP!]
[!ELSE!]
    [!CODE!]CAN_43_FLEXCAN_IPW_CONFIG_PB[!CR!][!ENDCODE!]
[!ENDIF!]
[!ENDNOCODE!]

[!IF "ecu:get('Can.CanConfigSet.CanPretendedNetworking') = 'STD_ON' and ./CanGeneral/CanPublicIcomSupport = 'true'"!]
#define CAN_43_FLEXCAN_IPW_ICOM_RXMESSAGE_EXT \
[!NOCODE!]
[!IF "var:defined('postBuildVariant')"!]
    [!VAR "variantIndex"="0"!]
    [!VAR "variantNumber"="variant:size()"!]
    [!LOOP "variant:all()"!]
        [!VAR "variantIndex"="$variantIndex + 1"!]
        [!CODE!]CAN_43_FLEXCAN_IPW_ICOM_RXMESSAGE_CONFIG_[!"text:toupper(.)"!]_PB [!IF "$variantIndex < $variantNumber"!]\[!ENDIF!][!CR!][!ENDCODE!]
    [!ENDLOOP!]
[!ELSE!]
    [!CODE!]CAN_43_FLEXCAN_IPW_ICOM_RXMESSAGE_CONFIG_PB[!CR!][!ENDCODE!]
[!ENDIF!]
[!ENDNOCODE!]
[!ENDIF!]
/*==================================================================================================
