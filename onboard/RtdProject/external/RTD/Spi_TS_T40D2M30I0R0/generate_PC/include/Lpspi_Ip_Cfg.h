...
[!ENDIF!]
[!IF "contains(ecu:get('Spi.SpiGeneral.SpiPhyUnit.SpiPhyUnitMapping'), 'LPSPI')"!][!//
#include "[!"ecu:get('Spi.SpiHeaderNameLPSPI')"!].h"
[!IF "(node:exists(SpiAutosarExt/SpiEnableLlceLpspiSupport))"!][!//
#include "[!"ecu:get('Spi.SpiWrapperFileName')"!].h"
#include "[!"ecu:get('Spi.SpiHeaderNameLLCECore2Core')"!].h"
[!ENDIF!]
[!ENDIF!]
/*==================================================================================================
...
* @brief LLCE support
*/
/** @implements LPSPI_IP_LLCE_SUPPORT_define  */
#define LPSPI_IP_LLCE_SUPPORT     [!IF "(node:value(SpiAutosarExt/SpiEnableLlceLpspiSupport) = 'true')"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
[!ENDIF!]

#ifndef LPSPI_IP_LLCE_SUPPORT
    #define LPSPI_IP_SUPPORT STD_ON
#else
    #if (STD_ON == LPSPI_IP_LLCE_SUPPORT)
        #define LPSPI_IP_SUPPORT STD_ON
    #else
        #define LPSPI_IP_SUPPORT STD_OFF
    #endif
#endif
...
[!NOCODE!][!//
[!VAR "LpspiFIFOSize" = "0"!]
[!IF "ecu:has('Spi.LpspiFIFOSize')"!][!//
[!VAR "LpspiFIFOSize" = "ecu:get('Spi.LpspiFIFOSize')"!]
[!ELSE!]
[!VAR "LpspiFIFOSize" = "ecu:get('Spi.SpiFIFOSize')"!]
[!ENDIF!][!//
[!ENDNOCODE!][!//
/** @brief Number of FIFO entries supported */
#define LPSPI_IP_FIFO_SIZE_U8   ((uint8)[!"num:i($LpspiFIFOSize)"!]U)
...
* @api
*/
[!IF "ecu:has('Spi.LlceLpspiSupport')"!]
...
*/
#define LPSPI_IP_FRAMESIZE_MAX_U16                              ((uint16)[!"ecu:get('Spi.SpiFrameSizeMax')"!]U)

/**
* @brief Minimum of frame size supported.
*/
#define LPSPI_IP_FRAMESIZE_MIN_U16                              ((uint16)[!"ecu:get('Spi.SpiFrameSizeMin')"!]U)
...
*/
#define LPSPI_IP_HALF_DUPLEX_TIMEOUT_COUNTER       ((uint32)[!"num:i(SpiGeneral/SpiTransmitTimeout)"!]U)
#endif
/*==================================================================================================
 *                                     DEFINES AND MACROS
==================================================================================================*/
