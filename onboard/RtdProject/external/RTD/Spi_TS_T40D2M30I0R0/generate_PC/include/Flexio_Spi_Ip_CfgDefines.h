...
[!LOOP "SpiGeneral/SpiPhyUnit/*"!]
  [!IF "contains(node:value(SpiPhyUnitMapping),'FLEXIO_SPI')"!]
    ...
    [!CODE!][!WS "0"!]#else[!CR!][!ENDCODE!][!//
    [!CODE!][!WS "4"!]#error "[!"node:ref(SpiFlexioRxAndCsChannelsConfig)/FlexioMclAddPinId"!] cannot be used by SPI driver to configure for CS channel. PIN locked by another driver!"[!CR!][!ENDCODE!][!//
    [!CODE!][!WS "0"!]#endif[!CR!][!CR!][!ENDCODE!][!//
 [!ENDIF!]
[!ENDLOOP!]
[!ENDNOCODE!][!//
