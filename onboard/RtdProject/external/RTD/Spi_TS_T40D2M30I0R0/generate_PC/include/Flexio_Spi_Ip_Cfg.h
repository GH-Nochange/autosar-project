...
* @api
*/
#define FLEXIO_SPI_IP_ENABLE_USER_MODE_SUPPORT   [!IF "(ecu:get('Spi.SpiRegProtectAvailable') = 'TRUE') and (node:value(SpiAutosarExt/SpiEnableUserModeSupport) = 'true')"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]

#ifndef MCAL_ENABLE_USER_MODE_SUPPORT
 #ifdef FLEXIO_SPI_IP_ENABLE_USER_MODE_SUPPORT
  #if (FLEXIO_SPI_IP_ENABLE_USER_MODE_SUPPORT == STD_ON)
  ...
  #endif /* (FLEXIO_SPI_IP_ENABLE_USER_MODE_SUPPORT == STD_ON) */
...
*/
#define FLEXIO_SPI_IP_REG_PROT_AVAILABLE   [!IF "ecu:get('Spi.SpiRegProtectAvailable') = 'TRUE'"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]

#if (FLEXIO_SPI_IP_REG_PROT_AVAILABLE == STD_ON)
/**
* @brief The protection size
*/
    #define FLEXIO_SPI_IP_PROT_MEM_U32                           ((uint32)[!"ecu:get('Spi.SpiRegProtectMem')"!]U)
#endif
