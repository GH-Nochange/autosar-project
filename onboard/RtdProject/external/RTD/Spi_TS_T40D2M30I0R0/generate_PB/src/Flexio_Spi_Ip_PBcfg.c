...
/* Check if Flexio_Spi_Ip_[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBcfg header file and Spi configuration header file are of the same software version */
    ...
    #if (FLEXIO_SPI_IP_ENABLE == STD_ON)
    #if (FLEXIO_SPI_IP_DMA_USED == STD_ON)
        #if ((FLEXIO_SPI_IP[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_AR_RELEASE_MAJOR_VERSION_PBCFG_C != DMA_IP_CFG_AR_RELEASE_MAJOR_VERSION) || \
             (FLEXIO_SPI_IP[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_AR_RELEASE_MINOR_VERSION_PBCFG_C != DMA_IP_CFG_AR_RELEASE_MINOR_VERSION) \
            )
            #error "AutoSar Version Numbers of Flexio_Spi_Ip[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBcfg.h and Dma_Ip_Cfg.h are different"
        #endif
...
const Flexio_Spi_Ip_ExternalDeviceType Flexio_Spi_Ip_DeviceAttributes_[!"@name"!]_Instance_[!"$extInstanceIndex"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!] =
{
[!ENDCODE!]
...
[!ENDCODE!][!//
    [!ENDIF!][!//
[!CODE!][!//
        (uint32)[!"num:i($DivBest)"!]U, /* Normal Mode */
[!ENDCODE!][!//
    [!IF "$DualClockSupport = 'true'"!][!//
        [!IF "$DualClockEnabled = 'true'"!][!//
[!CODE!][!//
        (uint32)[!"num:i($DivBestAlternate)"!]U /* Alternate Mode*/
[!ENDCODE!][!//
        [!ELSE!][!//
[!CODE!][!//
        (uint32)[!"num:i($DivBest)"!]U  /* Normal Mode */
...
[!IF "num:i($CPHA) = 1"!],FLEXIO_SPI_IP_TIMCFG_DEFAULT_SLAVE_CPHA1_VALUE_U32[!ELSE!],FLEXIO_SPI_IP_TIMCFG_DEFAULT_SLAVE_CPHA0_VALUE_U32[!ENDIF!]
...
const Flexio_Spi_Ip_ConfigType Flexio_Spi_Ip_PhyUnitConfig_[!"@name"!]_Instance_[!"$InstanceIndex"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!] =
{
    [!"substring-after(node:value(node:ref(SpiFlexioTxAndClkChannelsConfig)/../../FlexioMclInstances),'FLEXIO_')"!]U, /* Flexio Instance */
