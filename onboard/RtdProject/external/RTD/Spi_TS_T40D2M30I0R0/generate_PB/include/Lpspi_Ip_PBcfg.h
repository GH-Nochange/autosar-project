...
[!CODE!]#define LPSPI_IP_CONFIG_[!"$postBuildVariant"!]_PB[!ENDCODE!]
[!ELSE!][!//
[!CODE!]#define LPSPI_IP_CONFIG_PB[!ENDCODE!]
[!ENDIF!][!//
    ...
    [!IF "contains($extInstance,'LPSPI')"!]
        ...
        [!CODE!] \[!CR!][!WS8!]extern const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_[!"@name"!]_Instance_[!"$extInstanceIndex"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!];[!ENDCODE!]
    [!ENDIF!]
    [!ENDLOOP!]
    ...
    [!IF "contains(node:value(SpiPhyUnitMapping),'LPSPI')"!]
        ...
        [!CODE!] \[!CR!][!WS8!]extern const Lpspi_Ip_ConfigType Lpspi_Ip_PhyUnitConfig_[!"@name"!]_Instance_[!"$InstanceIndex"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!];[!ENDCODE!]
    [!ENDIF!]
    [!ENDLOOP!]
[!ENDIF!][!//   
[!ENDNOCODE!]
