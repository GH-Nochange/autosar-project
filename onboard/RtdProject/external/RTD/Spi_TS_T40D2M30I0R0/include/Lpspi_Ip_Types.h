...
#ifndef LPSPI_IP_TYPES_H
#define LPSPI_IP_TYPES_H
...
typedef struct
{
   ...
   boolean ByteSwapNext;   /**< Store byteswap for current transfer */
...
typedef struct
{
    ...
    boolean KeepCs;
    /* Not really needed. To be removed later */
    boolean FirstCmd;
...
#endif
    Lpspi_Ip_DeviceParamsType * NextTransferConfig;
    const uint8* TxBufferNext;  /**< Store pointer for Next Tx buffer */
    uint16 LengthNext;  /**< Store pointer for Next Tx buffer */
