...
[!LOOP "variant:all()"!]
[!CODE!]#include "Dpga_Ip_[!"."!]_PBcfg.h"[!CR!][!ENDCODE!]
[!ENDLOOP!]
[!ELSE!]
[!CODE!]#include "Dpga_Ip_PBcfg.h"[!CR!][!ENDCODE!]
[!ENDIF!]
[!ENDNOCODE!][!//
...
#define DPGA_IP_AR_RELEASE_MINOR_VERSION_CFG        7
#define DPGA_IP_AR_RELEASE_REVISION_VERSION_CFG     0
#define DPGA_IP_SW_MAJOR_VERSION_CFG                3
...
[!IF "var:defined('postBuildVariant')"!][!//
[!LOOP "variant:all()"!][!//
/* Check if current file and Dpga_Ip_[!"."!]_PBcfg.h file are of the same vendor */
#if (DPGA_IP_VENDOR_ID_CFG != DPGA_IP_VENDOR_ID_[!"text:toupper(.)"!]_PBCFG)
    #error "Dpga_Ip_Cfg.h and Dpga_Ip_[!"."!]_PBcfg.h have different vendor IDs"
#endif

/* Check if current file and Dpga_Ip_[!"."!]_PBcfg.h file are of the same Autosar version */
#if ((DPGA_IP_AR_RELEASE_MAJOR_VERSION_CFG     != DPGA_IP_AR_RELEASE_MAJOR_VERSION_[!"text:toupper(.)"!]_PBCFG) || \
     (DPGA_IP_AR_RELEASE_MINOR_VERSION_CFG     != DPGA_IP_AR_RELEASE_MINOR_VERSION_[!"text:toupper(.)"!]_PBCFG) || \
     (DPGA_IP_AR_RELEASE_REVISION_VERSION_CFG  != DPGA_IP_AR_RELEASE_REVISION_VERSION_[!"text:toupper(.)"!]_PBCFG) \
    )
    #error "AutoSar Version Numbers of Dpga_Ip_Cfg.h and Dpga_Ip_[!"."!]_PBcfg.h are different"
#endif

/* Check if current file and Dpga_Ip_[!"."!]_PBcfg.h file are of the same software version */
#if ((DPGA_IP_SW_MAJOR_VERSION_CFG != DPGA_IP_SW_MAJOR_VERSION_[!"text:toupper(.)"!]_PBCFG) || \
     (DPGA_IP_SW_MINOR_VERSION_CFG != DPGA_IP_SW_MINOR_VERSION_[!"text:toupper(.)"!]_PBCFG) || \
     (DPGA_IP_SW_PATCH_VERSION_CFG != DPGA_IP_SW_PATCH_VERSION_[!"text:toupper(.)"!]_PBCFG) \
    )
    #error "Software Version Numbers of Dpga_Ip_Cfg.h and Dpga_Ip_[!"."!]_PBcfg.h are different"
#endif
[!ENDLOOP!][!//
[!ELSE!][!//
