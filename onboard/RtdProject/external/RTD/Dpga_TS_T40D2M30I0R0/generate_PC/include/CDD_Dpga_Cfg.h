...
/* Check if current file and Std_Types header file are of the same Autosar version */
    ...
    #error "AutoSar Version Numbers of CDD_Dpga_Cfg.h and Std_Types.h are different"
#endif
...
[!ENDCODE!]
    [!IF "var:defined('postBuildVariant')"!][!//
        [!LOOP "variant:all()"!][!//
            [!WS "8"!][!CODE!]DPGA_CONFIG_[!"text:toupper(.)"!]_PB[!ENDCODE!]
        [!ENDLOOP!][!//
    [!ELSE!][!//
        [!WS "8"!][!CODE!]DPGA_CONFIG_PB[!ENDCODE!]
    [!ENDIF!][!//
[!ENDIF!]
[!ENDNOCODE!][!//
