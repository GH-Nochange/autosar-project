...
#define DPGA_SW_MAJOR_VERSION_TYPES             3
...
typedef struct
{
    uint32 DpgaCorePartitionUse; /* Configuration for partition use */
    const Dpga_Ip_ConfigType *Dpga_pIpConfig; /* Pointer to IP layer configuration */
} Dpga_ConfigType;
