...
[!CR!][!ENDCODE!][!//
        [!ELSEIF "contains($DerivativeName, 'S32K39') or contains($DerivativeName, 'S32K36')"!][!//
[!CODE!][!WS "0"!]
#include "S32K39_FLEXIO.h"
[!CR!][!ENDCODE!][!//
        [!ELSEIF "contains($DerivativeName, 'S32K37')"!][!//
[!CODE!][!WS "0"!]
#include "S32K37_FLEXIO.h"
[!CR!][!ENDCODE!][!//
...
*
*/
#define FLEXIO_LIN_IP_FLEXIO_USED ([!"$HasFlexio"!]) /* [!IF "$HasFlexio = 'STD_ON'"!]Flexio Used[!ELSE!]No Used Flexio[!ENDIF!] */
