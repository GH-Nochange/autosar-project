...
#if (LIN_43_LPUART_FLEXIO_IPW_CFG_VENDOR_ID != LIN_43_LPUART_FLEXIO_IPW_[!"text:toupper(.)"!]_PBCFG_VENDOR_ID)
    #error "Lin_43_LPUART_FLEXIO_Ipw_Cfg.h and Lin_43_LPUART_FLEXIO_Ipw_[!"."!]_PBcfg.h have different vendor ids"
#endif
#if ((LIN_43_LPUART_FLEXIO_IPW_CFG_AR_RELEASE_MAJOR_VERSION    != LIN_43_LPUART_FLEXIO_IPW_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
     (LIN_43_LPUART_FLEXIO_IPW_CFG_AR_RELEASE_MINOR_VERSION    != LIN_43_LPUART_FLEXIO_IPW_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_MINOR_VERSION) || \
     (LIN_43_LPUART_FLEXIO_IPW_CFG_AR_RELEASE_REVISION_VERSION != LIN_43_LPUART_FLEXIO_IPW_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_REVISION_VERSION) \
    )
     #error "AUTOSAR Version Numbers of Lin_43_LPUART_FLEXIO_Ipw_Cfg.h and Lin_43_LPUART_FLEXIO_Ipw_[!"."!]_PBcfg.h are different"
#endif
#if ((LIN_43_LPUART_FLEXIO_IPW_CFG_SW_MAJOR_VERSION != LIN_43_LPUART_FLEXIO_IPW_[!"text:toupper(.)"!]_PBCFG_SW_MAJOR_VERSION) || \
     (LIN_43_LPUART_FLEXIO_IPW_CFG_SW_MINOR_VERSION != LIN_43_LPUART_FLEXIO_IPW_[!"text:toupper(.)"!]_PBCFG_SW_MINOR_VERSION) || \
     (LIN_43_LPUART_FLEXIO_IPW_CFG_SW_PATCH_VERSION != LIN_43_LPUART_FLEXIO_IPW_[!"text:toupper(.)"!]_PBCFG_SW_PATCH_VERSION) \
    )
...
[!IF "var:defined('postBuildVariant')"!]
[!LOOP "variant:all()"!][!//
    [!CODE!][!WS "4"!]LIN_43_LPUART_FLEXIO_IPW_CONFIG_[!"text:toupper(.)"!]_PB \[!CR!][!ENDCODE!]
[!ENDLOOP!][!//
[!ELSE!][!//
