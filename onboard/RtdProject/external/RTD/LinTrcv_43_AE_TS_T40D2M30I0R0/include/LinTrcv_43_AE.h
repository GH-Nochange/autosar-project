...
#define LINTRCV_43_AE_SW_MAJOR_VERSION               3
...
/**
* @brief            API service called with the requested resource is not configured to be available on the current partition.
* @details          The LINTRCV will check upon each API call if the requested resource is configured to be available on the current partition,
