...
#if (GPT_VENDOR_ID_[!"text:toupper(.)"!]_PBCFG_H != GPT_VENDOR_ID_CFG)
...
#if ((GPT_AR_RELEASE_MAJOR_VERSION_[!"text:toupper(.)"!]_PBCFG_H != GPT_AR_RELEASE_MAJOR_VERSION_CFG) || \
     (GPT_AR_RELEASE_MINOR_VERSION_[!"text:toupper(.)"!]_PBCFG_H != GPT_AR_RELEASE_MINOR_VERSION_CFG) || \
     (GPT_AR_RELEASE_REVISION_VERSION_[!"text:toupper(.)"!]_PBCFG_H != GPT_AR_RELEASE_REVISION_VERSION_CFG) \
    )
...
#if ((GPT_SW_MAJOR_VERSION_[!"text:toupper(.)"!]_PBCFG_H != GPT_SW_MAJOR_VERSION_CFG) || \
     (GPT_SW_MINOR_VERSION_[!"text:toupper(.)"!]_PBCFG_H != GPT_SW_MINOR_VERSION_CFG) || \
     (GPT_SW_PATCH_VERSION_[!"text:toupper(.)"!]_PBCFG_H != GPT_SW_PATCH_VERSION_CFG) \
    )
...
[!VAR "hasDualClock" = "'true'"!][!//
[!IF "contains($DerivativeName,'S32Z2') or contains($DerivativeName,'S32E2')"!][!//
    [!LOOP "GptChannelConfigSet/GptChannelConfiguration/*"!][!//
        [!IF "(node:value(GptHwIp) = 'STM') or (node:value(GptHwIp) = 'EMIOS') or (node:value(GptHwIp) = 'ETIMER')"!][!//
[!VAR "hasDualClock" = "'true'"!][!//
        [!ELSE!][!//
[!VAR "hasDualClock" = "'false'"!][!//
        [!ENDIF!][!//
    [!ENDLOOP!]
[!ELSE!][!//
[!VAR "hasDualClock" = "'true'"!][!//
[!ENDIF!][!//
[!IF "$hasDualClock = 'true'"!][!//
...
*/
[!VAR "hasChainMode" = "'false'"!][!//
[!LOOP "GptChannelConfigSet/GptChannelConfiguration/*"!][!//
[!IF "(node:value(GptHwIp) = 'PIT') or (node:value(GptHwIp) = 'LPIT')"!][!//
[!VAR "hasChainMode" = "'true'"!][!//
[!ENDIF!][!//
[!ENDLOOP!][!//
[!IF "$hasChainMode = 'true'"!][!//
...
[!LOOP "GptHwConfiguration/*"!][!//
    [!IF "(node:value(GptChannelIsUsed) = 'true') and (contains(GptIsrHwId,'STM') or contains(GptIsrHwId,'FTM') or (contains(GptIsrHwId,'ETIMER')))"!][!//
        [!VAR "hasPredef" = "'true'"!][!//
    [!ENDIF!][!//
[!ENDLOOP!][!//
[!ENDNOCODE!][!//
...
*/
#define GPT_MULTIPARTITION_ENABLED [!IF "node:value(GptDriverConfiguration/GptMultiPartitionSupport) = 'true'"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
/*================================================================================================*/
/**
