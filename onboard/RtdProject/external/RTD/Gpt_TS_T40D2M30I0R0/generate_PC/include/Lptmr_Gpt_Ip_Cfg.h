...
[!IF "var:defined('postBuildVariant')"!]
    [!LOOP "variant:all()"!]
#include "Lptmr_Gpt_Ip_[!"."!]_PBcfg.h"
    [!ENDLOOP!]
[!ELSE!]
...
[!IF "var:defined('postBuildVariant')"!]
    [!LOOP "variant:all()"!]
#if (LPTMR_GPT_IP_VENDOR_ID_CFG != LPTMR_GPT_IP_VENDOR_ID_[!"text:toupper(.)"!]_PBCFG_H)
    #error "Lptmr_Gpt_Ip_Cfg.h and Lptmr_Gpt_Ip_[!"."!]_PBcfg.h have different vendor ids"
#endif
/* Check if this header file and header file are of the same Autosar version */
#if ((LPTMR_GPT_IP_AR_RELEASE_MAJOR_VERSION_CFG != LPTMR_GPT_IP_AR_RELEASE_MAJOR_VERSION_[!"text:toupper(.)"!]_PBCFG_H) || \
     (LPTMR_GPT_IP_AR_RELEASE_MINOR_VERSION_CFG != LPTMR_GPT_IP_AR_RELEASE_MINOR_VERSION_[!"text:toupper(.)"!]_PBCFG_H) || \
     (LPTMR_GPT_IP_AR_RELEASE_REVISION_VERSION_CFG != LPTMR_GPT_IP_AR_RELEASE_REVISION_VERSION_[!"text:toupper(.)"!]_PBCFG_H) \
    )
    #error "AutoSar Version Numbers of Lptmr_Gpt_Ip_Cfg.h and Lptmr_Gpt_Ip_[!"."!]_PBcfg.h are different"
#endif
/* Check if this header file and header file are of the same Software version */
#if ((LPTMR_GPT_IP_SW_MAJOR_VERSION_CFG != LPTMR_GPT_IP_SW_MAJOR_VERSION_[!"text:toupper(.)"!]_PBCFG_H) || \
     (LPTMR_GPT_IP_SW_MINOR_VERSION_CFG != LPTMR_GPT_IP_SW_MINOR_VERSION_[!"text:toupper(.)"!]_PBCFG_H) || \
     (LPTMR_GPT_IP_SW_PATCH_VERSION_CFG != LPTMR_GPT_IP_SW_PATCH_VERSION_[!"text:toupper(.)"!]_PBCFG_H) \
    )
    #error "Software Version Numbers of Lptmr_Gpt_Ip_Cfg.h and Lptmr_Gpt_Ip_[!"."!]_PBcfg.h are different"
#endif
    [!ENDLOOP!]
[!ELSE!]
...
*/
#define LPTMR_GPT_IP_DEV_ERROR_DETECT ([!IF "GptDriverConfiguration/GptDevErrorDetect"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
*/
#define LPTMR_GPT_IP_ENABLE_USER_MODE_SUPPORT    ([!IF "GptAutosarExt/GptEnableUserModeSupport"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
*/
#define LPTMR_GPT_IP_STANDBY_WAKEUP_SUPPORT    ([!IF "GptAutosarExt/GptStandbyWakeupSupport"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
