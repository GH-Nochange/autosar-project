...
[!IF "var:defined('postBuildVariant')"!]
    [!LOOP "variant:all()"!]
#if (LPIT_GPT_IP_VENDOR_ID_CFG != LPIT_GPT_IP_VENDOR_ID[!"text:toupper($VS_number)"!]PBCFG_H)
    #error "LPit_Gpt_Ip_Cfg.h and LPit_Gpt_Ip_[!"."!]_PBcfg.h have different vendor ids"
#endif
/* Check if this header file and header file are of the same Autosar version */
#if ((LPIT_GPT_IP_AR_RELEASE_MAJOR_VERSION_CFG != LPIT_GPT_IP_AR_RELEASE_MAJOR_VERSION_[!"text:toupper(.)"!]_PBCFG_H) || \
     (LPIT_GPT_IP_AR_RELEASE_MINOR_VERSION_CFG != LPIT_GPT_IP_AR_RELEASE_MINOR_VERSION_[!"text:toupper(.)"!]_PBCFG_H) || \
     (LPIT_GPT_IP_AR_RELEASE_REVISION_VERSION_CFG != LPIT_GPT_IP_AR_RELEASE_REVISION_VERSION_[!"text:toupper(.)"!]_PBCFG_H) \
    )
    #error "AutoSar Version Numbers of LPit_Gpt_Ip_Cfg.h and LPit_Gpt_Ip_[!"."!]_PBcfg.h are different"
#endif
/* Check if this header file and header file are of the same Software version */
#if ((LPIT_GPT_IP_SW_MAJOR_VERSION_CFG != LPIT_GPT_IP_SW_MAJOR_VERSION_[!"text:toupper(.)"!]_PBCFG_H) || \
     (LPIT_GPT_IP_SW_MINOR_VERSION_CFG != LPIT_GPT_IP_SW_MINOR_VERSION_[!"text:toupper(.)"!]_PBCFG_H) || \
     (LPIT_GPT_IP_SW_PATCH_VERSION_CFG != LPIT_GPT_IP_SW_PATCH_VERSION_[!"text:toupper(.)"!]_PBCFG_H) \
    )
    #error "Software Version Numbers of LPit_Gpt_Ip_Cfg.h and LPit_Gpt_Ip_[!"."!]_PBcfg.h are different"
#endif
    [!ENDLOOP!]
[!ELSE!]
#if (LPIT_GPT_IP_VENDOR_ID_CFG != LPIT_GPT_IP_VENDOR_ID[!"text:toupper($VS_number)"!]PBCFG_H)
...
*/
#define LPIT_GPT_IP_DEV_ERROR_DETECT ([!IF "GptDriverConfiguration/GptDevErrorDetect"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
*/
#define LPIT_GPT_IP_CHAIN_MODE ([!IF "GptAutosarExt/ChainModeApi"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
*/
#define LPIT_GPT_IP_ENABLE_USER_MODE_SUPPORT    ([!IF "GptAutosarExt/GptEnableUserModeSupport"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
[!MACRO "CalculateModulesNumber","Module"!]
    [!IF "$Module = 'LPIT_0'"!][!//
        [!VAR "ChannelsNumberLpit0" = "count(text:grep(ecu:list('Gpt.GptChannelConfigSet.GptChannelConfiguration.GptHwChannel'),concat($Module,'_CH','.*')))"!][!//
    [!ENDIF!]
[!ENDMACRO!]

[!CALL "CalculateModulesNumber","Module"="string('LPIT_0')"!][!//
[!IF "num:i($ChannelsNumberLpit0) > 0"!][!//
[!CODE!][!//
/** Channels number instance LPIT_0 */
#define LPIT_0_IP_CHANNELS_NUMBER  ([!"num:i($ChannelsNumberLpit0)"!]U)
...
*/
#define LPIT_GPT_IP_CHANGE_NEXT_TIMEOUT_VALUE     ([!IF "GptAutosarExt/GptChangeNextTimeoutValueApi"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
