...
[!VAR "DerivativeName" = "text:toupper(substring-before(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative,'_'))"!]
    ...
    [!ELSEIF "contains(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative, 's32m24')"!][!//
        [!CODE!][!WS "0"!]#include "S32M24x_RTC.h"[!CR!][!ENDCODE!][!//
    [!ENDIF!][!//
[!ENDIF!][!//
[!ENDNOCODE!][!//
...
[!IF "node:value(GptChannelIsUsed) = 'true' and contains(GptIsrHwId, 'SRTC')"!][!//
[!VAR "MacRtcUsed"="1"!][!//
[!ENDIF!][!//
[!ENDLOOP!][!//
[!ENDNOCODE!][!//
...
*/
#define SRTC_IP_USED ([!IF "$MacRtcUsed=1"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
