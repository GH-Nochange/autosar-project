...
/**
 *   @file          LPit_Gpt_Ip[!"$VS_number"!]PBcfg.c
 *
 ...
 *================================================================================================*/
#define LPIT_GPT_IP_VENDOR_ID[!"text:toupper($VS_number)"!]PBCFG_C                    43
#define LPIT_GPT_IP_AR_RELEASE_MAJOR_VERSION[!"text:toupper($VS_number)"!]PBCFG_C     4
#define LPIT_GPT_IP_AR_RELEASE_MINOR_VERSION[!"text:toupper($VS_number)"!]PBCFG_C     7
#define LPIT_GPT_IP_AR_RELEASE_REVISION_VERSION[!"text:toupper($VS_number)"!]PBCFG_C  0
#define LPIT_GPT_IP_SW_MAJOR_VERSION[!"text:toupper($VS_number)"!]PBCFG_C             3
#define LPIT_GPT_IP_SW_MINOR_VERSION[!"text:toupper($VS_number)"!]PBCFG_C             0
#define LPIT_GPT_IP_SW_PATCH_VERSION[!"text:toupper($VS_number)"!]PBCFG_C             0
/*==================================================================================================
 *                                      FILE VERSION CHECKS
 *================================================================================================*/
#if (LPIT_GPT_IP_VENDOR_ID[!"text:toupper($VS_number)"!]PBCFG_C != LPIT_GPT_IP_VENDOR_ID[!"text:toupper($VS_number)"!]PBCFG_H)
    #error "LPit_Gpt_Ip[!"$VS_number"!]PBcfg.c and LPit_Gpt_Ip[!"$VS_number"!]PBcfg.h have different vendor ids"
#endif
/* Check if this header file and header file are of the same Autosar version */
#if ((LPIT_GPT_IP_AR_RELEASE_MAJOR_VERSION[!"text:toupper($VS_number)"!]PBCFG_C != LPIT_GPT_IP_AR_RELEASE_MAJOR_VERSION[!"text:toupper($VS_number)"!]PBCFG_H) || \
     (LPIT_GPT_IP_AR_RELEASE_MINOR_VERSION[!"text:toupper($VS_number)"!]PBCFG_C != LPIT_GPT_IP_AR_RELEASE_MINOR_VERSION[!"text:toupper($VS_number)"!]PBCFG_H) || \
     (LPIT_GPT_IP_AR_RELEASE_REVISION_VERSION[!"text:toupper($VS_number)"!]PBCFG_C != LPIT_GPT_IP_AR_RELEASE_REVISION_VERSION[!"text:toupper($VS_number)"!]PBCFG_H) \
    )
    #error "AutoSar Version Numbers of LPit_Gpt_Ip[!"$VS_number"!]PBcfg.c and LPit_Gpt_Ip[!"$VS_number"!]PBcfg.h are different"
#endif
/* Check if this header file and header file are of the same Software version */
#if ((LPIT_GPT_IP_SW_MAJOR_VERSION[!"text:toupper($VS_number)"!]PBCFG_C != LPIT_GPT_IP_SW_MAJOR_VERSION[!"text:toupper($VS_number)"!]PBCFG_H) || \
     (LPIT_GPT_IP_SW_MINOR_VERSION[!"text:toupper($VS_number)"!]PBCFG_C != LPIT_GPT_IP_SW_MINOR_VERSION[!"text:toupper($VS_number)"!]PBCFG_H) || \
     (LPIT_GPT_IP_SW_PATCH_VERSION[!"text:toupper($VS_number)"!]PBCFG_C != LPIT_GPT_IP_SW_PATCH_VERSION[!"text:toupper($VS_number)"!]PBCFG_H) \
    )
    #error "Software Version Numbers of LPit_Gpt_Ip[!"$VS_number"!]PBcfg.c and LPit_Gpt_Ip[!"$VS_number"!]PBcfg.h are different"
#endif

#if (LPIT_GPT_IP_VENDOR_ID[!"text:toupper($VS_number)"!]PBCFG_C != GPT_IRQ_VENDOR_ID)
    #error "LPit_Gpt_Ip[!"$VS_number"!]PBcfg.c and Gpt_Irq.h have different vendor ids"
#endif
/* Check if this header file and header file are of the same Autosar version */
#if ((LPIT_GPT_IP_AR_RELEASE_MAJOR_VERSION[!"text:toupper($VS_number)"!]PBCFG_C != GPT_IRQ_AR_RELEASE_MAJOR_VERSION) || \
     (LPIT_GPT_IP_AR_RELEASE_MINOR_VERSION[!"text:toupper($VS_number)"!]PBCFG_C != GPT_IRQ_AR_RELEASE_MINOR_VERSION) || \
     (LPIT_GPT_IP_AR_RELEASE_REVISION_VERSION[!"text:toupper($VS_number)"!]PBCFG_C != GPT_IRQ_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of LPit_Gpt_Ip[!"$VS_number"!]PBcfg.c and Gpt_Irq.h are different"
#endif
/* Check if this header file and header file are of the same Software version */
#if ((LPIT_GPT_IP_SW_MAJOR_VERSION[!"text:toupper($VS_number)"!]PBCFG_C != GPT_IRQ_SW_MAJOR_VERSION) || \
     (LPIT_GPT_IP_SW_MINOR_VERSION[!"text:toupper($VS_number)"!]PBCFG_C != GPT_IRQ_SW_MINOR_VERSION) || \
     (LPIT_GPT_IP_SW_PATCH_VERSION[!"text:toupper($VS_number)"!]PBCFG_C != GPT_IRQ_SW_PATCH_VERSION) \
    )
