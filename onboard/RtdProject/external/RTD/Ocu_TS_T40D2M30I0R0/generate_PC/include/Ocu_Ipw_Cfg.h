...
[!IF "var:defined('postBuildVariant')"!][!//
[!LOOP "variant:all()"!]
#if (OCU_IPW_CFG_VENDOR_ID != OCU_IPW_[!"text:toupper(.)"!]_PBCFG_VENDOR_ID)
...
#if ((OCU_IPW_CFG_AR_RELEASE_MAJOR_VERSION != OCU_IPW_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
     (OCU_IPW_CFG_AR_RELEASE_MINOR_VERSION != OCU_IPW_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_MINOR_VERSION) || \
     (OCU_IPW_CFG_AR_RELEASE_REVISION_VERSION != OCU_IPW_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_REVISION_VERSION))
...
#if ((OCU_IPW_CFG_SW_MAJOR_VERSION != OCU_IPW_[!"text:toupper(.)"!]_PBCFG_SW_MAJOR_VERSION) || \
     (OCU_IPW_CFG_SW_MINOR_VERSION != OCU_IPW_[!"text:toupper(.)"!]_PBCFG_SW_MINOR_VERSION) || \
     (OCU_IPW_CFG_SW_PATCH_VERSION != OCU_IPW_[!"text:toupper(.)"!]_PBCFG_SW_PATCH_VERSION))
