...
#define FTM_OCU_IP_AR_RELEASE_MINOR_VERSION        7
#define FTM_OCU_IP_AR_RELEASE_REVISION_VERSION     0
#define FTM_OCU_IP_SW_MAJOR_VERSION                3
 ...
 * @param[in]   InstNum - FTM instance number
 * @param[in]   ChNum - Channel number in the FTM instance
 *              PinAction - Type of action: FTM_OCU_IP_SET_LOW, FTM_OCU_IP_SET_HIGH, FTM_OCU_IP_SET_TOGGLE
 *
 ...
 * @param[in]   InstNum - FTM instance number
 * @param[in]   ChNum - Channel number in the FTM instance
 *              PinState - Expectation state of pin: FTM_OCU_IP_HIGH, FTM_OCU_IP_LOW
 *
 ...
 * @param[in]   InstNum - FTM instance number
 *
 * @implements   Ftm_Ocu_Ip_SetClockMode_Activity
 */
 ...
 * @implements  Ftm_Ocu_Ip_GetMaxCounterValue_Activity
 */
