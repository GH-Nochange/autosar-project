...
static const Dma_Ip_LogicInstanceConfigType LogicInstance[!"@index"!]Config[!"$Type"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!] =
{
    {
...
static const Dma_Ip_LogicInstanceConfigType * const Dma_Ip_paxLogicInstanceConfigArray[!"$Type"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!][DMA_IP_NOF_CFG_LOGIC_INSTANCES] =
{
[!LOOP "./MclConfig/dmaLogicInstance_ConfigType/*"!][!//
...
static const Dma_Ip_GlobalConfigType LogicChannel[!"@index"!]GlobalConfig[!"$Type"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!] =
{
    {
...
/* DMA Logic Channel [!"@index"!] */
static const Dma_Ip_TransferConfigType LogicChannel[!"@index"!]TransferConfig[!"$Type"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!] =
{
    {
...
static __attribute__(( aligned(32) )) Dma_Ip_SwTcdRegType LogicChannel[!"$Mac_LogicChannel"!]Stcd[!"@index"!][!"$Type"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!];
[!ENDLOOP!][!//
[!ENDIF!][!//
[!ENDLOOP!][!//
[!ENDCODE!][!//
...
/* DMA Logic Channel [!"$Mac_LogicChannel"!] */
[!LOOP "./dmaLogicChannel_ConfigType/dmaLogicChannel_ScatterGatherConfigType/dmaLogicChannelConfig_ScatterGatherArrayType/*"!][!//
static Dma_Ip_ScatterGatherConfigType LogicChannel[!"$Mac_LogicChannel"!]SgaElem[!"@index"!]Config[!"$Type"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!];
[!ENDLOOP!][!//
[!ENDIF!][!//
[!ENDLOOP!][!//
[!ENDCODE!][!//
...
/* DMA Logic Channel [!"$Mac_LogicChannel"!] */
static Dma_Ip_TransferConfigType LogicChannel[!"$Mac_LogicChannel"!]TransferElem[!"@index"!][!"$Type"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!] =
{
    {
        /* uint32 ScatterGatherAddr; */     0U,
        /* uint32 DestinationStoreAddr; */  0U,
...
[!ENDLOOP!][!//
static Dma_Ip_ScatterGatherConfigType * LogicChannel[!"$Mac_LogicChannel"!]SgaArray[!"$Type"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!][[!"$Mac_LogicChannelName"!]_NOF_CFG_SGA_ELEMENTS] =
{
[!LOOP "./dmaLogicChannel_ConfigType/dmaLogicChannel_ScatterGatherConfigType/dmaLogicChannelConfig_ScatterGatherArrayType/*"!][!//
...
static const Dma_Ip_LogicChannelConfigType LogicChannel[!"@index"!]Config[!"$Type"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!] =
{
    {
...
static const Dma_Ip_LogicChannelConfigType * const Dma_Ip_paxLogicChannelConfigArray[!"$Type"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!][DMA_IP_NOF_CFG_LOGIC_CHANNELS] =
{
[!LOOP "./MclConfig/dmaLogicChannel_Type/*"!][!//
...
static Dma_Ip_HwChannelStateType HwChannel[!"@index"!]State[!"$Type"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!];
[!ENDLOOP!][!//
[!ENDCODE!][!//
[!ENDNOCODE!][!//
[!ENDMACRO!][!//
...
static Dma_Ip_HwChannelStateType * Dma_Ip_paxHwChannelStateArray[!"$Type"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!][DMA_IP_NOF_CFG_LOGIC_CHANNELS] =
{
[!LOOP "./MclConfig/dmaLogicChannel_Type/*"!][!//
...
[!MACRO "Dma_Ip_Multipartition_Config"!][!//
...
static const Dma_Ip_MultiPartitionConfigType Dma_Ip_MultiPartitionConfig[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!] =
{
[!NOCODE!][!//
[!VAR "Mac_PartitionUsed" ="num:i(255)"!][!//
...
[!IF "$Mac_LogicChannelIdx  =  $curModChannel"!]
    [!IF "node:exists(dmaLogicChannel_EcucPartitionRef)"!][!//
                ...
                [!IF "$Mac_PartitionRef = node:value(./OsAppEcucPartitionRef)"!][!//
                    [!IF "node:refvalid(./OsApplicationCoreRef)"!]
                        [!SELECT "node:ref(./OsAppEcucPartitionRef)"!][!//
                            [!VAR "Mac_PartitionUsed" ="node:pos(.)"!][!//
                        [!ENDSELECT!][!//
                        [!VAR "Mac_ReturnValue1" = "num:i($Mac_ReturnValue1 + 1)"!][!//
                    [!ELSE!]
                        [!VAR "Mac_ReturnValue2" = "num:i($Mac_ReturnValue2 + 1)"!][!//
                        [!ERROR!]
                            [!CR!] Error when generate partition reference for Logic Channel
                            [!CR!]1.Why you got this error? [!CR!]-> When enable multi partitions feature, OsAppEcucPartitionRef and OsApplicationCoreRef of the OsApplication must be added and configured synchronization with configuration of EcuC component.[!CR!]For now:OsAppEcucPartitionRef ([!"text:split($Mac_PartitionRef, '/')[last()]"!]) was added correctly. But OsApplicationCoreRef was not configured.
        ...
        [!IF "($Mac_ReturnValue1 = 0) and ($Mac_ReturnValue2 = 0)"!]
            [!ERROR!]
            [!CR!]1.Why you got this error? [!CR!]-> When enable multi partitions support, OsAppEcucPartitionRef and OsApplicationCoreRef of the OsApplication must be added and configured synchronization with configuration of EcuC component.[!CR!]For now: Both of OsAppEcucPartitionRef ([!"text:split($Mac_PartitionRef, '/')[last()]"!]) and OsApplicationCoreRef were not configured.
            [!CR!]2. How to resolve this error?
            - Step 1: Go to Os component
            - Step 2: Select OsApplication
    ...
    [!ELSE!]
            [!ERROR!]
            [!CR!] Error when generate partition reference for Logic Channel
            [!CR!]1. Why you got this error? [!CR!]-> When enable multi partitions feature, users need to configure 'Ecuc Partition Ref' for corresponding Logic Channel. [!CR!]For now: 'Ecuc Partition Ref' Node of [!"node:value(./dmaLogicChannel_LogicName)"!] was not configured.
            [!CR!]2. How to resolve this error?
...
[!ENDLOOP!]
[!ENDFOR!]
[!CODE!]/** @brief DMA Channel [!"$curModChannel"!] status partition */[!CR!][!ENDCODE!]
[!IF "$Mac_PartitionUsed != 255"!][!//
    [!IF "$curModChannel = $Mac_TotalNumberOfChannel - 1"!]
[!CODE!]        [!"num:i($Mac_PartitionUsed + 1)"!][!ENDCODE!]
    [!ELSE!]
[!CODE!]        [!"num:i($Mac_PartitionUsed + 1)"!],[!CR!][!ENDCODE!]
    [!ENDIF!]
[!ELSE!]
    [!IF "$curModChannel = $Mac_TotalNumberOfChannel - 1"!]
[!CODE!]        0[!ENDCODE!]
...
[!IF "$LogicInstanceIdx  =  $curModInstance"!]
            ...
            [!IF "node:refvalid(./OsAppEcucPartitionRef)"!][!//
                [!IF "$Mac_PartitionRef = node:value(./OsAppEcucPartitionRef)"!][!//
                    ...
                    [!ELSE!]
                        [!VAR "Mac_ReturnValue2" = "num:i($Mac_ReturnValue2 + 1)"!][!//
                        [!ERROR!]
                            [!CR!] Error when generate partition reference for Logic Instance
                            [!CR!]1.Why you got this error? [!CR!]-> When enable multi partitions feature, OsAppEcucPartitionRef and OsApplicationCoreRef of the OsApplication must be added and configured synchronization with configuration of EcuC component.[!CR!]For now:OsAppEcucPartitionRef ([!"text:split($Mac_PartitionRef, '/')[last()]"!]) was added correctly. But OsApplicationCoreRef was not configured.
                            [!CR!]2. How to resolve this error?
                            - Step 1: Go to Os component
                            - Step 2: Select OsApplication
    ...
    [!ELSE!]
            [!ERROR!]
            [!CR!] Error when generate partition reference for Logic Instance
            [!CR!]1. Why you got this error? [!CR!]-> When enable multi partitions feature, users need to configure 'Ecuc Partition Ref' for corresponding Logic Instance. [!CR!]For now: 'Ecuc Partition Ref' Node of [!"node:value(./dmaLogicInstance_IdName)"!] was not configured.
            [!CR!]2. How to resolve this error?
...
[!ENDLOOP!]
[!ENDFOR!]
[!CODE!]/** @brief DMA Instance [!"$curModInstance"!] status partition */[!CR!][!ENDCODE!]
[!IF "$Mac_PartitionUsed != 255"!][!//
...
*
*/
#define DMA_IP_NOF_VIRTUAL_MEMORY_SECTION[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]  [!"$Mac_NrOfMemSection"!]U

static const Dma_Ip_VirtualSectionConfigType Dma_Ip_VirtualMemorySectionConfig[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!][DMA_IP_NOF_VIRTUAL_MEMORY_SECTION[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]] =
{
[!ENDCODE!][!//
[!LOOP "./MclConfig/MclVirtualMemorySection/*"!][!//
[!CODE!][!//
...
[!ENDCODE!][!//
[!CODE!][!//
static const Dma_Ip_VirtualMemoryConfigType Dma_Ip_VirtualMemoryConfig[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!] =
{
...
[!ENDCODE!][!//
    [!ENDIF!][!//
[!CODE!][!//
[!IF "node:value(MclGeneral/MclEnableMultipartitionSupport)='true'"!][!//
    /* const Dma_Ip_MultiPartitionConfigType * const MultiPartitionConfig   */           &Dma_Ip_MultiPartitionConfig[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!],
[!ENDIF!][!//
[!ENDCODE!][!//
[!CODE!][!//
