...
[!IF "node:value(./MclGeneral/MclCache/MclEnableCache)"!][!//
...
#define CACHE_IP_USER_MODE_SUPPORT_IS_AVAILABLE      STD_ON
[!ELSE!][!//
...
#define CACHE_IP_LMEM_COMMAND_TIMEOUT_VAL      [!"node:value(./MclGeneral/MclCache/MclCacheTimeoutValue)"!]U
#define CACHE_IP_LMEM_COMMAND_TIMEOUT_TYPE     [!"node:value(./MclGeneral/MclCache/MclCacheTimeoutMethod)"!]
