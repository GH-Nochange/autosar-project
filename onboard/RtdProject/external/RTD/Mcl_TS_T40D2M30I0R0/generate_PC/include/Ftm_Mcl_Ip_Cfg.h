...
*                                       DEFINES AND MACROS
==================================================================================================*/
[!VAR "DerivativeName" = "0"!][!//
[!IF "node:exists(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative)"!][!//
    [!VAR "DerivativeName" = "text:toupper(substring-before(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative,'_'))"!][!//
[!ENDIF!][!//
/* Enable/Disable FTM common timebase API from MCL. */
#define FTM_MCL_SELECT_COMMON_TIMEBASE_API          ([!IF "node:value(./MclGeneral/MclFtmCommon/Mcl_FtmCommonTimebase)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
[!IF "(contains($DerivativeName, 'S32K146') or contains($DerivativeName, 'S32K148'))"!][!//
    [!CODE!]#define FTM_MCL_SPLIT_COMMON_TIMEBASE_API           ([!IF "node:value(./MclGeneral/MclFtmCommon/Mcl_FtmSplitCommonTimebase)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])[!CR!][!ENDCODE!][!//
[!ELSE!][!//
    [!CODE!]#define FTM_MCL_SPLIT_COMMON_TIMEBASE_API           (STD_OFF)[!CR!][!ENDCODE!][!//
[!ENDIF!][!//
 ...
 */
#define FTM_MCL_IP_NOF_MODULES                      ((uint8)[!"num:i(ecu:get('Mcl.Ftm.NumberOfModules'))"!]U)
 ...
 */
#define FTM_MCL_ENABLE_USER_MODE_SUPPORT            ([!IF "node:value(MclGeneral/MclEnableUserModeSupport)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
