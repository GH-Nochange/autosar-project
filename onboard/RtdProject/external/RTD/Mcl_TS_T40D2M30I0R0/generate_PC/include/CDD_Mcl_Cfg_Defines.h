...
/  MULTIPARTITION                                     /
/-----------------------------------------------*/
[!IF "node:value(./MclGeneral/MclEnableMultipartitionSupport)"!][!//
#define MCL_MULTIPARTITION_IS_AVAILABLE                 STD_ON
[!ELSE!][!//
...
*/
#define MCL_MAX_PARTITIONS             ([!"num:i($maxPartition)"!]U)

/*-----------------------------------------------/
/  VERSION INFO API                              /
/-----------------------------------------------*/
[!IF "node:value(./MclGeneral/Mcl_VersionInfoApi)"!][!//
