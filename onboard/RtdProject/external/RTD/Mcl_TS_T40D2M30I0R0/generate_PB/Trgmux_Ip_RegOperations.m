...
[!NOCODE!][!//
[!VAR "Mac_IsMultipartitionEnable"="num:i(0)"!][!//
[!IF "node:value(MclGeneral/MclEnableMultipartitionSupport)='true'"!][!//
[!VAR "Mac_IsMultipartitionEnable" = "num:i(1)"!][!//
...
static const Trgmux_Ip_LogicTriggerType Trgmux_Ip_LogicTrigger[!"num:i($Mac_NrOfLogicTriggers - 1)"!]Config[!"$Type"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!] =
{
...
[!NOCODE!][!//
[!IF "$Mac_IsMultipartitionEnable = num:i(1)"!][!//
    ...
    [!ELSE!]
        [!ERROR!]
        [!CR!] Error when generate partition reference for Logic Channel
        [!CR!]1. Why you got this error? [!CR!]-> When enable multi partitions feature, users need to configure 'Ecuc Partition Ref' for corresponding Logic Channel. [!CR!]For now: 'Ecuc Partition Ref' Node of [!"node:value(./trgmuxLogicTrigger_Name)"!] was not configured.
        [!CR!]2. How to resolve this error?
    ...
    [!IF "$Mac_PartitionUsed != 255"!][!//
        [!CODE!]    /* uint8 PartitionId; */               [!"num:i($Mac_PartitionUsed)"!]U,[!CR!][!ENDCODE!]
    [!ELSE!]
        [!CODE!]    /* uint8 PartitionId; */               0xFFU,[!CR!][!ENDCODE!]
    [!ENDIF!]
[!ENDIF!]
[!ENDNOCODE!][!//
};
