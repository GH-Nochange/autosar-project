...
#define ENET_IP_AR_RELEASE_MINOR_VERSION       7
#define ENET_IP_AR_RELEASE_REVISION_VERSION    0
#define ENET_IP_SW_MAJOR_VERSION               3
#define ENET_IP_SW_MINOR_VERSION               0
#define ENET_IP_SW_PATCH_VERSION               0
 ...
 * @param[in]  DiffTimeStamp      Offset between time stamp grandmaster and time stamp by local clock.
 */                                         
 ...
 * @param[in] Instance      Instance number
 * @param[in] Channel       Timer channel
 * @param[in] Capture       The value captured.
 */                             
 ...
 *
 * @param[in] Instance       Instance number
 * @param[in] TimeStamp    timer value gotten.
 */
