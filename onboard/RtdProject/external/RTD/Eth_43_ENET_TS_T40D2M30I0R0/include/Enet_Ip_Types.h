...
#define ENET_IP_TYPES_AR_RELEASE_MINOR_VERSION       7
#define ENET_IP_TYPES_AR_RELEASE_REVISION_VERSION    0
#define ENET_IP_TYPES_SW_MAJOR_VERSION               3
#define ENET_IP_TYPES_SW_MINOR_VERSION               0
#define ENET_IP_TYPES_SW_PATCH_VERSION               0
...
typedef enum
{
    ...
    ENET_STATUS_CACHE_ERROR                = 0x005U,    /*!< Generic operation cache operation failed*/
