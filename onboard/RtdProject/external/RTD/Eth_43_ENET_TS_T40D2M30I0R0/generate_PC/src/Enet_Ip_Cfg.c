...
#define ENET_IP_CFG_AR_RELEASE_MINOR_VERSION_C      7
#define ENET_IP_CFG_AR_RELEASE_REVISION_VERSION_C   0
#define ENET_IP_CFG_SW_MAJOR_VERSION_C              3
#define ENET_IP_CFG_SW_MINOR_VERSION_C              0
#define ENET_IP_CFG_SW_PATCH_VERSION_C              0
...
*                                      GLOBAL VARIABLES
==================================================================================================*/
#if (STD_OFF == ENET_HAS_CACHE_MANAGEMENT)
