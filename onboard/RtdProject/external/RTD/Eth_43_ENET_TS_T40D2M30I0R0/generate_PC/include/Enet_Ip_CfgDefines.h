...
[!CODE!][!WS "0"!]#include "S32K148_SIM.h"[!CR!][!ENDCODE!][!//
        [!ELSE!]
[!ERROR!]
Ethernet is not support in the Derivertive.
[!ENDERROR!]
        [!ENDIF!][!// 
...
#define ENET_IP_CFGDEFINES_AR_RELEASE_MINOR_VERSION     7
#define ENET_IP_CFGDEFINES_AR_RELEASE_REVISION_VERSION  0
#define ENET_IP_CFGDEFINES_SW_MAJOR_VERSION             3
#define ENET_IP_CFGDEFINES_SW_MINOR_VERSION             0
#define ENET_IP_CFGDEFINES_SW_PATCH_VERSION             0
