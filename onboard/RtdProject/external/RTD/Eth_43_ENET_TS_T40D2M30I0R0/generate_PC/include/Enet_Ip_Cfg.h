...
#define ENET_IP_CFG_AR_RELEASE_MINOR_VERSION      7
#define ENET_IP_CFG_AR_RELEASE_REVISION_VERSION   0
#define ENET_IP_CFG_SW_MAJOR_VERSION              3
#define ENET_IP_CFG_SW_MINOR_VERSION              0
#define ENET_IP_CFG_SW_PATCH_VERSION              0
...
#if (ENET_IP_CFG_VENDOR_ID != ENET_IP_[!"text:toupper(.)"!]_PBCFG_VENDOR_ID)
    #error "Enet_Ip_Cfg.h and Enet_Ip_[!"."!]_PBcfg.h have different vendor ids"
#endif
#if ((ENET_IP_CFG_AR_RELEASE_MAJOR_VERSION    != ENET_IP_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
     (ENET_IP_CFG_AR_RELEASE_MINOR_VERSION    != ENET_IP_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_MINOR_VERSION) || \
     (ENET_IP_CFG_AR_RELEASE_REVISION_VERSION != ENET_IP_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_REVISION_VERSION))
     #error "AUTOSAR Version Numbers of Enet_Ip_Cfg.h and Enet_Ip_[!"."!]_PBcfg.h are different"
#endif
#if ((ENET_IP_CFG_SW_MAJOR_VERSION != ENET_IP_[!"text:toupper(.)"!]_PBCFG_SW_MAJOR_VERSION) || \
     (ENET_IP_CFG_SW_MINOR_VERSION != ENET_IP_[!"text:toupper(.)"!]_PBCFG_SW_MINOR_VERSION) || \
     (ENET_IP_CFG_SW_PATCH_VERSION != ENET_IP_[!"text:toupper(.)"!]_PBCFG_SW_PATCH_VERSION))
...
/* Checks against Enet_Ip_PBcfg.h */
    ...
    #error "Enet_Ip_Cfg.h and Enet_Ip_PBcfg.h have different vendor ids"
     ...
     #error "AUTOSAR Version Numbers of Enet_Ip_Cfg.h and Enet_Ip_PBcfg.h are different"
#endif
...
[!ENDNOCODE!]
    ...
    /* Checks against Std_Types.h */
        ...
        #error "AUTOSAR Version Numbers of Enet_Ip_Cfg.h and Std_Types.h are different"
    #endif
...
[!IF "var:defined('postBuildVariant')"!]
[!LOOP "variant:all()"!][!//
    [!CODE!][!WS "4"!]ENET_CONFIG_[!"text:toupper(.)"!]_PB \[!CR!][!ENDCODE!]
[!ENDLOOP!][!//
[!ELSE!][!//
...
[!NOCODE!]
[!VAR "FeatureControllerHasExternalBufferEnabled" = "'{'"!][!//
[!VAR "FeatureDriverHasExternalBufferEnabled" = "'(STD_OFF)'"!]
[!VAR "FeatureControllerHasExternalBufferEnabled" = "concat('{', text:join(EthConfigSet/EthCtrlConfig/*/EthCtrlVendorSpecific/EthCtrlConfigGeneral/EthCtrlAllocateTxDataBuffers, ','), '}')"!]
[!VAR "FeatureControllerHasExternalBufferEnabled" = "text:replaceAll($FeatureControllerHasExternalBufferEnabled, 'false', '(boolean) TRUE')"!]
[!VAR "FeatureControllerHasExternalBufferEnabled" = "text:replaceAll($FeatureControllerHasExternalBufferEnabled, 'true', '(boolean) FALSE')"!]
[!IF "contains($FeatureControllerHasExternalBufferEnabled, 'TRUE')"!]
    [!VAR "FeatureDriverHasExternalBufferEnabled" = "'(STD_ON)'"!]
[!ENDIF!]
[!ENDNOCODE!]

/*! @brief Enables / Disables the allocation of the TX data buffers */
#define ENET_IP_HAS_EXTERNAL_BUFFERS  [!"$FeatureDriverHasExternalBufferEnabled"!]

#if (STD_ON == ENET_IP_HAS_EXTERNAL_BUFFERS)
/*! @brief Array of the feature of external buffers support indexed at controller level */
    #define ENET_IP_INST_HAS_EXTERNAL_BUFFERS  [!"$FeatureControllerHasExternalBufferEnabled"!]
#endif

/*! @brief Enables/Disables internal cache management */
#define  ENET_HAS_CACHE_MANAGEMENT  ([!IF "EthGeneral/EthGeneralVendorSpecific/EthEnableCacheManagement"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
