...
#define UART[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PBCFG_VENDOR_ID_C                     43
#define UART[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PBCFG_AR_RELEASE_MAJOR_VERSION_C      4
#define UART[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PBCFG_AR_RELEASE_MINOR_VERSION_C      7
#define UART[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PBCFG_AR_RELEASE_REVISION_VERSION_C   0
#define UART[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PBCFG_SW_MAJOR_VERSION_C              3
#define UART[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PBCFG_SW_MINOR_VERSION_C              0
#define UART[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PBCFG_SW_PATCH_VERSION_C              0

/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Checks against CDD_Uart_Cfg.h */
#if (UART[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PBCFG_VENDOR_ID_C != UART_CFG_VENDOR_ID)
...
#endif
#if ((UART[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PBCFG_AR_RELEASE_MAJOR_VERSION_C    != UART_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (UART[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PBCFG_AR_RELEASE_MINOR_VERSION_C    != UART_CFG_AR_RELEASE_MINOR_VERSION) || \
     (UART[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PBCFG_AR_RELEASE_REVISION_VERSION_C != UART_CFG_AR_RELEASE_REVISION_VERSION) \
    )
...
#endif
#if ((UART[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PBCFG_SW_MAJOR_VERSION_C != UART_CFG_SW_MAJOR_VERSION) || \
     (UART[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PBCFG_SW_MINOR_VERSION_C != UART_CFG_SW_MINOR_VERSION) || \
     (UART[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PBCFG_SW_PATCH_VERSION_C != UART_CFG_SW_PATCH_VERSION) \
    )
...
#if (UART[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PBCFG_VENDOR_ID_C != UART_IPW_CFG_VENDOR_ID)
...
#endif
#if ((UART[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PBCFG_AR_RELEASE_MAJOR_VERSION_C    != UART_IPW_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (UART[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PBCFG_AR_RELEASE_MINOR_VERSION_C    != UART_IPW_CFG_AR_RELEASE_MINOR_VERSION) || \
     (UART[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PBCFG_AR_RELEASE_REVISION_VERSION_C != UART_IPW_CFG_AR_RELEASE_REVISION_VERSION) \
    )
...
#endif
#if ((UART[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PBCFG_SW_MAJOR_VERSION_C != UART_IPW_CFG_SW_MAJOR_VERSION) || \
     (UART[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PBCFG_SW_MINOR_VERSION_C != UART_IPW_CFG_SW_MINOR_VERSION) || \
     (UART[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PBCFG_SW_PATCH_VERSION_C != UART_IPW_CFG_SW_PATCH_VERSION) \
    )
...
#if (UART[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PBCFG_VENDOR_ID_C != UART_DEFINES_VENDOR_ID_CFG)
...
#endif
#if ((UART[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PBCFG_AR_RELEASE_MAJOR_VERSION_C    != UART_DEFINES_AR_RELEASE_MAJOR_VERSION_CFG) || \
     (UART[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PBCFG_AR_RELEASE_MINOR_VERSION_C    != UART_DEFINES_AR_RELEASE_MINOR_VERSION_CFG) || \
     (UART[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PBCFG_AR_RELEASE_REVISION_VERSION_C != UART_DEFINES_AR_RELEASE_REVISION_VERSION_CFG) \
    )
...
#endif
#if ((UART[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PBCFG_SW_MAJOR_VERSION_C != UART_DEFINES_SW_MAJOR_VERSION_CFG) || \
     (UART[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PBCFG_SW_MINOR_VERSION_C != UART_DEFINES_SW_MINOR_VERSION_CFG) || \
     (UART[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PBCFG_SW_PATCH_VERSION_C != UART_DEFINES_SW_PATCH_VERSION_CFG) \
    )
...
/* Check if current file and Std_Types.h header file are of the same Autosar version */
    #if ((UART[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PBCFG_AR_RELEASE_MAJOR_VERSION_C != STD_AR_RELEASE_MAJOR_VERSION) || \
         (UART[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PBCFG_AR_RELEASE_MINOR_VERSION_C != STD_AR_RELEASE_MINOR_VERSION) \
        )
        #error "AutoSar Version Numbers of Uart[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBcfg.c and Std_Types.h are different"
    #endif
#endif
...
[!IF "as:modconf('Uart')[1]/GeneralConfiguration/UartMultipartitionSupport = 'true'"!]
        ...
        [!LOOP "as:modconf('Os')[1]/OsApplication/*"!][!//
            [!IF "$PartitionRef = node:value(./OsAppEcucPartitionRef)"!][!//
                [!SELECT "node:ref(./OsAppEcucPartitionRef)"!][!//
                    [!CODE!]
#define UART_[!"$PartitionNameUpper"!]_PARTITION_ID     ((uint32)[!"node:pos(.)"!]U)
                    [!ENDCODE!]
                [!ENDSELECT!][!//
            [!ENDIF!][!//
        [!ENDLOOP!][!//
...
[!ELSE!]
[!CODE!]
#define UART_[!"$PartitionName"!]PARTITION_ID     ((uint32)0U)
[!ENDCODE!]
...
*
*/
static const Uart_ChannelConfigType Uart_ChannelConfig_[!"UartChannelId"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!] =
{
[!ENDCODE!][!//
[!CODE!]    (uint8)[!"UartChannelId"!]U, /* Uart Channel ID */[!CR!][!ENDCODE!]
[!CODE!]
#if (UART_MULTIPARTITION_SUPPORT == STD_ON)
    (uint32)UART[!"$PartitionNameUpper"!]_PARTITION_ID, /* Uart Channel Partition ID */
#endif
[!ENDCODE!]
[!CODE!]    (uint32)[!"num:i($ClockFrequencyFromMcu)"!]U, /* Clock frequency */[!CR!][!ENDCODE!]
[!CODE!]    &Uart_Ipw_xHwConfigPB_[!"UartChannelId"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!] [!ENDIF!] /* Pointer to the hardware configuration */
};
[!ENDCODE!][!//
[!ENDLOOP!][!//
[!ENDNOCODE!]
...
#if (UART_MULTIPARTITION_SUPPORT == STD_ON)
    UART[!"text:toupper($FinalPartitionName)"!]_PARTITION_ID,
#endif
    {
[!ENDCODE!][!//
[!NOCODE!]
...
[!IF "as:modconf('Uart')[1]/GeneralConfiguration/UartMultipartitionSupport = 'true'"!]
    ...
    [!FOR "UartCountPartitionId"="0" TO "$MaxPartitionId"!]
        ...
        [!LOOP "GeneralConfiguration/UartEcucPartitionRef/*"!][!//
            ...
                        [!SELECT "node:ref(./OsAppEcucPartitionRef)"!][!//
                            ...
                            [!IF "($UartCountPartitionId = node:pos(.))"!]
...
[!ENDCODE!]
        [!ENDIF!]
    [!ENDFOR!]
[!ELSE!][!//UartGeneral/UartMultipartitionSupport = 'false'
    [!CODE!]
    &Uart_xConfig
    [!ENDCODE!]
[!ENDIF!][!//UartGeneral/UartMultipartitionSupport = 'true'
[!CODE!][!//
};
[!ENDCODE!]
