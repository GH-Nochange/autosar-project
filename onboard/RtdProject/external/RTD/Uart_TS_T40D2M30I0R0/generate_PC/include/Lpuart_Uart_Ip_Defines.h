...
[!IF "node:exists(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative)"!][!//
    ...
    [!ELSEIF "contains($Derivative, 'S32K36') or contains($Derivative, 'S32K39')"!][!//
    ...
    [!ELSEIF "contains($Derivative, 'S32K37')"!][!//
        [!VAR "Derivative" = "'S32K37'"!]
    [!ELSEIF "contains($Derivative, 'S32K5')"!][!//
        [!VAR "Derivative" = "'S32K566'"!]
    [!ENDIF!][!//
...
[!NOCODE!]
[!IF "contains($Derivative, 'S32K5')"!][!//
[!CODE!]
/** Array initializer of LPUART peripheral base pointers */
#define LPUART_IP_BASE_PTRS                      { IP_LPUART_0, IP_LPUART_1, IP_LPUART_2, IP_LPUART_3, IP_LPUART_4, IP_LPUART_5, IP_LPUART_6, IP_LPUART_7, IP_LPUART_8, IP_LPUART_9, IP_LPUART_10, IP_LPUART_11, IP_LPUART_12, IP_LPUART_13, IP_LPUART_14, IP_LPUART_15, IP_LPUART_16, IP_LPUART_17, IP_LPUART_18, IP_LPUART_19, IP_LPUART_20, IP_LPUART_21, IP_LPE_LPUART_0, IP_LPE_LPUART_1, IP_LPE_LPUART_2 }
[!ENDCODE!]
[!ELSE!][!//
[!CODE!]
    ...
    [!LOOP "UartGlobalConfig/UartChannel/*"!]
        [!IF "UartHwUsing = 'LPUART_IP'"!][!//
            ...
            [!IF "contains($Channel, 'LPUART')"!]
                [!VAR "EnableLoopback" = "false()"!]
                [!VAR "EnableTimeoutInterrupt" = "false()"!]
                [!IF "contains($Channel, 'LPUART_MSC')"!][!// LPUART_MSC is only available on S32K396 S32K366 S32K364
                    [!VAR "HwChannel" = "4"!]
                [!ELSEIF "contains($Channel, 'LPE_LPUART_0')"!][!// LPUART_LPE is only available on S32K5
                    [!VAR "HwChannel" = "22"!]
                [!ELSEIF "contains($Channel, 'LPE_LPUART_1')"!][!// LPUART_LPE is only available on S32K5
                    [!VAR "HwChannel" = "23"!]
                [!ELSEIF "contains($Channel, 'LPE_LPUART_2')"!][!// LPUART_LPE is only available on S32K5
                    [!VAR "HwChannel" = "24"!]
                [!ELSE!]
...
#define LPUART_UART_IP_ENABLE_TIMEOUT_INTERRUPT  [!"$FeatureEnableTimeoutInterrupt"!]

#if (STD_ON == LPUART_UART_IP_ENABLE_TIMEOUT_INTERRUPT)
    /* @brief Array of instances that have timeout interrupt enabled. */
    #define LPUART_UART_IP_ENABLE_TIMEOUT_INTERRUPT_PER_INSTANCE  [!"$StringTimeoutInterrupt"!]
#endif
