...
#if (FTM_QDEC_IP_CFG_VENDOR_ID != FTM_QDEC_IP_[!"text:toupper(.)"!]_PBCFG_VENDOR_ID)
...
#if ((FTM_QDEC_IP_CFG_AR_RELEASE_MAJOR_VERSION != FTM_QDEC_IP_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
     (FTM_QDEC_IP_CFG_AR_RELEASE_MINOR_VERSION != FTM_QDEC_IP_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_MINOR_VERSION) || \
     (FTM_QDEC_IP_CFG_AR_RELEASE_REVISION_VERSION != FTM_QDEC_IP_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_REVISION_VERSION))
...
#if ((FTM_QDEC_IP_CFG_SW_MAJOR_VERSION != FTM_QDEC_IP_[!"text:toupper(.)"!]_PBCFG_SW_MAJOR_VERSION) || \
     (FTM_QDEC_IP_CFG_SW_MINOR_VERSION != FTM_QDEC_IP_[!"text:toupper(.)"!]_PBCFG_SW_MINOR_VERSION) || \
     (FTM_QDEC_IP_CFG_SW_PATCH_VERSION != FTM_QDEC_IP_[!"text:toupper(.)"!]_PBCFG_SW_PATCH_VERSION))
