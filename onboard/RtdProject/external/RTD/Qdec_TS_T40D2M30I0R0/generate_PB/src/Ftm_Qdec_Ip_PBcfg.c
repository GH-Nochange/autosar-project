 ...
 *================================================================================================*/
#define FTM_QDEC_IP[!"text:toupper($VS_number)"!]_PBCFG_VENDOR_ID_C                       43
#define FTM_QDEC_IP[!"text:toupper($VS_number)"!]_PBCFG_AR_RELEASE_MAJOR_VERSION_C        4
#define FTM_QDEC_IP[!"text:toupper($VS_number)"!]_PBCFG_AR_RELEASE_MINOR_VERSION_C        7
#define FTM_QDEC_IP[!"text:toupper($VS_number)"!]_PBCFG_AR_RELEASE_REVISION_VERSION_C     0
#define FTM_QDEC_IP[!"text:toupper($VS_number)"!]_PBCFG_SW_MAJOR_VERSION_C                3
#define FTM_QDEC_IP[!"text:toupper($VS_number)"!]_PBCFG_SW_MINOR_VERSION_C                0
#define FTM_QDEC_IP[!"text:toupper($VS_number)"!]_PBCFG_SW_PATCH_VERSION_C                0

/*==================================================================================================
 *                                      FILE VERSION CHECKS
 *================================================================================================*/
/* Check if source file and Ftm_Qdec_Ip[!"$VS_number"!]_PBcfg header file are of the same vendor */
#if (FTM_QDEC_IP[!"text:toupper($VS_number)"!]_PBCFG_VENDOR_ID_C != FTM_QDEC_IP[!"text:toupper($VS_number)"!]_PBCFG_VENDOR_ID)
...
#if ((FTM_QDEC_IP[!"text:toupper($VS_number)"!]_PBCFG_AR_RELEASE_MAJOR_VERSION_C != FTM_QDEC_IP[!"text:toupper($VS_number)"!]_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
     (FTM_QDEC_IP[!"text:toupper($VS_number)"!]_PBCFG_AR_RELEASE_MINOR_VERSION_C != FTM_QDEC_IP[!"text:toupper($VS_number)"!]_PBCFG_AR_RELEASE_MINOR_VERSION) || \
     (FTM_QDEC_IP[!"text:toupper($VS_number)"!]_PBCFG_AR_RELEASE_REVISION_VERSION_C != FTM_QDEC_IP[!"text:toupper($VS_number)"!]_PBCFG_AR_RELEASE_REVISION_VERSION))
...
#if ((FTM_QDEC_IP[!"text:toupper($VS_number)"!]_PBCFG_SW_MAJOR_VERSION_C != FTM_QDEC_IP[!"text:toupper($VS_number)"!]_PBCFG_SW_MAJOR_VERSION) || \
     (FTM_QDEC_IP[!"text:toupper($VS_number)"!]_PBCFG_SW_MINOR_VERSION_C != FTM_QDEC_IP[!"text:toupper($VS_number)"!]_PBCFG_SW_MINOR_VERSION) || \
     (FTM_QDEC_IP[!"text:toupper($VS_number)"!]_PBCFG_SW_PATCH_VERSION_C != FTM_QDEC_IP[!"text:toupper($VS_number)"!]_PBCFG_SW_PATCH_VERSION))
...
const Ftm_Qdec_Ip_ConfigType Ftm_Qdec_Ip_InstanceConfig[!"$VS_number"!][[!"num:i($NumberOfFtmUsed)"!]U] =
{
        ...
        [!NOCODE!]
           ...
           /* Get hw information: alternate prescaler */
            [!IF "(node:exists('QdecFtmPrescale_Alternate'))"!]
                [!IF "../../QdecGeneral/QdecEnableDualClockMode = 'true' "!]
            ...
            /* Get hw information: filter prescaler */
            [!VAR "FilterPrescaler" = "node:value(QdecFtmFilterPrescaler)"!]
            [!VAR "FilterPrescaler" = "concat('FTM_CLOCK_FILTER_PRESCALER_', $FilterPrescaler)"!]
    ...
    /* [!"@name"!] -> [!"QdecFtmModule"!] */
    {
        ...
        (Ftm_Qdec_Ip_ClockFilterPrescType) [!"$FilterPrescaler"!]       /** @brief FlexTimer Clock Filter Prescaler */
