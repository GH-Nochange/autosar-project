...
#if (CLOCK_IP_CFG_VENDOR_ID != CLOCK_IP_[!"text:toupper(.)"!]_PBCFG_VENDOR_ID)
...
#if ((CLOCK_IP_CFG_AR_RELEASE_MAJOR_VERSION != CLOCK_IP_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
     (CLOCK_IP_CFG_AR_RELEASE_MINOR_VERSION != CLOCK_IP_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_MINOR_VERSION) || \
     (CLOCK_IP_CFG_AR_RELEASE_REVISION_VERSION != CLOCK_IP_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_REVISION_VERSION) \
    )
...
#if ((CLOCK_IP_CFG_SW_MAJOR_VERSION != CLOCK_IP_[!"text:toupper(.)"!]_PBCFG_SW_MAJOR_VERSION) || \
     (CLOCK_IP_CFG_SW_MINOR_VERSION != CLOCK_IP_[!"text:toupper(.)"!]_PBCFG_SW_MINOR_VERSION) || \
     (CLOCK_IP_CFG_SW_PATCH_VERSION != CLOCK_IP_[!"text:toupper(.)"!]_PBCFG_SW_PATCH_VERSION) \
    )
