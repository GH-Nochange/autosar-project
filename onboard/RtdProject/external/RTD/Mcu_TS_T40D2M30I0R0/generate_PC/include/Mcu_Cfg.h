...
#if (MCU_CFG_VENDOR_ID != MCU_[!"text:toupper(.)"!]_PBCFG_VENDOR_ID)
...
#if ((MCU_CFG_AR_RELEASE_MAJOR_VERSION != MCU_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
     (MCU_CFG_AR_RELEASE_MINOR_VERSION != MCU_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_MINOR_VERSION) || \
     (MCU_CFG_AR_RELEASE_REVISION_VERSION != MCU_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_REVISION_VERSION) \
    )
...
#if ((MCU_CFG_SW_MAJOR_VERSION != MCU_[!"text:toupper(.)"!]_PBCFG_SW_MAJOR_VERSION) || \
     (MCU_CFG_SW_MINOR_VERSION != MCU_[!"text:toupper(.)"!]_PBCFG_SW_MINOR_VERSION) || \
     (MCU_CFG_SW_PATCH_VERSION != MCU_[!"text:toupper(.)"!]_PBCFG_SW_PATCH_VERSION) \
    )
...
*/
#define MCU_POWER_NOTIFICATIONS            CLOCK_IP_POWER_NOTIFICATIONS
...
[!IF "node:exists(McuGeneralConfiguration/McuPmcAeNotification)"!]
/**
* @brief            The callout configured by the user for PMC_AE notifications.
*/

#define MCU_PMC_AE_NOTIFICATION(Error,u8ErrorCode)           ([!"normalize-space(McuGeneralConfiguration/McuPmcAeNotification)"!](Error,u8ErrorCode))
[!ENDIF!]
...
*/
#define MCU_MULTIPARTITION_SUPPORT                   ([!IF "McuGeneralConfiguration/McuMultiPartitionSupport"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
#define MCU_PARTITION_[!"num:i($CurrentPartitionId)"!]                 ((uint8)[!"num:i($CurrentPartitionId)"!]UL)
[!ENDIF!][!//
[!ENDLOOP!][!//
[!ENDLOOP!][!//
[!ELSE!][!//
#define MCU_PARTITION_0                 ((uint8)0UL)
[!ENDIF!][!//
[!ELSE!][!//
/**
* @brief        Support for MultiPartition.
...
extern void MCU_PMC_AE_NOTIFICATION(Power_Ip_ReportErrorType Error,uint8 u8ErrorCode);
[!ENDIF!]
