...
[!IF "node:exists(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative)"!][!//
    ...
    [!ELSEIF "contains(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative, 's32k37')"!][!//
        [!CODE!][!WS "0"!]#include "S32K37_FLEXIO.h"[!CR!][!ENDCODE!][!//
    [!ELSEIF "contains(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative, 's32k39') or
              contains(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative, 's32k36')"!][!//
...
[!IF "var:defined('postBuildVariant')"!]
    [!LOOP "variant:all()"!]
/* Check if header file and Flexio_Pwm_Ip_[!"."!]_PBcfg header file are of the same vendor */
#if (FLEXIO_PWM_IP_CFG_VENDOR_ID != FLEXIO_PWM_IP_[!"text:toupper(.)"!]_PBCFG_VENDOR_ID)
    #error "Vendor IDs of Flexio_Pwm_Ip_Cfg.h and Flexio_Pwm_Ip_[!"."!]_PBcfg.h are different."
#endif

/* Check if header file and Flexio_Pwm_Ip_[!"."!]_PBcfg header file are of the same AUTOSAR version */
#if ((FLEXIO_PWM_IP_CFG_AR_RELEASE_MAJOR_VERSION    != FLEXIO_PWM_IP_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
     (FLEXIO_PWM_IP_CFG_AR_RELEASE_MINOR_VERSION    != FLEXIO_PWM_IP_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_MINOR_VERSION) || \
     (FLEXIO_PWM_IP_CFG_AR_RELEASE_REVISION_VERSION != FLEXIO_PWM_IP_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_REVISION_VERSION))
    #error "AUTOSAR version numbers of Flexio_Pwm_Ip_Cfg.h and Flexio_Pwm_Ip_[!"."!]_PBcfg.h are different."
#endif

/* Check if header file and Flexio_Pwm_Ip_[!"."!]_PBcfg header file are of the same software version */
#if ((FLEXIO_PWM_IP_CFG_SW_MAJOR_VERSION != FLEXIO_PWM_IP_[!"text:toupper(.)"!]_PBCFG_SW_MAJOR_VERSION) || \
     (FLEXIO_PWM_IP_CFG_SW_MINOR_VERSION != FLEXIO_PWM_IP_[!"text:toupper(.)"!]_PBCFG_SW_MINOR_VERSION) || \
     (FLEXIO_PWM_IP_CFG_SW_PATCH_VERSION != FLEXIO_PWM_IP_[!"text:toupper(.)"!]_PBCFG_SW_PATCH_VERSION))
...
/* Check if header file and Flexio_Pwm_Ip_PBcfg header file are of the same AUTOSAR version */
...
/* Check if header file and Flexio_Pwm_Ip_PBcfg header file are of the same software version */
...
#define FLEXIO_PWM_IP_NO_CACHE_NEEDED           ([!IF "num:i(count(PwmGeneral/PwmEcucPartitionRef/*)) > 1"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
