...
#ifndef PWM[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PB_CFG_H
#define PWM[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PB_CFG_H

/**
*   @file       Pwm[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBcfg.h
*
...
==================================================================================================*/
#define PWM[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PB_CFG_VENDOR_ID                    43
#define PWM[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PB_CFG_MODULE_ID                    121
#define PWM[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PB_CFG_AR_RELEASE_MAJOR_VERSION     4
#define PWM[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PB_CFG_AR_RELEASE_MINOR_VERSION     7
#define PWM[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PB_CFG_AR_RELEASE_REVISION_VERSION  0
#define PWM[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PB_CFG_SW_MAJOR_VERSION             3
#define PWM[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PB_CFG_SW_MINOR_VERSION             0
#define PWM[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PB_CFG_SW_PATCH_VERSION             0
...
==================================================================================================*/
    ...
    #if ((PWM[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PB_CFG_AR_RELEASE_MAJOR_VERSION != STD_AR_RELEASE_MAJOR_VERSION) || \
         (PWM[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PB_CFG_AR_RELEASE_MINOR_VERSION != STD_AR_RELEASE_MINOR_VERSION))
...
*
*/
#define PWM[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PB_CONF_PARTITIONS         ((uint8)[!"num:i($numPartition)"!]U)
...
*/
#define PWM[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PB_CFG_CHANNELS_COUNT           ((uint8)[!"num:i(count(PwmChannelConfigSet/PwmChannel/*))"!]U)

[!IF "ecu:has('Pwm.ExclusiveHwInstance') and (ecu:get('Pwm.ExclusiveHwInstance') = 'true')"!]
/**
* @brief        Total number of configured PWM instances
*/
#define PWM[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PB_CFG_INSTANCES_COUNT          ((uint8)[!IF "$instanceCount > 0"!][!"num:i($instanceCount)"!]U[!ELSE!]1U[!ENDIF!])
...
*/
#define PWM[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PB_CFG_CHANNELS_COUNT_[!"text:toupper($PwmEcucPartitionShortName)"!]    ((uint8)[!"num:i($NumChannelInPartition)"!]U)

/**
* @brief        Total number of configured PWM instances in [!"$PwmEcucPartitionShortName"!]
*/
#define PWM[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PB_CFG_INSTANCES_COUNT_[!"text:toupper($PwmEcucPartitionShortName)"!]    ((uint8)[!IF "$NumModuleInPartition > 0"!][!"num:i($NumModuleInPartition)"!]U[!ELSE!]1U[!ENDIF!])
...
#define PWM_CONFIG_[!"text:toupper($postBuildVariant)"!]_PB \
    [!ELSE!]
...
#endif /* PWM[!IF "var:defined('postBuildVariant')"!]_[!"text:toupper($postBuildVariant)"!][!ENDIF!]_PB_CFG_H */
