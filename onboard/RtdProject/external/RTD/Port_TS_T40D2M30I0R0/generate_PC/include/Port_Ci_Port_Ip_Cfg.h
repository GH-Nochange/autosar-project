...
[!LOOP "variant:all()"!]
#include "Port_Ci_Port_Ip_[!"."!]_PBcfg.h"
[!ENDLOOP!]
[!ELSE!]
...
[!IF "var:defined('postBuildVariant')"!]
[!LOOP "variant:all()"!]
/* Check if the files Port_Ci_Port_Ip_Cfg.h and Port_Ci_Port_Ip_[!"."!]_PBcfg.h are of the same vendor */
#if (PORT_CI_PORT_IP_VENDOR_ID_CFG_H != PORT_CI_PORT_IP_VENDOR_ID_[!"."!]_PBCFG_H)
    #error "Port_Ci_Port_Ip_Cfg.h and Port_Ci_Port_Ip_[!"."!]_PBcfg.h have different vendor ids"
#endif
/* Check if the files Port_Ci_Port_Ip_Cfg.h and Port_Ci_Port_Ip_[!"."!]_PBcfg.h are of the same Autosar version */
#if ((PORT_CI_PORT_IP_AR_RELEASE_MAJOR_VERSION_CFG_H    != PORT_CI_PORT_IP_AR_RELEASE_MAJOR_VERSION_[!"."!]_PBCFG_H)  || \
     (PORT_CI_PORT_IP_AR_RELEASE_MINOR_VERSION_CFG_H    != PORT_CI_PORT_IP_AR_RELEASE_MINOR_VERSION_[!"."!]_PBCFG_H)  || \
     (PORT_CI_PORT_IP_AR_RELEASE_REVISION_VERSION_CFG_H != PORT_CI_PORT_IP_AR_RELEASE_REVISION_VERSION_[!"."!]_PBCFG_H)  \
    )
    #error "AutoSar Version Numbers of Port_Ci_Port_Ip_Cfg.h and Port_Ci_Port_Ip_[!"."!]_PBcfg.h are different"
#endif
/* Check if the files Port_Ci_Port_Ip_Cfg.h and Port_Ci_Port_Ip_[!"."!]_PBcfg.h are of the same software version */
#if ((PORT_CI_PORT_IP_SW_MAJOR_VERSION_CFG_H != PORT_CI_PORT_IP_SW_MAJOR_VERSION_[!"."!]_PBCFG_H) || \
     (PORT_CI_PORT_IP_SW_MINOR_VERSION_CFG_H != PORT_CI_PORT_IP_SW_MINOR_VERSION_[!"."!]_PBCFG_H) || \
     (PORT_CI_PORT_IP_SW_PATCH_VERSION_CFG_H != PORT_CI_PORT_IP_SW_PATCH_VERSION_[!"."!]_PBCFG_H)    \
    )
    #error "Software Version Numbers of Port_Ci_Port_Ip_Cfg.h and Port_Ci_Port_Ip_[!"."!]_PBcfg.h are different"
#endif
[!ENDLOOP!]
[!ELSE!]
