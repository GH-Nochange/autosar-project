...
#define PORT_CI_PORT_IP_AR_RELEASE_MINOR_VERSION_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG_C        7
#define PORT_CI_PORT_IP_AR_RELEASE_REVISION_VERSION_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG_C     0
#define PORT_CI_PORT_IP_SW_MAJOR_VERSION_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG_C                3
#define PORT_CI_PORT_IP_SW_MINOR_VERSION_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG_C                0
#define PORT_CI_PORT_IP_SW_PATCH_VERSION_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG_C                0
...
[!VAR "slewRateCtrlSel_IP"= "'PORT_FAST_SLEW_RATE'"!][!//
...
[!IF "(ecu:get('Port.Family')='m241') or (ecu:get('Port.Family')='m242') or (ecu:get('Port.Family')='m243') or (ecu:get('Port.Family')='m244')"!][!//
    [!/* Check if slew rate control is set */!][!//
    [!IF "node:fallback(./PortPinSlewRate, 'SLOW_SLEW_RATE') = 'FAST_SLEW_RATE'"!][!//
        [!VAR "slewRateCtrlSel_IP" = "'PORT_FAST_SLEW_RATE'"!][!//
    [!ELSE!][!//
        [!VAR "slewRateCtrlSel_IP" = "'PORT_SLOW_SLEW_RATE'"!][!//
    [!ENDIF!][!//
    [!/* Check if open drain is enabled */!][!//
    [!IF "./PortPinODE"!][!//
