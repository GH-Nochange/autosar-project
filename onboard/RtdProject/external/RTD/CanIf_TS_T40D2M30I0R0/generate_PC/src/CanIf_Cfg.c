...
static const CanIf_CallbackNotifULPtrType CanIf_DispatchCfgPtr = 
{
    ...
    [!IF "node:exists(./CanIfDispatchCfg/CanIfDispatchUserValidateWakeupEventName)"!][!"normalize-space(./CanIfDispatchCfg/CanIfDispatchUserValidateWakeupEventName)"!][!ELSE!]NULL_PTR[!ENDIF!],[!CR!]
    /* .UserControllerBusOff */
    [!IF "node:exists(./CanIfDispatchCfg/CanIfDispatchUserCtrlBusOffName)"!][!"normalize-space(./CanIfDispatchCfg/CanIfDispatchUserCtrlBusOffName)"!][!ELSE!]NULL_PTR[!ENDIF!],[!CR!]
    /* .UserConfirmPnAvailability */
    [!IF "node:exists(./CanIfDispatchCfg/CanIfDispatchUserConfirmPnAvailabilityName)"!][!"normalize-space(./CanIfDispatchCfg/CanIfDispatchUserConfirmPnAvailabilityName)"!][!ELSE!]NULL_PTR[!ENDIF!],[!CR!]
    /* .UserClearTrcvWufFlagIndication */
    [!IF "node:exists(./CanIfDispatchCfg/CanIfDispatchUserClearTrcvWufFlagIndicationName)"!][!"normalize-space(./CanIfDispatchCfg/CanIfDispatchUserClearTrcvWufFlagIndicationName)"!][!ELSE!]NULL_PTR[!ENDIF!],[!CR!]
    /* .UserCheckTrcvWakeFlagIndication */
    [!IF "node:exists(./CanIfDispatchCfg/CanIfDispatchUserCheckTrcvWakeFlagIndicationName)"!][!"normalize-space(./CanIfDispatchCfg/CanIfDispatchUserCheckTrcvWakeFlagIndicationName)"!][!ELSE!]NULL_PTR[!ENDIF!],[!CR!]
    /* .UserControllerModeIndication */
    [!IF "node:exists(./CanIfDispatchCfg/CanIfDispatchUserCtrlModeIndicationName)"!][!"normalize-space(./CanIfDispatchCfg/CanIfDispatchUserCtrlModeIndicationName)"!][!ELSE!]NULL_PTR[!ENDIF!],[!CR!]
    /* .UserTrcvModeIndication */
    [!IF "node:exists(./CanIfDispatchCfg/CanIfDispatchUserTrcvModeIndicationName)"!][!"normalize-space(./CanIfDispatchCfg/CanIfDispatchUserTrcvModeIndicationName)"!][!ELSE!]NULL_PTR[!ENDIF!],[!CR!]
    [!ENDINDENT!]
};
