...
[!CODE!][!WS "0"!]#include "S32K312_MSCM.h"[!CR!][!ENDCODE!][!//
    [!ELSEIF "text:match(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative, 's32k311')"!][!// 
[!CODE!][!WS "0"!]#include "S32K311_SYSTICK.h"[!CR!][!ENDCODE!][!//
[!CODE!][!WS "0"!]#include "S32K311_MSCM.h"[!CR!][!ENDCODE!][!//
    [!ELSEIF "text:match(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative, 's32k310')"!][!// 
[!CODE!][!WS "0"!]#include "S32K311_SYSTICK.h"[!CR!][!ENDCODE!][!//
[!CODE!][!WS "0"!]#include "S32K311_MSCM.h"[!CR!][!ENDCODE!][!//
...
[!CODE!][!WS "0"!]#include "S32K314_MSCM.h"[!CR!][!ENDCODE!][!//
...
[!CODE!][!WS "0"!]#include "S32K324_MSCM.h"[!CR!][!ENDCODE!][!//
...
[!CODE!][!WS "0"!]#include "S32K342_MSCM.h"[!CR!][!ENDCODE!][!//
...
[!CODE!][!WS "0"!]#include "S32K344_MSCM.h"[!CR!][!ENDCODE!][!//
    [!ELSEIF "text:match(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative, 's32k341')"!][!// 
[!CODE!][!WS "0"!]#include "S32K341_SYSTICK.h"[!CR!][!ENDCODE!][!//
[!CODE!][!WS "0"!]#include "S32K341_MSCM.h"[!CR!][!ENDCODE!][!//
    [!ELSEIF "text:match(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative, 's32k322')"!][!// 
[!CODE!][!WS "0"!]#include "S32K322_SYSTICK.h"[!CR!][!ENDCODE!][!//
[!CODE!][!WS "0"!]#include "S32K322_MSCM.h"[!CR!][!ENDCODE!][!//
    [!ELSEIF "text:match(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative, 's32k39')"!][!// 
[!CODE!][!WS "0"!]#include "S32K39_SYSTICK.h"[!CR!][!ENDCODE!][!//
[!CODE!][!WS "0"!]#include "S32K39_MSCM.h"[!CR!][!ENDCODE!][!//
    [!ELSEIF "text:match(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative, 's32k36')"!][!// 
[!CODE!][!WS "0"!]#include "S32K39_SYSTICK.h"[!CR!][!ENDCODE!][!//
[!CODE!][!WS "0"!]#include "S32K39_MSCM.h"[!CR!][!ENDCODE!][!//
    [!ELSEIF "text:match(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative, 's32k37')"!][!// 
[!CODE!][!WS "0"!]#include "S32K37_SYSTICK.h"[!CR!][!ENDCODE!][!//
[!CODE!][!WS "0"!]#include "S32K37_MSCM.h"[!CR!][!ENDCODE!][!//
    [!ELSEIF "text:match(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative, 's32k358')"!][!// 
[!CODE!][!WS "0"!]#include "S32K358_SYSTICK.h"[!CR!][!ENDCODE!][!//
[!CODE!][!WS "0"!]#include "S32K358_MSCM.h"[!CR!][!ENDCODE!][!//
    [!ELSEIF "text:match(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative, 's32k328')"!][!// 
[!CODE!][!WS "0"!]#include "S32K358_SYSTICK.h"[!CR!][!ENDCODE!][!//
[!CODE!][!WS "0"!]#include "S32K358_MSCM.h"[!CR!][!ENDCODE!][!//
    [!ELSEIF "text:match(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative, 's32k338')"!][!// 
[!CODE!][!WS "0"!]#include "S32K358_SYSTICK.h"[!CR!][!ENDCODE!][!//
[!CODE!][!WS "0"!]#include "S32K358_MSCM.h"[!CR!][!ENDCODE!][!//
    [!ELSEIF "text:match(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative, 's32k348')"!][!// 
[!CODE!][!WS "0"!]#include "S32K358_SYSTICK.h"[!CR!][!ENDCODE!][!//
[!CODE!][!WS "0"!]#include "S32K358_MSCM.h"[!CR!][!ENDCODE!][!//
    [!ELSEIF "text:match(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative, 's32k388')"!][!// 
[!CODE!][!WS "0"!]#include "S32K388_SYSTICK.h"[!CR!][!ENDCODE!][!//
[!CODE!][!WS "0"!]#include "S32K388_MSCM.h"[!CR!][!ENDCODE!][!//
    [!ELSEIF "text:match(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative, 's32m27')"!][!// 
[!CODE!][!WS "0"!]#include "S32M27x_SYSTICK.h"[!CR!][!ENDCODE!][!//
[!CODE!][!WS "0"!]#include "S32M27x_MSCM.h"[!CR!][!ENDCODE!][!//
...
[!CODE!][!WS "0"!]#include "SAF85xx_SYSTICK.h"[!CR!][!ENDCODE!][!//
[!CODE!][!WS "0"!]#include "SAF85xx_MSCM.h"[!CR!][!ENDCODE!][!//
    [!ELSEIF "contains(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative, 'saf86')"!][!// 
[!CODE!][!WS "0"!]#include "SAF86xx_SYSTICK.h"[!CR!][!ENDCODE!][!//
[!CODE!][!WS "0"!]#include "SAF86xx_MSCM.h"[!CR!][!ENDCODE!][!//
...
[!CODE!][!WS "0"!]#include "S32M24x_SYSTICK.h"[!CR!][!ENDCODE!][!// 
    [!ELSEIF "contains(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative, 's32e')"!][!// 
[!CODE!][!WS "0"!]#include "S32E2_SYSTICK.h"[!CR!][!ENDCODE!][!//
[!CODE!][!WS "0"!]#include "S32E2_MSCM.h"[!CR!][!ENDCODE!][!//
    [!ELSEIF "contains(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative, 's32z')"!][!// 
[!CODE!][!WS "0"!]#include "S32Z2_SYSTICK.h"[!CR!][!ENDCODE!][!//
[!CODE!][!WS "0"!]#include "S32Z2_MSCM.h"[!CR!][!ENDCODE!][!//
    [!ELSEIF "contains(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative, 's32n5')"!][!// 
[!CODE!][!WS "0"!]#include "S32N55_SYSTICK.h"[!CR!][!ENDCODE!][!//
    [!ELSEIF "contains(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative, 's32n7')"!][!// 
[!CODE!][!WS "0"!]#include "S32N79_SYSTICK.h"[!CR!][!ENDCODE!][!//
    [!ELSEIF "contains(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative, 'sja')"!][!// 
[!CODE!][!WS "0"!]#include "SJA1110.h"[!CR!][!ENDCODE!][!//
    [!ELSEIF "contains(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative, 's32k566')"!][!// 
[!CODE!][!WS "0"!]#include "S32K566_SYSTICK.h"[!CR!][!ENDCODE!][!//
[!CODE!][!WS "0"!]#include "S32K566_MSCM.h"[!CR!][!ENDCODE!][!//
    [!ELSEIF "contains(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative, 'saf9000')"!][!// 
[!CODE!][!WS "0"!]#include "SAF900X_SYSTICK.h"[!CR!][!ENDCODE!][!//
    [!ENDIF!][!//
[!ELSE!][!//
...
#define OSIF_MAX_APPIDX_SUPPORTED        ([!IF "OsIfGeneral/OsIfMulticoreSupport"!][!"num:i(count(as:modconf('Os')[1]/OsApplication/*))"!][!ELSE!]1[!ENDIF!]U)  

#define OSIF_DEV_ERROR_DETECT            ([!IF "OsIfGeneral/OsIfDevErrorDetect"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])

[!NOCODE!]
[!IF "node:exists(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative)"!][!//
    [!CODE!]#define USING_COHORT_DOMAIN_ID           ([!IF "contains(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative, 's32n')"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])[!ENDCODE!]
[!ELSE!][!//
    [!CODE!]#define USING_COHORT_DOMAIN_ID           (STD_OFF)[!ENDCODE!]
[!ENDIF!][!//
[!ENDNOCODE!]
...
[!CODE!]#define USING_GET_PARTITION_ID[!ENDCODE!]
[!ENDIF!]

[!IF "node:containsValue(OsIfGeneral/OsIfUseGetUserId, 'GET_CORE_ID')"!]
[!CODE!]#define USING_GET_CORE_ID[!ENDCODE!]
[!ENDIF!]

[!IF "node:containsValue(OsIfGeneral/OsIfUseGetUserId, 'GET_CUSTOM_ID')"!]
[!CODE!]#define USING_GET_CUSTOM_ID[!ENDCODE!]
[!ENDIF!]
...
#define OSIF_GET_PHYSICAL_CORE_ID_ENABLE  ([!IF "OsIfGeneral/OsIfGetPhysicalCoreIdEnable"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
[!IF "OsIfGeneral/OsIfGetPhysicalCoreIdEnable"!]
[!VAR "getPhysicalCoreIdRuntime" = "'STD_OFF'"!]
#define OSIF_GET_PHYSICAL_CORE_ID_RUNTIME ([!"$getPhysicalCoreIdRuntime"!])
[!IF "$getPhysicalCoreIdRuntime = 'STD_OFF'"!]
#define OSIF_PHYSICAL_CORE_ID             (0U)
[!ENDIF!]
[!ENDIF!]

#define OSIF_SOFTWARE_SEMAPHORE_ENABLE  ([!IF "OsIfGeneral/OsIfSoftwareSemaphoredEnable"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
