...
#define EEP[!"$variantNameUpperCase"!]_SW_MAJOR_VERSION_PBCFG_C               3
#define EEP[!"$variantNameUpperCase"!]_SW_MINOR_VERSION_PBCFG_C               0
#define EEP[!"$variantNameUpperCase"!]_SW_PATCH_VERSION_PBCFG_C               0
...
#if (EEP[!"$variantNameUpperCase"!]_VENDOR_ID_PBCFG_C != FTFC_EEP_IP_CFG_VENDOR_ID_H)
    #error "AutoSar Version Numbers of Eep[!"$variantName"!]_PBcfg.c and Ftfc_Eep_Ip_Cfg.h have different vendor ids"
#endif
/* Check if current file and Ftfc_Eep_Ip_Cfg header file are of the same Autosar version */
#if ((EEP[!"$variantNameUpperCase"!]_AR_RELEASE_MAJOR_VERSION_PBCFG_C    != FTFC_EEP_IP_CFG_AR_RELEASE_MAJOR_VERSION_H) || \
     (EEP[!"$variantNameUpperCase"!]_AR_RELEASE_MINOR_VERSION_PBCFG_C    != FTFC_EEP_IP_CFG_AR_RELEASE_MINOR_VERSION_H) || \
     (EEP[!"$variantNameUpperCase"!]_AR_RELEASE_REVISION_VERSION_PBCFG_C != FTFC_EEP_IP_CFG_AR_RELEASE_REVISION_VERSION_H) \
    )
    #error "AutoSar Version Numbers of Eep[!"$variantName"!]_PBcfg.c and Ftfc_Eep_Ip_Cfg.h are different"
#endif
/* Check if current file and Ftfc_Eep_Ip_Cfg header file are of the same Software version */
#if ((EEP[!"$variantNameUpperCase"!]_SW_MAJOR_VERSION_PBCFG_C != FTFC_EEP_IP_CFG_SW_MAJOR_VERSION_H) || \
     (EEP[!"$variantNameUpperCase"!]_SW_MINOR_VERSION_PBCFG_C != FTFC_EEP_IP_CFG_SW_MINOR_VERSION_H) || \
     (EEP[!"$variantNameUpperCase"!]_SW_PATCH_VERSION_PBCFG_C != FTFC_EEP_IP_CFG_SW_PATCH_VERSION_H) \
    )
    #error "Software Version Numbers of Eep[!"$variantName"!]_PBcfg.c and Ftfc_Eep_Ip_Cfg.h are different"
#endif
...
[!LOOP "EepInitConfiguration"!][!//
    ...
    */
    ...
    [!ENDIF!][!//
        [!WS "4"!]/* FTFC IP Config Set                */ &EepFtfcCfg[!"$variantName"!]
    };
