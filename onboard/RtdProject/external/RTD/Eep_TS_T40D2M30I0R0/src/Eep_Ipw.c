...
#define EEP_IPW_SW_MAJOR_VERSION_C               3
                                             ...
                                             )
{
    ...
    Eep_AddressType SrcAddressValue;
    Eep_AddressType CheckAddress;

    /* Check the validity of source add */
    if (NULL_PTR == pu8SrcAddress)
    {
#if (EEP_DEV_ERROR_DETECT == STD_ON)
    ...
    {
        SrcAddressValue = (Eep_AddressType)&pu8SrcAddress[0u];
        CheckAddress = (DestAddress | SrcAddressValue) & 3U;
