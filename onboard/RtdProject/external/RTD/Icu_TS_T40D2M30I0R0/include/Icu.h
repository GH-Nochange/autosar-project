...
/* Check if header file and Std_Types.h file are of the same Autosar version */
    ...
    #if (ICU_REPORT_WAKEUP_SOURCE == STD_ON)
        /* Check if header file and EcuM.h file are of the same Autosar version */
        #if ((ICU_AR_RELEASE_MAJOR_VERSION != ECUM_AR_RELEASE_MAJOR_VERSION) || \
             (ICU_AR_RELEASE_MINOR_VERSION != ECUM_AR_RELEASE_MINOR_VERSION))
            #error "AutoSar Version Numbers of Icu.h and EcuM.h are different"
        #endif
 ...
 **/
extern Icu_ModeType             Icu_CurrentMode[ICU_MAX_PARTITIONS];
