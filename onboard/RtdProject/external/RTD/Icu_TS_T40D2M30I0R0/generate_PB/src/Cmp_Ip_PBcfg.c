...
[!SELECT "./IcuConfigSet"!]
[!IF "count(IcuLpCmp/*) > '0'"!]
    [!CODE!]#define ICU_START_SEC_CONFIG_DATA_UNSPECIFIED[!CR!][!ENDCODE!]
    ...
    [!LOOP "IcuLpCmp/*"!]
      ...
      [!CODE!]const Cmp_Ip_ConfigType Cmp_Ip_[!"node:value(IcuCmpInstanceNumber)"!]_Config_[!"$VARIANT"!] =[!CR!]{[!CR!][!ENDCODE!]
        ...
        [!IF "node:exists(IcuCmp/IcuCmpEnableComparatorInvert)"!]
        ...
        [!CODE!][!WS "4"!]/** @brief CMP Trigger parameters */[!CR!][!ENDCODE!]
        [!CODE!][!WS "4"!]{[!CR!][!ENDCODE!]
        ...
        [!IF "node:exists(IcuTrigger/IcuTrgRoundRobinPreSetChannel)"!]
            [!CODE!][!WS "8"!]/** @brief CMP Trigger Round Robin Pre-Set Channel */[!CR!][!ENDCODE!]
            [!CODE!][!WS "8"!][!"node:value(IcuTrigger/IcuTrgRoundRobinPreSetChannel)"!]U,[!CR!][!ENDCODE!]
        [!ENDIF!]
 ...
 *================================================================================================*/
#define CMP_IP_[!IF "var:defined('postBuildVariant')"!][!"text:toupper($postBuildVariant)"!]_[!ENDIF!]PBCFG_VENDOR_ID_C                    43
#define CMP_IP_[!IF "var:defined('postBuildVariant')"!][!"text:toupper($postBuildVariant)"!]_[!ENDIF!]PBCFG_AR_RELEASE_MAJOR_VERSION_C     4
#define CMP_IP_[!IF "var:defined('postBuildVariant')"!][!"text:toupper($postBuildVariant)"!]_[!ENDIF!]PBCFG_AR_RELEASE_MINOR_VERSION_C     7
#define CMP_IP_[!IF "var:defined('postBuildVariant')"!][!"text:toupper($postBuildVariant)"!]_[!ENDIF!]PBCFG_AR_RELEASE_REVISION_VERSION_C  0
#define CMP_IP_[!IF "var:defined('postBuildVariant')"!][!"text:toupper($postBuildVariant)"!]_[!ENDIF!]PBCFG_SW_MAJOR_VERSION_C             3
#define CMP_IP_[!IF "var:defined('postBuildVariant')"!][!"text:toupper($postBuildVariant)"!]_[!ENDIF!]PBCFG_SW_MINOR_VERSION_C             0
#define CMP_IP_[!IF "var:defined('postBuildVariant')"!][!"text:toupper($postBuildVariant)"!]_[!ENDIF!]PBCFG_SW_PATCH_VERSION_C             0
 ...
 *================================================================================================*/
    ...
    #if ((CMP_IP_[!IF "var:defined('postBuildVariant')"!][!"text:toupper($postBuildVariant)"!]_[!ENDIF!]PBCFG_AR_RELEASE_MAJOR_VERSION_C != STD_AR_RELEASE_MAJOR_VERSION) || \
         (CMP_IP_[!IF "var:defined('postBuildVariant')"!][!"text:toupper($postBuildVariant)"!]_[!ENDIF!]PBCFG_AR_RELEASE_MINOR_VERSION_C != STD_AR_RELEASE_MINOR_VERSION))
...
#if (CMP_IP_[!IF "var:defined('postBuildVariant')"!][!"text:toupper($postBuildVariant)"!]_[!ENDIF!]PBCFG_VENDOR_ID_C != CMP_IP_TYPES_VENDOR_ID)
...
#if ((CMP_IP_[!IF "var:defined('postBuildVariant')"!][!"text:toupper($postBuildVariant)"!]_[!ENDIF!]PBCFG_AR_RELEASE_MAJOR_VERSION_C != CMP_IP_TYPES_AR_RELEASE_MAJOR_VERSION) || \
     (CMP_IP_[!IF "var:defined('postBuildVariant')"!][!"text:toupper($postBuildVariant)"!]_[!ENDIF!]PBCFG_AR_RELEASE_MINOR_VERSION_C != CMP_IP_TYPES_AR_RELEASE_MINOR_VERSION) || \
     (CMP_IP_[!IF "var:defined('postBuildVariant')"!][!"text:toupper($postBuildVariant)"!]_[!ENDIF!]PBCFG_AR_RELEASE_REVISION_VERSION_C != CMP_IP_TYPES_AR_RELEASE_REVISION_VERSION))
...
#if ((CMP_IP_[!IF "var:defined('postBuildVariant')"!][!"text:toupper($postBuildVariant)"!]_[!ENDIF!]PBCFG_SW_MAJOR_VERSION_C != CMP_IP_TYPES_SW_MAJOR_VERSION) || \
     (CMP_IP_[!IF "var:defined('postBuildVariant')"!][!"text:toupper($postBuildVariant)"!]_[!ENDIF!]PBCFG_SW_MINOR_VERSION_C != CMP_IP_TYPES_SW_MINOR_VERSION) || \
     (CMP_IP_[!IF "var:defined('postBuildVariant')"!][!"text:toupper($postBuildVariant)"!]_[!ENDIF!]PBCFG_SW_PATCH_VERSION_C != CMP_IP_TYPES_SW_PATCH_VERSION))
