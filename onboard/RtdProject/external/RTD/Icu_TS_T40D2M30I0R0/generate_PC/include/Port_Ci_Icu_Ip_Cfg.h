...
#define PORT_CI_ICU_IP_CFG_SW_MAJOR_VERSION                3
...
[!IF "var:defined('postBuildVariant')"!][!//
    [!LOOP "variant:all()"!][!//
/* Check if header file and Port_Ci_Icu_Ip_[!"."!]_PBcfg.h file are of the same vendor */
#if (PORT_CI_ICU_IP_CFG_VENDOR_ID != PORT_CI_ICU_IP_[!"text:toupper(.)"!]_PBCFG_VENDOR_ID)
    #error "Port_Ci_Icu_Ip_Cfg.h and Port_Ci_Icu_Ip_[!"."!]_PBcfg.h have different vendor IDs"
#endif

/* Check if header file and Port_Ci_Icu_Ip_[!"."!]_PBcfg.h file are of the same Autosar version */
#if ((PORT_CI_ICU_IP_CFG_AR_RELEASE_MAJOR_VERSION != PORT_CI_ICU_IP_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
     (PORT_CI_ICU_IP_CFG_AR_RELEASE_MINOR_VERSION != PORT_CI_ICU_IP_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_MINOR_VERSION) || \
     (PORT_CI_ICU_IP_CFG_AR_RELEASE_REVISION_VERSION != PORT_CI_ICU_IP_[!"text:toupper(.)"!]_PBCFG_AR_RELEASE_REVISION_VERSION))
    #error "AutoSar Version Numbers of Port_Ci_Icu_Ip_Cfg.h and Port_Ci_Icu_Ip_[!"."!]_PBcfg.h are different"
#endif

/* Check if header file and Port_Ci_Icu_Ip_[!"."!]_PBcfg.h file are of the same software version */
#if ((PORT_CI_ICU_IP_CFG_SW_MAJOR_VERSION != PORT_CI_ICU_IP_[!"text:toupper(.)"!]_PBCFG_SW_MAJOR_VERSION) || \
     (PORT_CI_ICU_IP_CFG_SW_MINOR_VERSION != PORT_CI_ICU_IP_[!"text:toupper(.)"!]_PBCFG_SW_MINOR_VERSION) || \
     (PORT_CI_ICU_IP_CFG_SW_PATCH_VERSION != PORT_CI_ICU_IP_[!"text:toupper(.)"!]_PBCFG_SW_PATCH_VERSION))
    #error "Software Version Numbers of Port_Ci_Icu_Ip_Cfg.h and Port_Ci_Icu_Ip_[!"."!]_PBcfg.h are different"
#endif
    [!ENDLOOP!][!//
[!ELSE!][!//
/* Check if header file and Port_Ci_Icu_Ip_PBcfg.h file are of the same vendor */
...
/* Check if header file and Port_Ci_Icu_Ip_PBcfg.h file are of the same Autosar version */
...
/* Check if header file and Port_Ci_Icu_Ip_PBcfg.h file are of the same Software version */
...
[!IF "var:defined('postBuildVariant')"!][!//
    [!LOOP "variant:all()"!][!//
        [!CODE!][!WS "8"!]PORT_CI_ICU_CONFIG_[!"text:toupper(.)"!]_PB \[!CR!][!ENDCODE!]
    [!ENDLOOP!][!//
[!ELSE!][!//
    [!CODE!][!WS "8"!]PORT_CI_ICU_CONFIG_PB[!CR!][!ENDCODE!]
[!ENDIF!][!//
[!ENDIF!][!//
