...
[!IF "node:exists(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative)"!][!//
    ...
    [!ELSEIF "contains($DerivativeName, 'S32K3')"!][!//
        ...
        [!ELSEIF "contains($DerivativeName, 'S32K37')"!][!//
            [!CODE!][!WS "0"!]#include "S32K37_LPCMP.h"[!CR!][!ENDCODE!][!//
    ...
    [!ELSEIF "contains($DerivativeName, 'S32K5')"!][!//
        [!CODE!][!WS "0"!]#include "S32K566_LPCMP.h"[!CR!][!ENDCODE!][!//
    [!ENDIF!][!//
[!ENDIF!][!//
...
#define CMP_IP_DEINIT_API                   ([!IF "IcuOptionalApis/IcuDeInitApi"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])

/** @brief Define if global variables need to be placed in non-cache area or not */
#define CMP_IP_NO_CACHE_USED                ([!IF "num:i(count(IcuGeneral/IcuEcucPartitionRef/*)) > 1"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])

[!LOOP "IcuConfigSet/IcuHwInterruptConfigList/*"!][!//
    [!IF "contains(IcuIsrHwId, 'CMP')"!][!//
        [!CODE!]#define ICU_[!"node:value(IcuIsrHwId)"!]_ISR_USED[!CR!][!ENDCODE!][!//
    [!ENDIF!][!//
[!ENDLOOP!][!//
...
[!NOCODE!][!//
[!IF "node:exists(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative)"!][!//
    [!IF "contains($DerivativeName, 'S32K39') or contains($DerivativeName, 'S32K36') or contains($DerivativeName, 'S32K37')"!][!//
        [!CODE!][!WS "0"!]#define CMP_IP_SUPPORT_CMPTODAC_LINK    (STD_OFF)[!CR!][!ENDCODE!][!//
    [!ELSEIF "contains($DerivativeName, 'S32K3') or contains($DerivativeName, 'S32M27')"!][!//
        [!CODE!][!WS "0"!]#define CMP_IP_SUPPORT_CMPTODAC_LINK    (STD_ON)[!CR!][!ENDCODE!][!//
    [!ENDIF!][!//
[!ENDIF!][!//
[!ENDNOCODE!][!//
